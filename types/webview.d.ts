...
declare module "sketch-module-web-view" {
  ...
  class BrowserWindow extends CommonEventEmitter<BrowserWindow.EventListeners> {
    ...
    */
    setAspectRatio(aspectRatio: number, extraSize?: cocoa.CGSize): void;

    /** Resizes and moves the window to the supplied bounds */
    setBounds(bounds: cocoa.CGRect, animate?: boolean): void;
    getBounds(): cocoa.CGRect;

    /** Resizes and moves the window's client area (e.g. the web page) to the supplied bounds. */
    setContentBounds(bounds: cocoa.CGRect, animate?: boolean): void;
    getContentBounds(): cocoa.CGRect;
    ...
    getNativeWindowHandle<R = cocoa.NSPanel>(): R;
