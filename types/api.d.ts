...
declare module "sketch/dom" {
  ...
  namespace dom {
    ...
    export class Document extends Component<cocoa.MSDocument> {
      /**
       * Access the selected Document
       * @return The selected Document or undefined if no document is open.
       */
    ...
    export abstract class Layer<
      NativeType extends cocoa.MSLayer = cocoa.MSLayer
    ...
    class StyledLayer<NativeType extends cocoa.MSStyledLayer> extends Layer<
      NativeType
    > {
      /**
    ...
    class BaseGroup<
      NativeType extends cocoa.MSLayerGroup = cocoa.MSLayerGroup
    ...
    export class Page extends BaseGroup<cocoa.MSPage> {
      /**
       * The document the page is in.
       */
      parent: Document;
    ...
    class BaseArtboard<
      NativeType extends cocoa.MSArtboardGroup = cocoa.MSArtboardGroup
    > extends BaseGroup<cocoa.MSArtboardGroup> {
      /**
    ...
    export interface ImageProperties {
       ...
       * * an ImageData
       * * a native cocoa.NSImage
       * * a native cocoa.NSURL
       * * a native cocoa.MSImageData
    ...
    export class Image extends StyledLayer<cocoa.MSBitmapLayer> {
      type: Types.Image;
      /**
       * The group the Image is in.
       */
    ...
    /**
     * An ImageData is a wrapper around a native cocoa.NSImage.
     * You can access the native cocoa.NSImage with nsimage or a native cocoa.NSData representation of the image with nsdata.
     */
    export abstract class ImageData extends Component<cocoa.MSImageData> {
      type: Types.ImageData;
      readonly nsimage: cocoa.NSImage;
      readonly nsdata: cocoa.NSData;
      /**
       * The image property accept a wide range of input:
       * * an ImageData
       * * a native cocoa.NSImage
    ...
    export class Shape extends BaseGroup<cocoa.MSShapeGroup> {
      type: Types.Shape;
      /**
       * The group the Shape is in.
       */
    ...
    export class ShapePath extends StyledLayer<cocoa.MSShapePathLayer> {
     ...
     */
    export class CurvePoint extends Component<cocoa.MSCurvePoint> {
      /**
    ...
    export class Point {
      ...
      y: number;
      /**
       * Return the Point as a cocoa.CGPoint.
       */
      asCGPoint(): cocoa.CGPoint;
      /**
       * Return the Point as a NSPoint.
       */
      asNSPoint(): cocoa.CGPoint;
    }
    ...
    export class Text extends StyledLayer<cocoa.MSTextLayer> {
      type: Types.Text;
      /**
       * The group the Text is in.
       */
    ...
    export class SymbolMaster extends BaseArtboard<cocoa.MSSymbolMaster> {
    ...
    export class SymbolInstance extends StyledLayer<cocoa.MSSymbolInstance> {
       ...
       * @param value The value of override to set. Can be a string or an cocoa.NSImage or a symbolId depending on the type of the override.
       */
      setOverrideValue(
        override: Override,
        value: string | cocoa.NSImage
      ): this;
    }
     ...
     */
    export abstract class Override extends Component<
      cocoa.MSAvailableOverride
    > {
      type: Types.Override;
      /**
     ...
     */
    export class HotSpot extends Layer<cocoa.MSHotspotLayer> {
      type: Types.HotSpot;
     ...
     * A Sketch Library.
     */
    export abstract class Library extends Component<cocoa.MSAssetLibrary> {
      type: Types.Library;
      /**
    ...
    type ImportableNative =
      | cocoa.MSShareableObjectReference
      | cocoa.MSSymbolMasterReference
      | cocoa.MSSharedStyleReference
      | cocoa.MSSharedLayerReference
      | cocoa.MSSharedTextReference;
    /**
    ...
    export class Style extends Component<cocoa.MSStyle> {
      type: Types.Style;
      /**
       * The opacity of a Layer, between 0 (transparent) and 1 (opaque).
       */
    ...
    export abstract class SharedStyle extends Component<cocoa.MSSharedStyle> {
     ...
     * A Sketch hotspot. It is an instance of both Layer so all the methods defined there are available.
     */
    export class Slice extends Layer<cocoa.MSSliceLayer> {
      type: Types.Slice;
    ...
    export function fromNative(nativeObject: cocoa.MSDocument): Document;
    export function fromNative(nativeObject: cocoa.MSLayerGroup): Group;
    export function fromNative(nativeObject: cocoa.MSPage): Page;
    export function fromNative(nativeObject: cocoa.MSArtboardGroup): Artboard;
    export function fromNative(nativeObject: cocoa.MSBitmapLayer): Image;
    export function fromNative(nativeObject: cocoa.MSShapeGroup): Shape;
    export function fromNative(
      nativeObject: cocoa.MSShapePathLayer
    ): ShapePath;
    export function fromNative(nativeObject: cocoa.MSTextLayer): Text;
    export function fromNative(
      nativeObject: cocoa.MSSymbolMaster
    ): SymbolMaster;
    export function fromNative(
      nativeObject: cocoa.MSSymbolInstance
    ): SymbolInstance;
    export function fromNative(
      nativeObject: cocoa.MSAvailableOverride
    ): Override;
    export function fromNative(nativeObject: cocoa.MSHotspotLayer): HotSpot;
    export function fromNative(nativeObject: cocoa.MSAssetLibrary): Library;
    export function fromNative(nativeObject: cocoa.MSStyle): Style;
    export function fromNative(nativeObject: cocoa.MSSharedStyle): SharedStyle;
    export function fromNative(nativeObject: cocoa.MSSliceLayer): Slice;
    export function fromNative(
...
declare module "sketch" {
  ...
  namespace sketch {
    ...
    export type ActionContext<T extends cocoa.MSAction> = SketchActionContext<T>;
  }
  export = sketch;
}
declare interface SketchContext {
  api(): any;
  command: cocoa.MSPluginCommand;
  document: cocoa.MSDocument;
  scriptPath: string;
  scriptURL: cocoa.NSURL;
  selection: cocoa.NSArray;
}
declare interface SketchActionContext<T extends cocoa.MSAction> extends SketchContext {
  actionContext: {
    document: cocoa.MSDocument;
    action?: T;
    exports?: { path: string; request: cocoa.MSExportRequest }[];
  };
  action: string;
}
