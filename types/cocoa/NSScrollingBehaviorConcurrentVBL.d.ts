...
declare namespace cocoa {
  export interface NSScrollingBehaviorConcurrentVBL<T = any> extends cocoa.NSScrollingBehavior, cocoa._NSScrollStateEventListenerProtocol {
    ...
    _asynchronouslyAllowDelegateToAdjustMomentum_withInitialOrigin_velocity_synchronousTimeout_gestureToken<R = void, P0 = unknown, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = number, P4 = number>(__asynchronouslyAllowDelegateToAdjustMomentum: P0, _withInitialOrigin: P1, _velocity: P2, _synchronousTimeout: P3, _gestureToken: P4): R;
    ...
    _snapRubberbandWithInitialOrigin_velocity_stretch<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGSize>(__snapRubberbandWithInitialOrigin: P0, _velocity: P1, _stretch: P2): R;
  ...
  namespace classes {
    export interface NSScrollingBehaviorConcurrentVBL<T = any> extends cocoa.classes.NSScrollingBehavior, cocoa.classes._NSScrollStateEventListenerProtocol {
