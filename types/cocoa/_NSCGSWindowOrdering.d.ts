...
declare namespace cocoa {
  export interface _NSCGSWindowOrdering<T = any> extends cocoa.NSObject, cocoa._NSCGSWindowOrderingStateProtocol {
  ...
  namespace classes {
    export interface _NSCGSWindowOrdering<T = any> extends cocoa.classes.NSObject, cocoa.classes._NSCGSWindowOrderingStateProtocol {
