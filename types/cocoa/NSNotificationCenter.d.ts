...
declare namespace cocoa {
  export interface NSNotificationCenter<T = any> extends cocoa.NSObject {
    debugDescription<R = unknown>(): R;
    isEmpty<R = boolean>(): R;
    addObserverForName_object_queue_usingBlock<R = unknown, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(_addObserverForName: P0, _object: P1, _queue: P2, _usingBlock: P3): R;
    ...
    dealloc<R = void>(): R;
    _initWithCFNotificationCenter<R = unknown, P0 = cocoa.__CFNotificationCenter>(__initWithCFNotificationCenter: P0): R;
  ...
  namespace classes {
    export interface NSNotificationCenter<T = any> extends cocoa.classes.NSObject {
...
declare const NSNotificationCenter: cocoa.classes.NSNotificationCenter;
