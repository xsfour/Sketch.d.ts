...
declare namespace cocoa {
  export interface MSAddFlowBackAction<T = any> extends cocoa.MSFlowBaseAction {
    label<R = unknown>(): R;
    addFlowBack<R = void, P0 = unknown>(_addFlowBack: P0): R;
    validate<R = boolean>(): R;
  }
  namespace classes {
    export interface MSAddFlowBackAction<T = any> extends cocoa.classes.MSFlowBaseAction {
