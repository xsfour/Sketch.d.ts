...
declare namespace cocoa {
  export interface NSPersistentUICrashHandler<T = any> extends cocoa.NSObject {
    crashBlameCounter<R = number>(): R;
    clearCrashCountFileIfNecessary<R = void>(): R;
    inspectCrashDataWithModification_handler<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(_inspectCrashDataWithModification: P0, _handler: P1): R;
  ...
  namespace classes {
    export interface NSPersistentUICrashHandler<T = any> extends cocoa.classes.NSObject {
