...
declare namespace cocoa {
  export interface NSSaveAccessoryAdapter<T = any> extends cocoa.NSView {
    _updateConstrainedSize<R = void, P0 = cocoa.CGSize>(__updateConstrainedSize: P0): R;
    ...
    heightConstraint<R = cocoa.NSLayoutConstraint>(): R;
    setHeightConstraint<R = void, P0 = cocoa.NSLayoutConstraint>(_v: P0): R;
    widthConstraint<R = cocoa.NSLayoutConstraint>(): R;
    setWidthConstraint<R = void, P0 = cocoa.NSLayoutConstraint>(_v: P0): R;
  }
  namespace classes {
    export interface NSSaveAccessoryAdapter<T = any> extends cocoa.classes.NSView {
      alloc<R = NSSaveAccessoryAdapter>(): R;
      new: <R = NSSaveAccessoryAdapter>() => R;
      checkAllowedSize_atPriority_ofView<R = cocoa.CGSize, P0 = cocoa.CGSize, P1 = number, P2 = unknown>(_checkAllowedSize: P0, _atPriority: P1, _ofView: P2): R;
