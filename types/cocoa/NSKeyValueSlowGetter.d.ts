...
declare namespace cocoa {
  export interface NSKeyValueSlowGetter<T = any> extends cocoa.NSKeyValueGetter {
  ...
  namespace classes {
    export interface NSKeyValueSlowGetter<T = any> extends cocoa.classes.NSKeyValueGetter {
