...
declare namespace cocoa {
  export interface NSColorPickerUserView<T = any> extends cocoa.NSView {
    ...
    color<R = unknown>(): R;
    colorFromPoint<R = unknown, P0 = cocoa.CGPoint>(_colorFromPoint: P0): R;
    _resizeImage<R = void>(): R;
    setImage<R = void, P0 = unknown>(_setImage: P0): R;
    _getColorFromImageAtPoint<R = unknown, P0 = cocoa.CGPoint>(__getColorFromImageAtPoint: P0): R;
  ...
  namespace classes {
    export interface NSColorPickerUserView<T = any> extends cocoa.classes.NSView {
