...
declare namespace cocoa {
  export interface _NSToolbarImageRepView<T = any> extends cocoa.NSView {
    ...
    sizeWhenSizedToFit<R = cocoa.CGSize>(): R;
    ...
    logicalImageSize<R = cocoa.CGSize>(): R;
    setLogicalImageSize<R = void, P0 = cocoa.CGSize>(_v: P0): R;
  }
  namespace classes {
    export interface _NSToolbarImageRepView<T = any> extends cocoa.classes.NSView {
