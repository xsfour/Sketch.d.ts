...
declare namespace cocoa {
  export interface NSLocalizableString<T = any> extends cocoa.NSString {
    ...
    developmentLanguageString<R = cocoa.NSString>(): R;
    stringsFileKey<R = cocoa.NSString>(): R;
  }
  namespace classes {
    export interface NSLocalizableString<T = any> extends cocoa.classes.NSString {
