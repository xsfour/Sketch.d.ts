...
declare namespace cocoa {
  export interface MSInsertArtboardAction<T = any> extends cocoa.MSBaseInsertAction {
    tooltip<R = unknown>(): R;
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSInsertArtboardAction<T = any> extends cocoa.classes.MSBaseInsertAction {
