...
declare namespace cocoa {
  export interface AFPropertyListResponseSerializer<T = any> extends cocoa.AFHTTPResponseSerializer {
  ...
  namespace classes {
    export interface AFPropertyListResponseSerializer<T = any> extends cocoa.classes.AFHTTPResponseSerializer {
