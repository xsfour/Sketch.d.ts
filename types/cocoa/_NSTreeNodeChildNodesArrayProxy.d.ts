...
declare namespace cocoa {
  export interface _NSTreeNodeChildNodesArrayProxy<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSTreeNodeChildNodesArrayProxy<T = any> extends cocoa.classes.NSObject {
