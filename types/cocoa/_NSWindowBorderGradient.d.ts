...
declare namespace cocoa {
  export interface _NSWindowBorderGradient<T = any> extends cocoa.NSGradient {
  ...
  namespace classes {
    export interface _NSWindowBorderGradient<T = any> extends cocoa.classes.NSGradient {
