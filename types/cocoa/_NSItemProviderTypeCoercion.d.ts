...
declare namespace cocoa {
  export interface _NSItemProviderTypeCoercion<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSItemProviderTypeCoercion<T = any> extends cocoa.classes.NSObject {
