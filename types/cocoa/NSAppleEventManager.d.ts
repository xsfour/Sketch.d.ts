...
declare namespace cocoa {
  export interface NSAppleEventManager<T = any> extends cocoa.NSObject {
    resumeWithSuspensionID<R = void, P0 = cocoa.__NSAppleEventManagerSuspension>(_resumeWithSuspensionID: P0): R;
    setCurrentAppleEventAndReplyEventWithSuspensionID<R = void, P0 = cocoa.__NSAppleEventManagerSuspension>(_setCurrentAppleEventAndReplyEventWithSuspensionID: P0): R;
    replyAppleEventForSuspensionID<R = unknown, P0 = cocoa.__NSAppleEventManagerSuspension>(_replyAppleEventForSuspensionID: P0): R;
    appleEventForSuspensionID<R = unknown, P0 = cocoa.__NSAppleEventManagerSuspension>(_appleEventForSuspensionID: P0): R;
    suspendCurrentAppleEvent<R = cocoa.__NSAppleEventManagerSuspension>(): R;
    dispatchRawAppleEvent_withRawReply_handlerRefCon<R = number, P0 = cocoa.AEDesc, P1 = cocoa.AEDesc, P2 = void>(_dispatchRawAppleEvent: P0, _withRawReply: P1, _handlerRefCon: P2): R;
    ...
    currentReplyAppleEvent<R = cocoa.NSAppleEventDescriptor>(): R;
    currentAppleEvent<R = cocoa.NSAppleEventDescriptor>(): R;
  }
  namespace classes {
    export interface NSAppleEventManager<T = any> extends cocoa.classes.NSObject {
