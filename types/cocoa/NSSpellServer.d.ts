...
declare namespace cocoa {
  export interface NSSpellServer<T0 = void, T1 = void, T2 = void> extends NSObject {
    ...
    _findMisspelledWordInString_language_learnedDictionaries_wordCount_countOnly<R = _NSRange, P0 = unknown, P1 = unknown, P2 = unknown, P3 = number, P4 = string>(__findMisspelledWordInString: P0, _language: P1, _learnedDictionaries: P2, _wordCount: P3, _countOnly: P4): R;
    ...
    createDictHashTable<R = __CFSet, P0 = boolean>(_createDictHashTable: P0): R;
