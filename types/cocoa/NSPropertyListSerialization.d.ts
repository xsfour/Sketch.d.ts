...
declare namespace cocoa {
  export interface NSPropertyListSerialization<T = any> extends cocoa.NSObject {}
  namespace classes {
    export interface NSPropertyListSerialization<T = any> extends cocoa.classes.NSObject {
