...
declare namespace cocoa {
  export interface MSImmutableStyleBorderOptions<T = any> extends cocoa._MSImmutableStyleBorderOptions {
  ...
  namespace classes {
    export interface MSImmutableStyleBorderOptions<T = any> extends cocoa.classes._MSImmutableStyleBorderOptions {
