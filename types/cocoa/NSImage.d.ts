...
declare namespace cocoa {
  export interface NSImage<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol, cocoa.NSSecureCodingProtocol, cocoa.NSPasteboardReadingProtocol, cocoa.NSPasteboardWritingProtocol {
    ...
    _imageByBadgingWithImage_rect<R = unknown, P0 = unknown, P1 = cocoa.CGRect>(__imageByBadgingWithImage: P0, _rect: P1): R;
    hitTestPoint_withImageDestinationRect_context_hints<R = boolean, P0 = cocoa.CGPoint, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(_hitTestPoint: P0, _withImageDestinationRect: P1, _context: P2, _hints: P3): R;
    hitTestRect_withImageDestinationRect_context_hints<R = boolean, P0 = cocoa.CGRect, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(_hitTestRect: P0, _withImageDestinationRect: P1, _context: P2, _hints: P3): R;
    hitTestRect_withImageDestinationRect_context_hints_flipped<R = boolean, P0 = cocoa.CGRect, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown, P4 = boolean>(_hitTestRect: P0, _withImageDestinationRect: P1, _context: P2, _hints: P3, _flipped: P4): R;
    lockFocus<R = void>(): R;
    lockFocusFlipped<R = void, P0 = boolean>(_lockFocusFlipped: P0): R;
    lockFocusWithRect_context_hints_flipped<R = void, P0 = cocoa.CGRect, P1 = unknown, P2 = unknown, P3 = boolean>(_lockFocusWithRect: P0, _context: P1, _hints: P2, _flipped: P3): R;
    unlockFocus<R = void>(): R;
    _lockFocusOnRepresentation_rect_context_hints_flipped<R = void, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown, P4 = boolean>(__lockFocusOnRepresentation: P0, _rect: P1, _context: P2, _hints: P3, _flipped: P4): R;
    drawRepresentation_inRect<R = boolean, P0 = unknown, P1 = cocoa.CGRect>(_drawRepresentation: P0, _inRect: P1): R;
    _drawRepresentation_inRect_withScaling<R = boolean, P0 = unknown, P1 = cocoa.CGRect, P2 = boolean>(__drawRepresentation: P0, _inRect: P1, _withScaling: P2): R;
    _whenDrawn_fills<R = boolean, P0 = unknown, P1 = cocoa.CGRect>(__whenDrawn: P0, _fills: P1): R;
    ...
    drawInRect_fromRect_operation_fraction_hints<R = void, P0 = cocoa.CGRect, P1 = cocoa.CGRect, P2 = number, P3 = number, P4 = unknown>(_drawInRect: P0, _fromRect: P1, _operation: P2, _fraction: P3, _hints: P4): R;
    ...
    _drawMappingAlignmentRectToRect_withState_backgroundStyle_operation_fraction_flip_hints<R = void, P0 = cocoa.CGRect, P1 = number, P2 = number, P3 = number, P4 = number, P5 = boolean, P6 = unknown>(__drawMappingAlignmentRectToRect: P0, _withState: P1, _backgroundStyle: P2, _operation: P3, _fraction: P4, _flip: P5, _hints: P6): R;
    drawInRect<R = void, P0 = cocoa.CGRect>(_drawInRect: P0): R;
    drawInRect_fromRect_operation_fraction_respectFlipped_hints<R = void, P0 = cocoa.CGRect, P1 = cocoa.CGRect, P2 = number, P3 = number, P4 = boolean, P5 = unknown>(_drawInRect: P0, _fromRect: P1, _operation: P2, _fraction: P3, _respectFlipped: P4, _hints: P5): R;
    ...
    _setAlignmentRectInNormalizedCoordinates<R = void, P0 = cocoa.CGRect>(__setAlignmentRectInNormalizedCoordinates: P0): R;
    _alignmentRectInNormalizedCoordinates<R = cocoa.CGRect>(): R;
    ...
    initFromImage_rect<R = unknown, P0 = unknown, P1 = cocoa.CGRect>(_initFromImage: P0, _rect: P1): R;
    ...
    initWithSize<R = unknown, P0 = cocoa.CGSize>(_initWithSize: P0): R;
    ...
    _usingBestRepresentationForRect_context_hints_body<R = void, P0 = cocoa.CGRect, P1 = unknown, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(__usingBestRepresentationForRect: P0, _context: P1, _hints: P2, _body: P3): R;
    _usingBestRepresentationAmongRepresentations_forRect_context_hints_body<R = void, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown, P4 = cocoa.CDUnknownBlockType>(__usingBestRepresentationAmongRepresentations: P0, _forRect: P1, _context: P2, _hints: P3, _body: P4): R;
    bestRepresentationForRect_context_hints<R = unknown, P0 = cocoa.CGRect, P1 = unknown, P2 = unknown>(_bestRepresentationForRect: P0, _context: P1, _hints: P2): R;
    bestRepresentationAmongRepresentations_forRect_context_hints<R = unknown, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(_bestRepresentationAmongRepresentations: P0, _forRect: P1, _context: P2, _hints: P3): R;
    ...
    _setRepProviderWithIconRef<R = void, P0 = cocoa.OpaqueIconRef>(__setRepProviderWithIconRef: P0): R;
    ...
    _usingRepresentationsPerformBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__usingRepresentationsPerformBlock: P0): R;
    _usingRepProviderPerformBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__usingRepProviderPerformBlock: P0): R;
    ...
    _snapshotRepForRep_rect_context_processedHints<R = unknown, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(__snapshotRepForRep: P0, _rect: P1, _context: P2, _processedHints: P3): R;
    _newSnapshotRepForRep_rect_context_processedHints<R = unknown, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(__newSnapshotRepForRep: P0, _rect: P1, _context: P2, _processedHints: P3): R;
    _newSnapshotRepForCGImage_drawingRect_applicableForRect_context_processedHints<R = unknown, P0 = cocoa.CGImage, P1 = cocoa.CGRect, P2 = cocoa.CGRect, P3 = unknown, P4 = unknown>(__newSnapshotRepForCGImage: P0, _drawingRect: P1, _applicableForRect: P2, _context: P3, _processedHints: P4): R;
    _shouldCacheWhenDrawingRep_rect_context_processedHints<R = boolean, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(__shouldCacheWhenDrawingRep: P0, _rect: P1, _context: P2, _processedHints: P3): R;
    recache<R = void>(): R;
    _hasCacheRep<R = boolean>(): R;
    _isCachedToRep<R = boolean, P0 = unknown>(__isCachedToRep: P0): R;
    _usingCacheRepPerformBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__usingCacheRepPerformBlock: P0): R;
    ...
    _composite_delta_fromRect_toPoint<R = boolean, P0 = number, P1 = number, P2 = cocoa.CGRect, P3 = cocoa.CGPoint>(__composite: P0, _delta: P1, _fromRect: P2, _toPoint: P3): R;
    _compositeFlipped_atPoint_fromRect_operation_fraction<R = void, P0 = boolean, P1 = cocoa.CGPoint, P2 = cocoa.CGRect, P3 = number, P4 = number>(__compositeFlipped: P0, _atPoint: P1, _fromRect: P2, _operation: P3, _fraction: P4): R;
    _compositeFlipped_inRect_fromRect_operation_fraction<R = void, P0 = boolean, P1 = cocoa.CGRect, P2 = cocoa.CGRect, P3 = number, P4 = number>(__compositeFlipped: P0, _inRect: P1, _fromRect: P2, _operation: P3, _fraction: P4): R;
    _compositeToPoint_fromRect_operation_fraction<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGRect, P2 = number, P3 = number>(__compositeToPoint: P0, _fromRect: P1, _operation: P2, _fraction: P3): R;
    _compositeToPoint_operation_fraction<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number>(__compositeToPoint: P0, _operation: P1, _fraction: P2): R;
    compositeToPoint_fromRect_operation_fraction<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGRect, P2 = number, P3 = number>(_compositeToPoint: P0, _fromRect: P1, _operation: P2, _fraction: P3): R;
    compositeToPoint_operation_fraction<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number>(_compositeToPoint: P0, _operation: P1, _fraction: P2): R;
    dissolveToPoint_fromRect_fraction<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGRect, P2 = number>(_dissolveToPoint: P0, _fromRect: P1, _fraction: P2): R;
    compositeToPoint_fromRect_operation<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGRect, P2 = number>(_compositeToPoint: P0, _fromRect: P1, _operation: P2): R;
    dissolveToPoint_fraction<R = void, P0 = cocoa.CGPoint, P1 = number>(_dissolveToPoint: P0, _fraction: P1): R;
    compositeToPoint_operation<R = void, P0 = cocoa.CGPoint, P1 = number>(_compositeToPoint: P0, _operation: P1): R;
    ...
    _imageByScalingToSize_withImageInterpolation_imageScaling<R = unknown, P0 = cocoa.CGSize, P1 = number, P2 = number>(__imageByScalingToSize: P0, _withImageInterpolation: P1, _imageScaling: P2): R;
    _imageByScalingToSize_withImageInterpolation<R = unknown, P0 = cocoa.CGSize, P1 = number>(__imageByScalingToSize: P0, _withImageInterpolation: P1): R;
    ...
    capInsets<R = cocoa.NSEdgeInsets>(): R;
    setCapInsets<R = void, P0 = cocoa.NSEdgeInsets>(_v: P0): R;
    alignmentRect<R = cocoa.CGRect>(): R;
    setAlignmentRect<R = void, P0 = cocoa.CGRect>(_v: P0): R;
    ...
    delegate<R = cocoa.NSImageDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSImageDelegate>(_v: P0): R;
    ...
    thumbWithSize_cornerRadius<R = unknown, P0 = cocoa.CGSize, P1 = number>(_thumbWithSize: P0, _cornerRadius: P1): R;
    imageWithShadow_padding<R = unknown, P0 = unknown, P1 = number>(_imageWithShadow: P0, _padding: P1): R;
    pixelSize<R = cocoa.CGSize>(): R;
    isImageSizeLargerThan<R = boolean, P0 = cocoa.CGSize>(_isImageSizeLargerThan: P0): R;
    imageWithPadding<R = unknown, P0 = number>(_imageWithPadding: P0): R;
    isVectorImage<R = boolean>(): R;
    drawInRect_fromRect_fraction_respectFlipped_colorSpace<R = void, P0 = cocoa.CGRect, P1 = cocoa.CGRect, P2 = number, P3 = boolean, P4 = unknown>(_drawInRect: P0, _fromRect: P1, _fraction: P2, _respectFlipped: P3, _colorSpace: P4): R;
    ...
    drawFlippedAtPoint_fraction<R = void, P0 = cocoa.CGPoint, P1 = number>(_drawFlippedAtPoint: P0, _fraction: P1): R;
    drawFlippedAtPoint<R = void, P0 = cocoa.CGPoint>(_drawFlippedAtPoint: P0): R;
    ...
    drawProportionallyInRect_operation_fraction<R = void, P0 = cocoa.CGRect, P1 = number, P2 = number>(_drawProportionallyInRect: P0, _operation: P1, _fraction: P2): R;
    scaledImageToSize<R = unknown, P0 = cocoa.CGSize>(_scaledImageToSize: P0): R;
    drawInRect_fraction<R = void, P0 = cocoa.CGRect, P1 = number>(_drawInRect: P0, _fraction: P1): R;
    drawAtPoint_fraction<R = void, P0 = cocoa.CGPoint, P1 = number>(_drawAtPoint: P0, _fraction: P1): R;
    drawAtPoint<R = void, P0 = cocoa.CGPoint>(_drawAtPoint: P0): R;
    badgedWithImage_maskImage_offset_forOwner<R = unknown, P0 = unknown, P1 = unknown, P2 = cocoa.CGPoint, P3 = unknown>(_badgedWithImage: P0, _maskImage: P1, _offset: P2, _forOwner: P3): R;
    badgedWithImageNamed_maskImageNamed_offset_forOwner<R = unknown, P0 = unknown, P1 = unknown, P2 = cocoa.CGPoint, P3 = unknown>(_badgedWithImageNamed: P0, _maskImageNamed: P1, _offset: P2, _forOwner: P3): R;
  ...
  namespace classes {
    export interface NSImage<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol, cocoa.classes.NSSecureCodingProtocol, cocoa.classes.NSPasteboardReadingProtocol, cocoa.classes.NSPasteboardWritingProtocol {
      alloc<R = NSImage>(): R;
      new: <R = NSImage>() => R;
      ...
      imageWithSize_drawHandler<R = unknown, P0 = cocoa.CGSize, P1 = cocoa.CDUnknownBlockType>(_imageWithSize: P0, _drawHandler: P1): R;
      imageWithSize_drawingIsFlipped_drawHandler<R = unknown, P0 = cocoa.CGSize, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_imageWithSize: P0, _drawingIsFlipped: P1, _drawHandler: P2): R;
      imageWithSize_flipped_drawingHandler<R = unknown, P0 = cocoa.CGSize, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_imageWithSize: P0, _flipped: P1, _drawingHandler: P2): R;
      ...
      PDFImageWithSize_flipped_drawingHandler<R = unknown, P0 = cocoa.CGSize, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_PDFImageWithSize: P0, _flipped: P1, _drawingHandler: P2): R;
      ...
      drawImageFlipped_withSize_withBlock<R = unknown, P0 = boolean, P1 = cocoa.CGSize, P2 = cocoa.CDUnknownBlockType>(_drawImageFlipped: P0, _withSize: P1, _withBlock: P2): R;
      drawImageFlippedWithSize_withBlock<R = unknown, P0 = cocoa.CGSize, P1 = cocoa.CDUnknownBlockType>(_drawImageFlippedWithSize: P0, _withBlock: P1): R;
      drawImageWithSize_withBlock<R = unknown, P0 = cocoa.CGSize, P1 = cocoa.CDUnknownBlockType>(_drawImageWithSize: P0, _withBlock: P1): R;
