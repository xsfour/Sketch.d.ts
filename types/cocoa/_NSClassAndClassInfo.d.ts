...
declare namespace cocoa {
  export interface _NSClassAndClassInfo<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
  ...
  namespace classes {
    export interface _NSClassAndClassInfo<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
