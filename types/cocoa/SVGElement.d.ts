...
declare namespace cocoa {
  export interface SVGElement<T = any> extends cocoa._SVGElement {
    makeLayerWithParentLayer_progress<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_makeLayerWithParentLayer: P0, _progress: P1): R;
    ...
    makeChildLayersWithParentLayer_progress<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_makeChildLayersWithParentLayer: P0, _progress: P1): R;
    ...
    xml<R = cocoa.NSXMLElement>(): R;
    setXml<R = void, P0 = cocoa.NSXMLElement>(_v: P0): R;
    effectiveLayerName<R = cocoa.NSString>(): R;
  }
  namespace classes {
    export interface SVGElement<T = any> extends cocoa.classes._SVGElement {
