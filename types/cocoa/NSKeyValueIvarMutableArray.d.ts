...
declare namespace cocoa {
  export interface NSKeyValueIvarMutableArray<T = any> extends cocoa.NSKeyValueMutableArray {
  ...
  namespace classes {
    export interface NSKeyValueIvarMutableArray<T = any> extends cocoa.classes.NSKeyValueMutableArray {  }
  }
}
