...
declare namespace cocoa {
  export interface NSBridgedTextCorrectionController<T = any> extends cocoa.NSResponder {
    ...
    _modifiedGrammarRangeForRange_details<R = cocoa._NSRange, P0 = cocoa._NSRange, P1 = unknown>(__modifiedGrammarRangeForRange: P0, _details: P1): R;
    observeValueForKeyPath_ofObject_change_context<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = void>(_observeValueForKeyPath: P0, _ofObject: P1, _change: P2, _context: P3): R;
    traitsChangedFrom_to<R = void, P0 = unknown, P1 = unknown>(_traitsChangedFrom: P0, _to: P1): R;
    selectedRangeChangedFrom_to<R = void, P0 = cocoa._NSRange, P1 = cocoa._NSRange>(_selectedRangeChangedFrom: P0, _to: P1): R;
    performActionsForSelectedRange<R = void, P0 = cocoa._NSRange>(_performActionsForSelectedRange: P0): R;
    checkTextWithSelectedRange<R = void, P0 = cocoa._NSRange>(_checkTextWithSelectedRange: P0): R;
    checkTextInRange_types<R = void, P0 = cocoa._NSRange, P1 = number>(_checkTextInRange: P0, _types: P1): R;
    handleTextCheckingResults_forRange_types_options_orthography_wordCount<R = void, P0 = unknown, P1 = cocoa._NSRange, P2 = number, P3 = unknown, P4 = unknown, P5 = number>(_handleTextCheckingResults: P0, _forRange: P1, _types: P2, _options: P3, _orthography: P4, _wordCount: P5): R;
    ...
    setSelectedRange<R = void, P0 = cocoa._NSRange>(_setSelectedRange: P0): R;
    selectedRange<R = cocoa._NSRange>(): R;
    string<R = unknown>(): R;
    contextDidInsertText_replacementRange<R = void, P0 = unknown, P1 = cocoa._NSRange>(_contextDidInsertText: P0, _replacementRange: P1): R;
    attributedString<R = unknown>(): R;
    initWithTextInputContext<R = unknown, P0 = unknown>(_initWithTextInputContext: P0): R;
    alternativesString<R = cocoa.NSMutableAttributedString>(): R;
    setAlternativesString<R = void, P0 = cocoa.NSMutableAttributedString>(_v: P0): R;
    bubbleTimer<R = cocoa.__CFRunLoopTimer>(): R;
    setBubbleTimer<R = void, P0 = cocoa.__CFRunLoopTimer>(_v: P0): R;
    previousInsertionRange<R = cocoa._NSRange>(): R;
    setPreviousInsertionRange<R = void, P0 = cocoa._NSRange>(_v: P0): R;
    bubbleRange<R = cocoa._NSRange>(): R;
    setBubbleRange<R = void, P0 = cocoa._NSRange>(_v: P0): R;
    ...
    previousString<R = cocoa.NSString>(): R;
    setPreviousString<R = void, P0 = cocoa.NSString>(_v: P0): R;
  ...
  namespace classes {
    export interface NSBridgedTextCorrectionController<T = any> extends cocoa.classes.NSResponder {
