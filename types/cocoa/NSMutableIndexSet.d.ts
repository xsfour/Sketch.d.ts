...
declare namespace cocoa {
  export interface NSMutableIndexSet<T = any> extends cocoa.NSIndexSet {
    ...
    removeIndexesInRange<R = void, P0 = cocoa._NSRange>(_removeIndexesInRange: P0): R;
    addIndex<R = void, P0 = number>(_addIndex: P0): R;
    addIndexesInRange<R = void, P0 = cocoa._NSRange>(_addIndexesInRange: P0): R;
    _mergeOverlappingRangesStartingAtIndex<R = void, P0 = number>(__mergeOverlappingRangesStartingAtIndex: P0): R;
    removeIndexesPassingTest<R = void, P0 = cocoa.CDUnknownBlockType>(_removeIndexesPassingTest: P0): R;
    removeIndexesInRange_options_passingTest<R = void, P0 = cocoa._NSRange, P1 = number, P2 = cocoa.CDUnknownBlockType>(_removeIndexesInRange: P0, _options: P1, _passingTest: P2): R;
    removeIndexesWithOptions_passingTest<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_removeIndexesWithOptions: P0, _passingTest: P1): R;
    ...
    _replaceRangeInArrayAtIndex_withRange<R = void, P0 = number, P1 = cocoa._NSRange>(__replaceRangeInArrayAtIndex: P0, _withRange: P1): R;
    _removeRangeInArrayAtIndex<R = void, P0 = number>(__removeRangeInArrayAtIndex: P0): R;
    _insertRange_inArrayAtIndex<R = void, P0 = cocoa._NSRange, P1 = number>(__insertRange: P0, _inArrayAtIndex: P1): R;
    _addRangeToArray<R = void, P0 = cocoa._NSRange>(__addRangeToArray: P0): R;
    _ensureRangeCapacity<R = void, P0 = number>(__ensureRangeCapacity: P0): R;
  }
  namespace classes {
    export interface NSMutableIndexSet<T = any> extends cocoa.classes.NSIndexSet {
