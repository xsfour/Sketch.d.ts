...
declare namespace cocoa {
  export interface NSPinyinString<T = any> extends cocoa.NSString {
    nonPinyinRangeAtIndex<R = cocoa._NSRange, P0 = number>(_nonPinyinRangeAtIndex: P0): R;
    ...
    hash<R = number>(): R;
    dealloc<R = void>(): R;
    initWithString_syllableCount_lastSyllableIsPartial_score_replacementCount_transpositionCount_insertionCount_deletionCount_rangeCount_ranges<R = unknown, P0 = unknown, P1 = number, P2 = boolean, P3 = number, P4 = number, P5 = number, P6 = number, P7 = number, P8 = number, P9 = cocoa._NSRange>(_initWithString: P0, _syllableCount: P1, _lastSyllableIsPartial: P2, _score: P3, _replacementCount: P4, _transpositionCount: P5, _insertionCount: P6, _deletionCount: P7, _rangeCount: P8, _ranges: P9): R;
    initWithString_syllableCount_lastSyllableIsPartial_score_replacementCount_transpositionCount_insertionCount_deletionCount_indexOfFirstModification_rangeCount_ranges<R = unknown, P0 = unknown, P1 = number, P2 = boolean, P3 = number, P4 = number, P5 = number, P6 = number, P7 = number, P8 = number, P9 = number, P10 = cocoa._NSRange>(_initWithString: P0, _syllableCount: P1, _lastSyllableIsPartial: P2, _score: P3, _replacementCount: P4, _transpositionCount: P5, _insertionCount: P6, _deletionCount: P7, _indexOfFirstModification: P8, _rangeCount: P9, _ranges: P10): R;
    length<R = number>(): R;
  }
  namespace classes {
    export interface NSPinyinString<T = any> extends cocoa.classes.NSString {
...
declare const NSPinyinString: cocoa.classes.NSPinyinString;
