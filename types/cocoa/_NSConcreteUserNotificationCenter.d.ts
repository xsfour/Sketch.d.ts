...
declare namespace cocoa {
  export interface _NSConcreteUserNotificationCenter<T = any> extends cocoa.NSUserNotificationCenter {
    ...
    _sendAsyncMessage_withBlock<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(__sendAsyncMessage: P0, _withBlock: P1): R;
    _sendSyncMessage_result<R = unknown, P0 = number, P1 = cocoa.CDUnknownBlockType>(__sendSyncMessage: P0, _result: P1): R;
    ...
    _appDelegate<R = cocoa._NSUserNotificationCenterAppKitDelegatePrivate>(): R;
    set_appDelegate<R = void, P0 = cocoa._NSUserNotificationCenterAppKitDelegatePrivate>(_v: P0): R;
  }
  namespace classes {
    export interface _NSConcreteUserNotificationCenter<T = any> extends cocoa.classes.NSUserNotificationCenter {
