...
declare namespace cocoa {
  export interface MSPreviousPageAction<T = any> extends cocoa.MSChangePageAction {
    label<R = unknown>(): R;
    previousPage<R = void, P0 = unknown>(_previousPage: P0): R;
  }
  namespace classes {
    export interface MSPreviousPageAction<T = any> extends cocoa.classes.MSChangePageAction {
