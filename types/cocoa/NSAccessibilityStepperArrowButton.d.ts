...
declare namespace cocoa {
  export interface NSAccessibilityStepperArrowButton<T = any> extends cocoa.NSAccessibilityMockUIElement {
    increments<R = boolean>(): R;
    initWithIncrements_parent<R = unknown, P0 = boolean, P1 = unknown>(_initWithIncrements: P0, _parent: P1): R;
  }
  namespace classes {
    export interface NSAccessibilityStepperArrowButton<T = any> extends cocoa.classes.NSAccessibilityMockUIElement {
