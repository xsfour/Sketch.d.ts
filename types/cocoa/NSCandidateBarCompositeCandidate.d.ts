...
declare namespace cocoa {
  export interface NSCandidateBarCompositeCandidate<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
  ...
  namespace classes {
    export interface NSCandidateBarCompositeCandidate<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
