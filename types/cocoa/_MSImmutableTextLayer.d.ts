...
declare namespace cocoa {
  export interface _MSImmutableTextLayer<T = any> extends cocoa.MSImmutableStyledLayer {
  ...
  namespace classes {
    export interface _MSImmutableTextLayer<T = any> extends cocoa.classes.MSImmutableStyledLayer {
