...
declare namespace cocoa {
  export interface _NSISVariableObservable<T = any> extends cocoa.NSObservationSource {
  ...
  namespace classes {
    export interface _NSISVariableObservable<T = any> extends cocoa.classes.NSObservationSource {
