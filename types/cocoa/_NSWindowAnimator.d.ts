...
declare namespace cocoa {
  export interface _NSWindowAnimator<T = any> extends cocoa._NSObjectAnimator {
  ...
  namespace classes {
    export interface _NSWindowAnimator<T = any> extends cocoa.classes._NSObjectAnimator {  }
  }
}
