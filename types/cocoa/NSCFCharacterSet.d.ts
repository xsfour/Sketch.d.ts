...
declare namespace cocoa {
  export interface NSCFCharacterSet<T = any> extends cocoa.NSMutableCharacterSet {
  ...
  namespace classes {
    export interface NSCFCharacterSet<T = any> extends cocoa.classes.NSMutableCharacterSet {
