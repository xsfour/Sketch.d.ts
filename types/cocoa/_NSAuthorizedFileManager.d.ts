...
declare namespace cocoa {
  export interface _NSAuthorizedFileManager<T = any> extends cocoa.NSFileManager {
    ...
    _withPartitionedAttributesFromDictionary_performBlock<R = boolean, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__withPartitionedAttributesFromDictionary: P0, _performBlock: P1): R;
  ...
  namespace classes {
    export interface _NSAuthorizedFileManager<T = any> extends cocoa.classes.NSFileManager {
