...
declare namespace cocoa {
  export interface MSSharedLayerStyleProvider<T = any> extends cocoa.MSForeignObjectProvider {
    objectType<R = number>(): R;
    foreignObjects<R = unknown>(): R;
  }
  namespace classes {
    export interface MSSharedLayerStyleProvider<T = any> extends cocoa.classes.MSForeignObjectProvider {
