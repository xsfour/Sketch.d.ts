...
declare namespace cocoa {
  export interface MSApplyOrientationAction<T = any> extends cocoa.MSDocumentAction {
    isActive<R = boolean>(): R;
    layerHasOurOrientation<R = boolean, P0 = unknown>(_layerHasOurOrientation: P0): R;
    comparisonResultToTest<R = number>(): R;
  }
  namespace classes {
    export interface MSApplyOrientationAction<T = any> extends cocoa.classes.MSDocumentAction {
