...
declare namespace cocoa {
  export interface NSTouchBarColorPickerSliderCMYKArtworkProvider<T = any> extends cocoa.NSTouchBarColorPickerSliderArtworkProvider {
    initWithComponent<R = unknown, P0 = number>(_initWithComponent: P0): R;
  }
  namespace classes {
    export interface NSTouchBarColorPickerSliderCMYKArtworkProvider<T = any> extends cocoa.classes.NSTouchBarColorPickerSliderArtworkProvider {
