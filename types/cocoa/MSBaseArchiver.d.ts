...
declare namespace cocoa {
  export interface MSBaseArchiver<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface MSBaseArchiver<T = any> extends cocoa.classes.NSObject {
...
declare const MSBaseArchiver: cocoa.classes.MSBaseArchiver;
