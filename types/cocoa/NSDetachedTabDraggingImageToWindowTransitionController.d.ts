...
declare namespace cocoa {
  export interface NSDetachedTabDraggingImageToWindowTransitionController<T = any> extends cocoa.NSObject {
    ...
    _initWithMiniWindow_ofWidth_dropLocation_delegate<R = unknown, P0 = unknown, P1 = number, P2 = cocoa.CGPoint, P3 = unknown>(__initWithMiniWindow: P0, _ofWidth: P1, _dropLocation: P2, _delegate: P3): R;
  }
  namespace classes {
    export interface NSDetachedTabDraggingImageToWindowTransitionController<T = any> extends cocoa.classes.NSObject {
      ...
      detachTabAtPointOnScreen_withDraggedMiniWindow_ofWidth_withDelegate<R = void, P0 = cocoa.CGPoint, P1 = unknown, P2 = number, P3 = unknown>(_detachTabAtPointOnScreen: P0, _withDraggedMiniWindow: P1, _ofWidth: P2, _withDelegate: P3): R;
    }
  }
}
