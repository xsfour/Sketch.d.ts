...
declare namespace cocoa {
  export interface NSUnkeyedPortCoder<T = any> extends cocoa.NSConcretePortCoder {
  ...
  namespace classes {
    export interface NSUnkeyedPortCoder<T = any> extends cocoa.classes.NSConcretePortCoder {
...
declare const NSUnkeyedPortCoder: cocoa.classes.NSUnkeyedPortCoder;
