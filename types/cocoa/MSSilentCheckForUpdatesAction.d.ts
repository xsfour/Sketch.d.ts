...
declare namespace cocoa {
  export interface MSSilentCheckForUpdatesAction<T = any> extends cocoa.MSAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSSilentCheckForUpdatesAction<T = any> extends cocoa.classes.MSAction {
