...
declare namespace cocoa {
  export interface NSXPCSpellServerClient<T = any> extends cocoa.NSObject {
    ...
    _findMisspelledWordInString_language_learnedDictionaries_wordCount_countOnly<R = cocoa._NSRange, P0 = unknown, P1 = unknown, P2 = unknown, P3 = number, P4 = boolean>(__findMisspelledWordInString: P0, _language: P1, _learnedDictionaries: P2, _wordCount: P3, _countOnly: P4): R;
  ...
  namespace classes {
    export interface NSXPCSpellServerClient<T = any> extends cocoa.classes.NSObject {
