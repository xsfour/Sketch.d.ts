...
declare namespace cocoa {
  export interface NSRotationGestureRecognizer<T = any> extends cocoa.NSGestureRecognizer {
  ...
  namespace classes {
    export interface NSRotationGestureRecognizer<T = any> extends cocoa.classes.NSGestureRecognizer {
