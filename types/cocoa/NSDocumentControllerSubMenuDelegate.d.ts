...
declare namespace cocoa {
  export interface NSDocumentControllerSubMenuDelegate<T = any> extends cocoa.NSObject, cocoa.NSMenuDelegateProtocol {
  ...
  namespace classes {
    export interface NSDocumentControllerSubMenuDelegate<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSMenuDelegateProtocol {
