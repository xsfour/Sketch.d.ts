...
declare namespace cocoa {
  export interface MSPluginManager<T = any> extends cocoa.NSObject {
    ...
    downloadAndInstallPluginWithIdentifier_version_downloadCompletionHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_downloadAndInstallPluginWithIdentifier: P0, _version: P1, _downloadCompletionHandler: P2): R;
    downloadPluginUpdate_withVersion_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_downloadPluginUpdate: P0, _withVersion: P1, _completionHandler: P2): R;
    clearPluginsCache<R = void>(): R;
    cancelDownloadingPluginVersions<R = void>(): R;
    downloadLatestPluginUpdatesWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_downloadLatestPluginUpdatesWithCompletionHandler: P0): R;
    downloadCompatiblePluginUpdatesWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_downloadCompatiblePluginUpdatesWithCompletionHandler: P0): R;
    downloadPluginUpdates_withCompletionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_downloadPluginUpdates: P0, _withCompletionHandler: P1): R;
    checkForPluginUpdatesWithHandler_completionHandler<R = void, P0 = cocoa.CDUnknownBlockType, P1 = cocoa.CDUnknownBlockType>(_checkForPluginUpdatesWithHandler: P0, _completionHandler: P1): R;
    checkForPluginUpdates_handler_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType, P2 = cocoa.CDUnknownBlockType>(_checkForPluginUpdates: P0, _handler: P1, _completionHandler: P2): R;
    ...
    trackLongRunningCommand_onComplete<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_trackLongRunningCommand: P0, _onComplete: P1): R;
    ...
    setIncompatiblePluginVersions<R = void, P0 = cocoa.NSDictionary>(_v: P0): R;
    downloadPluginsErrors<R = cocoa.NSMutableArray>(): R;
    setDownloadPluginsErrors<R = void, P0 = cocoa.NSMutableArray>(_v: P0): R;
    pluginVersions<R = cocoa.NSMutableDictionary>(): R;
    setPluginVersions<R = void, P0 = cocoa.NSMutableDictionary>(_v: P0): R;
    pluginStateManager<R = cocoa.MSPluginManagingState>(): R;
    monitorForChanges<R = boolean>(): R;
    folderMonitors<R = cocoa.NSArray>(): R;
    setFolderMonitors<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    updater<R = cocoa.MSPluginUpdater>(): R;
    lastTimerInterval<R = number>(): R;
    setLastTimerInterval<R = void, P0 = number>(_v: P0): R;
    sessionTimer<R = cocoa.NSTimer>(): R;
    setSessionTimer<R = void, P0 = cocoa.NSTimer>(_v: P0): R;
    runningCommandCallbacks<R = cocoa.NSMutableDictionary>(): R;
    setRunningCommandCallbacks<R = void, P0 = cocoa.NSMutableDictionary>(_v: P0): R;
    runningCommands<R = cocoa.NSMutableDictionary>(): R;
    setRunningCommands<R = void, P0 = cocoa.NSMutableDictionary>(_v: P0): R;
    metadata<R = cocoa.NSDictionary>(): R;
    setMetadata<R = void, P0 = cocoa.NSDictionary>(_v: P0): R;
    metadataURL<R = cocoa.NSURL>(): R;
    setMetadataURL<R = void, P0 = cocoa.NSURL>(_v: P0): R;
    logAction<R = cocoa.MSPluginLogAction>(): R;
    setLogAction<R = void, P0 = cocoa.MSPluginLogAction>(_v: P0): R;
    ...
    pluginsWithSketchCompatipleUpdates<R = cocoa.NSArray>(): R;
    setPluginsWithSketchCompatipleUpdates<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    numberOfIncompatiblePluginsDisabled<R = number>(): R;
    setNumberOfIncompatiblePluginsDisabled<R = void, P0 = number>(_v: P0): R;
    pluginsFolderURLs<R = cocoa.NSArray>(): R;
    numberOfPluginsWithUpdates<R = number>(): R;
    numberOfPluginsWithSketchCompatibleUpdates<R = number>(): R;
    incompatiblePluginsWithCompatibleUpdates<R = cocoa.NSDictionary>(): R;
    incompatiblePluginsWithUpdates<R = cocoa.NSDictionary>(): R;
    incompatiblePlugins<R = cocoa.NSArray>(): R;
    plugins<R = cocoa.NSDictionary>(): R;
    setPlugins<R = void, P0 = cocoa.NSDictionary>(_v: P0): R;
    mainPluginsFolderURL<R = cocoa.NSURL>(): R;
  }
  namespace classes {
    export interface MSPluginManager<T = any> extends cocoa.classes.NSObject {
