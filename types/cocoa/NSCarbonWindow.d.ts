...
declare namespace cocoa {
  export interface NSCarbonWindow<T = any> extends cocoa.NSWindow {
    ...
    handleMouseDownEvent_at_inPart_withMods<R = number, P0 = cocoa.OpaqueEventRef, P1 = cocoa.Point, P2 = number, P3 = number>(_handleMouseDownEvent: P0, _at: P1, _inPart: P2, _withMods: P3): R;
    ...
    sendCarbonUpdateHICommandStatusEvent_withMenuRef_andMenuItemIndex<R = number, P0 = number, P1 = cocoa.OpaqueMenuRef, P2 = number>(_sendCarbonUpdateHICommandStatusEvent: P0, _withMenuRef: P1, _andMenuItemIndex: P2): R;
    ...
    carbonPlatformWindowBounds<R = cocoa.CGRect>(): R;
    windowRef<R = cocoa.OpaqueWindowPtr>(): R;
    _cleanup<R = void>(): R;
    initWithCarbonWindowRef_takingOwnership<R = unknown, P0 = cocoa.OpaqueWindowPtr, P1 = boolean>(_initWithCarbonWindowRef: P0, _takingOwnership: P1): R;
    initWithCarbonWindowRef_takingOwnership_disableOrdering<R = unknown, P0 = cocoa.OpaqueWindowPtr, P1 = boolean, P2 = boolean>(_initWithCarbonWindowRef: P0, _takingOwnership: P1, _disableOrdering: P2): R;
    cwFlags<R = number>(): R;
    setCwFlags<R = void, P0 = number>(_v: P0): R;
  }
  namespace classes {
    export interface NSCarbonWindow<T = any> extends cocoa.classes.NSWindow {
      alloc<R = NSCarbonWindow>(): R;
      new: <R = NSCarbonWindow>() => R;
      setWindowLevelOfWindowGroupForWindowRef_toLevel<R = void, P0 = cocoa.OpaqueWindowPtr, P1 = number>(_setWindowLevelOfWindowGroupForWindowRef: P0, _toLevel: P1): R;
    }
  }
}
