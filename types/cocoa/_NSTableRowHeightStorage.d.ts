...
declare namespace cocoa {
  export interface _NSTableRowHeightStorage<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
    deleteRowsInRange<R = void, P0 = cocoa._NSRange>(_deleteRowsInRange: P0): R;
    _variableDeleteRowsWithRange<R = void, P0 = cocoa._NSRange>(__variableDeleteRowsWithRange: P0): R;
    _normalDeleteRowsWithRange<R = void, P0 = cocoa._NSRange>(__normalDeleteRowsWithRange: P0): R;
    ...
    noteHeightOfRowsWithIndexesChanged_heightProvider<R = boolean, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_noteHeightOfRowsWithIndexesChanged: P0, _heightProvider: P1): R;
    computeTableHeightForNumberOfRows<R = number, P0 = number>(_computeTableHeightForNumberOfRows: P0): R;
    computeRowAtPoint<R = number, P0 = cocoa.CGPoint>(_computeRowAtPoint: P0): R;
    _normalComputeRowAtPoint<R = number, P0 = cocoa.CGPoint>(__normalComputeRowAtPoint: P0): R;
    _adjustRowForGapRow<R = number, P0 = number>(__adjustRowForGapRow: P0): R;
    _variableComputeRowAtPoint<R = number, P0 = cocoa.CGPoint>(__variableComputeRowAtPoint: P0): R;
    computeRectOfRow_assumingExists<R = cocoa.CGRect, P0 = number, P1 = boolean>(_computeRectOfRow: P0, _assumingExists: P1): R;
    computeRectOfRow<R = cocoa.CGRect, P0 = number>(_computeRectOfRow: P0): R;
    _normalComputeRectOfRow_assumingExists<R = cocoa.CGRect, P0 = number, P1 = boolean>(__normalComputeRectOfRow: P0, _assumingExists: P1): R;
    _variableComputeRectOfRow<R = cocoa.CGRect, P0 = number>(__variableComputeRectOfRow: P0): R;
    ...
    backgroundFillerRect<R = cocoa.CGRect>(): R;
  ...
  namespace classes {
    export interface _NSTableRowHeightStorage<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
