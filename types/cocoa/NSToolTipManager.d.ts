...
declare namespace cocoa {
  export interface NSToolTipManager<T = any> extends cocoa.NSObject {
    ...
    onScreenToolTipWindowFrameOriginForToolTip_windowFrame_where_location<R = cocoa.CGPoint, P0 = unknown, P1 = cocoa.CGRect, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint>(_onScreenToolTipWindowFrameOriginForToolTip: P0, _windowFrame: P1, _where: P2, _location: P3): R;
    toolTipContentViewWithAttributedString_location_where_windowFrame_toolTip<R = unknown, P0 = unknown, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = cocoa.CGRect, P4 = unknown>(_toolTipContentViewWithAttributedString: P0, _location: P1, _where: P2, _windowFrame: P3, _toolTip: P4): R;
    toolTipAttributes<R = unknown>(): R;
    toolTipYOffset<R = number>(): R;
    toolTipContentMargin<R = cocoa.CGSize>(): R;
    ...
    _findToolTipForView_passingTest<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__findToolTipForView: P0, _passingTest: P1): R;
    ...
    setToolTipForView_rect_owner_userData<R = number, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = void>(_setToolTipForView: P0, _rect: P1, _owner: P2, _userData: P3): R;
    setToolTipForView_rect_displayDelegate_displayInfo<R = number, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(_setToolTipForView: P0, _rect: P1, _displayDelegate: P2, _displayInfo: P3): R;
    ...
    _setToolTip_forView_cell_rect_owner_ownerIsDisplayDelegate_userData<R = number, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa.CGRect, P4 = unknown, P5 = boolean, P6 = void>(__setToolTip: P0, _forView: P1, _cell: P2, _rect: P3, _owner: P4, _ownerIsDisplayDelegate: P5, _userData: P6): R;
    _removeToolTipsForView_passingTest<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__removeToolTipsForView: P0, _passingTest: P1): R;
    ...
    _addTrackingRect_andStartToolTipIfNecessary_view_owner_toolTip_reuseExistingTrackingNum<R = number, P0 = cocoa.CGRect, P1 = boolean, P2 = unknown, P3 = unknown, P4 = unknown, P5 = boolean>(__addTrackingRect: P0, _andStartToolTipIfNecessary: P1, _view: P2, _owner: P3, _toolTip: P4, _reuseExistingTrackingNum: P5): R;
  ...
  namespace classes {
    export interface NSToolTipManager<T = any> extends cocoa.classes.NSObject {
