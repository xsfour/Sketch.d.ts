...
declare namespace cocoa {
  export interface NSTableView<T = any> extends NSControl, NSUserInterfaceValidationsProtocol, NSTextViewDelegateProtocol, NSDraggingSourceProtocol, NSAccessibilityTableProtocol {
    ...
    _doUpdatedWorkWithHandler<R = void, P0 = CDUnknownBlockType>(__doUpdatedWorkWithHandler: P0): R;
    ...
    _floatingHeaderViewFrame<R = CGRect>(): R;
    ...
    _visibleRectPastLastRow<R = CGRect>(): R;
    ...
    draggingImageComponentsWithFrame_forDisplayObject<R = unknown, P0 = CGRect, P1 = unknown>(_draggingImageComponentsWithFrame: P0, _forDisplayObject: P1): R;
    _viewBasedImageComponentsWithFrame_forDisplayObject<R = unknown, P0 = CGRect, P1 = unknown>(__viewBasedImageComponentsWithFrame: P0, _forDisplayObject: P1): R;
    _cellBasedImageComponentsWithFrame_forDisplayObject<R = unknown, P0 = CGRect, P1 = unknown>(__cellBasedImageComponentsWithFrame: P0, _forDisplayObject: P1): R;
    ...
    dragImageForRows_event_dragImageOffset<R = unknown, P0 = unknown, P1 = unknown, P2 = CGPoint>(_dragImageForRows: P0, _event: P1, _dragImageOffset: P2): R;
    ...
    _dragImageForRowsWithIndexes_tableColumns_event_offset<R = unknown, P0 = unknown, P1 = unknown, P2 = unknown, P3 = CGPoint>(__dragImageForRowsWithIndexes: P0, _tableColumns: P1, _event: P2, _offset: P3): R;
    _drawView_withCellFrameUnion_inContext<R = void, P0 = unknown, P1 = CGRect, P2 = unknown>(__drawView: P0, _withCellFrameUnion: P1, _inContext: P2): R;
    _drawDragImageCellAtColumn_row_withCellFrameUnion<R = void, P0 = number, P1 = number, P2 = CGRect>(__drawDragImageCellAtColumn: P0, _row: P1, _withCellFrameUnion: P2): R;
    _drawDragCell_inFrame<R = void, P0 = unknown, P1 = CGRect>(__drawDragCell: P0, _inFrame: P1): R;
    _columnsForDragImage<R = unknown>(): R;
    _isPoint_inDragZoneOfRow<R = boolean, P0 = CGPoint, P1 = number>(__isPoint: P0, _inDragZoneOfRow: P1): R;
    ...
    _dropHighlightOutlineRectForRow<R = CGRect, P0 = number>(__dropHighlightOutlineRectForRow: P0): R;
    ...
    _endEditingIfNecessaryWhenDeselectingRowRange<R = void, P0 = _NSRange>(__endEditingIfNecessaryWhenDeselectingRowRange: P0): R;
    _endEditingIfNecessaryWhenDeselectingColumnRange<R = void, P0 = _NSRange>(__endEditingIfNecessaryWhenDeselectingColumnRange: P0): R;
    _endEditingIfNecessaryWhenSelectingRowRange<R = void, P0 = _NSRange>(__endEditingIfNecessaryWhenSelectingRowRange: P0): R;
    _endEditingIfNecessaryWhenSelectingColumnRange<R = void, P0 = _NSRange>(__endEditingIfNecessaryWhenSelectingColumnRange: P0): R;
    ...
    _getRow_column_forPoint<R = void, P0 = number, P1 = number, P2 = CGPoint>(__getRow: P0, _column: P1, _forPoint: P2): R;
    ...
    _viewCanDragRowsWithIndexes_atPoint<R = boolean, P0 = unknown, P1 = CGPoint>(__viewCanDragRowsWithIndexes: P0, _atPoint: P1): R;
    _cellCanDragRowsWithIndexes_atPoint<R = boolean, P0 = unknown, P1 = CGPoint>(__cellCanDragRowsWithIndexes: P0, _atPoint: P1): R;
    ...
    _canDragRowForClickOnCell_column_row_atPoint<R = boolean, P0 = unknown, P1 = number, P2 = number, P3 = CGPoint>(__canDragRowForClickOnCell: P0, _column: P1, _row: P2, _atPoint: P3): R;
    ...
    _cellBasedFieldEditorFocusRingFrame<R = CGRect>(): R;
    _shouldDrawFocusAroundEditedCell<R = boolean>(): R;
    _drawTableExteriorFocusRingIfNecessaryInClipRect<R = void, P0 = CGRect>(__drawTableExteriorFocusRingIfNecessaryInClipRect: P0): R;
    ...
    _visibleOrPreparedRect<R = CGRect>(): R;
    _focusRingFrameForFocusedCell<R = CGRect>(): R;
    _subclassOverridesDrawGridInClipRect<R = boolean>(): R;
    _subclassOverridesDrawBackgroundInRect<R = boolean>(): R;
    _drawContextualMenuHighlightInClipRect<R = void, P0 = CGRect>(__drawContextualMenuHighlightInClipRect: P0): R;
    _drawCachedColumnsInRect<R = void, P0 = CGRect>(__drawCachedColumnsInRect: P0): R;
    _drawDraggedColumn<R = void, P0 = number>(__drawDraggedColumn: P0): R;
    _drawEditingRectWhileCurrentlyEditing<R = CGRect, P0 = boolean>(__drawEditingRectWhileCurrentlyEditing: P0): R;
    _viewBasedDrawRect<R = void, P0 = CGRect>(__viewBasedDrawRect: P0): R;
    ...
    _setKeyboardFocusRingNeedsDisplayForCellInRect<R = void, P0 = CGRect>(__setKeyboardFocusRingNeedsDisplayForCellInRect: P0): R;
    ...
    _makeRubberBandViewWithFrame_inView<R = unknown, P0 = CGRect, P1 = unknown>(__makeRubberBandViewWithFrame: P0, _inView: P1): R;
    ...
    _backgroundViewFillerFrame<R = CGRect>(): R;
    ...
    _makeSelectionBlurBackdropViewWithFrame<R = unknown, P0 = CGRect>(__makeSelectionBlurBackdropViewWithFrame: P0): R;
    ...
    drawBackgroundInClipRect<R = void, P0 = CGRect>(_drawBackgroundInClipRect: P0): R;
    _callDrawBackgroundInClipRect<R = void, P0 = CGRect>(__callDrawBackgroundInClipRect: P0): R;
    _drawBackgroundColor_inClipRect<R = void, P0 = unknown, P1 = CGRect>(__drawBackgroundColor: P0, _inClipRect: P1): R;
    _drawSourceListBackgroundInClipRect<R = void, P0 = CGRect>(__drawSourceListBackgroundInClipRect: P0): R;
    _drawStuff_withClipRect<R = void, P0 = CDUnknownBlockType, P1 = CGRect>(__drawStuff: P0, _withClipRect: P1): R;
    ...
    _viewBasedDrawAlternatingBackgroundInClipRect<R = void, P0 = CGRect>(__viewBasedDrawAlternatingBackgroundInClipRect: P0): R;
    _drawAlternatingRowBackgroundColors_inRect_useGetRectsBeingDrawn<R = void, P0 = unknown, P1 = CGRect, P2 = boolean>(__drawAlternatingRowBackgroundColors: P0, _inRect: P1, _useGetRectsBeingDrawn: P2): R;
    _drawAlternatingRowBackgroundColors_inRect<R = void, P0 = unknown, P1 = CGRect>(__drawAlternatingRowBackgroundColors: P0, _inRect: P1): R;
    ...
    _rectOfDraggedColumn<R = CGRect>(): R;
    _callHighlightSelectionInClipRect<R = void, P0 = CGRect>(__callHighlightSelectionInClipRect: P0): R;
    ...
    drawGridInClipRect<R = void, P0 = CGRect>(_drawGridInClipRect: P0): R;
    _drawVerticalGridInClipRect<R = void, P0 = CGRect>(__drawVerticalGridInClipRect: P0): R;
    ...
    _rowsInRectAssumingRowsCoverVisible<R = _NSRange, P0 = CGRect>(__rowsInRectAssumingRowsCoverVisible: P0): R;
    highlightSelectionInClipRect<R = void, P0 = CGRect>(_highlightSelectionInClipRect: P0): R;
    _highlightRegularSelectionInRange_clipRect<R = void, P0 = _NSRange, P1 = CGRect>(__highlightRegularSelectionInRange: P0, _clipRect: P1): R;
    _highlightSourceListSelectionInRange<R = void, P0 = _NSRange>(__highlightSourceListSelectionInRange: P0): R;
    ...
    _highlightColumn_clipRect<R = void, P0 = number, P1 = CGRect>(__highlightColumn: P0, _clipRect: P1): R;
    _highlightRow_clipRect<R = void, P0 = number, P1 = CGRect>(__highlightRow: P0, _clipRect: P1): R;
    ...
    _drawSourceListHighlightInRect<R = void, P0 = CGRect>(__drawSourceListHighlightInRect: P0): R;
    _drawSourceListHighlightInRect_isButtedUpRow<R = void, P0 = CGRect, P1 = boolean>(__drawSourceListHighlightInRect: P0, _isButtedUpRow: P1): R;
    _manuallyDrawSourceListHighlight<R = boolean>(): R;
    _manuallyDrawSourceListHighlightInRect_isButtedUpRow<R = void, P0 = CGRect, P1 = boolean>(__manuallyDrawSourceListHighlightInRect: P0, _isButtedUpRow: P1): R;
    ...
    drawRowsInRange_clipRect<R = void, P0 = _NSRange, P1 = CGRect>(_drawRowsInRange: P0, _clipRect: P1): R;
    ...
    _drawContextMenuHighlightForIndexes_clipRect<R = void, P0 = unknown, P1 = CGRect>(__drawContextMenuHighlightForIndexes: P0, _clipRect: P1): R;
    drawRow_clipRect<R = void, P0 = number, P1 = CGRect>(_drawRow: P0, _clipRect: P1): R;
    _drawRowBackgroundForRow_clipRect<R = void, P0 = number, P1 = CGRect>(__drawRowBackgroundForRow: P0, _clipRect: P1): R;
    ...
    _drawBackgroundForGroupRow_clipRect_isButtedUpRow<R = void, P0 = number, P1 = CGRect, P2 = boolean>(__drawBackgroundForGroupRow: P0, _clipRect: P1, _isButtedUpRow: P2): R;
    ...
    _drawContentsAtRow_column_clipRect<R = void, P0 = number, P1 = number, P2 = CGRect>(__drawContentsAtRow: P0, _column: P1, _clipRect: P2): R;
    ...
    _sourceListFrameOfCellAtColumn_row_frame<R = void, P0 = number, P1 = number, P2 = CGRect>(__sourceListFrameOfCellAtColumn: P0, _row: P1, _frame: P2): R;
    ...
    _finalTableBounds<R = CGRect>(): R;
    _finalFrameSize<R = CGSize>(): R;
    ...
    _moveAndResizeEditedCellWithOldFrame<R = void, P0 = CGRect>(__moveAndResizeEditedCellWithOldFrame: P0): R;
    ...
    _cellAtPoint_row_column<R = unknown, P0 = CGPoint, P1 = number, P2 = number>(__cellAtPoint: P0, _row: P1, _column: P2): R;
    rowsInRect<R = _NSRange, P0 = CGRect>(_rowsInRect: P0): R;
    rowAtPoint<R = number, P0 = CGPoint>(_rowAtPoint: P0): R;
    columnsInRect<R = _NSRange, P0 = CGRect>(_columnsInRect: P0): R;
    _rtlColumnsInRect<R = _NSRange, P0 = CGRect>(__rtlColumnsInRect: P0): R;
    _ltrColumnsInRect<R = _NSRange, P0 = CGRect>(__ltrColumnsInRect: P0): R;
    _visibleTableColumnIndexes<R = unknown>(): R;
    columnIndexesInRect<R = unknown, P0 = CGRect>(_columnIndexesInRect: P0): R;
    ...
    _rectOfColumnRange<R = CGRect, P0 = _NSRange>(__rectOfColumnRange: P0): R;
    _rectOfRowRange<R = CGRect, P0 = _NSRange>(__rectOfRowRange: P0): R;
    ...
    _rectOfRowAssumingRowExists<R = CGRect, P0 = number>(__rectOfRowAssumingRowExists: P0): R;
    _fillerRectHeight<R = number>(): R;
    rectOfRow<R = CGRect, P0 = number>(_rectOfRow: P0): R;
    _adjustRowRect_forSourceListRow<R = void, P0 = CGRect, P1 = number>(__adjustRowRect: P0, _forSourceListRow: P1): R;
    _setUseUncachedRectOfRow<R = void, P0 = boolean>(__setUseUncachedRectOfRow: P0): R;
    rectOfColumn<R = CGRect, P0 = number>(_rectOfColumn: P0): R;
    _rectOfColumn_ignoringTile<R = CGRect, P0 = number, P1 = boolean>(__rectOfColumn: P0, _ignoringTile: P1): R;
    _newRectOfColumn<R = CGRect, P0 = number>(__newRectOfColumn: P0): R;
    ...
    _oldRectOfColumn<R = CGRect, P0 = number>(__oldRectOfColumn: P0): R;
    ...
    _highlightRectForRow<R = CGRect, P0 = number>(__highlightRectForRow: P0): R;
    _adjustRowRect_forSourceListGroupRow<R = CGRect, P0 = CGRect, P1 = number>(__adjustRowRect: P0, _forSourceListGroupRow: P1): R;
    _isSourceListGroupRow<R = boolean, P0 = number>(__isSourceListGroupRow: P0): R;
    _adjustRowRect_forIntergroupSpacingRow<R = CGRect, P0 = CGRect, P1 = number>(__adjustRowRect: P0, _forIntergroupSpacingRow: P1): R;
    ...
    _cellBasedIsTypeSelectMatchAtRow_forString_compareRange<R = boolean, P0 = number, P1 = unknown, P2 = _NSRange>(__cellBasedIsTypeSelectMatchAtRow: P0, _forString: P1, _compareRange: P2): R;
    _viewBasedIsTypeSelectMatchAtRow_forString_compareRange<R = boolean, P0 = number, P1 = unknown, P2 = _NSRange>(__viewBasedIsTypeSelectMatchAtRow: P0, _forString: P1, _compareRange: P2): R;
    ...
    _hasTextFieldFromView_matchingBlock<R = boolean, P0 = unknown, P1 = CDUnknownBlockType>(__hasTextFieldFromView: P0, _matchingBlock: P1): R;
    ...
    _drawRowHeaderSeparatorInClipRect<R = void, P0 = CGRect>(__drawRowHeaderSeparatorInClipRect: P0): R;
    _rowHeaderSeparatorLineColor<R = unknown>(): R;
    _drawRowHeaderBackgroundInRect<R = void, P0 = CGRect>(__drawRowHeaderBackgroundInRect: P0): R;
    ...
    _rowHeaderShadowSurfaceBounds<R = CGRect>(): R;
    ...
    _unobstructedVisibleRectOfColumn<R = CGRect, P0 = number>(__unobstructedVisibleRectOfColumn: P0): R;
    _rowHeaderScrollableContentVisibleRect<R = CGRect>(): R;
    _rowHeaderFixedContentRect<R = CGRect>(): R;
    _getRowHeaderFixedContentRect_rowHeaderScrollableContentVisibleRect<R = void, P0 = CGRect, P1 = CGRect>(__getRowHeaderFixedContentRect: P0, _rowHeaderScrollableContentVisibleRect: P1): R;
    ...
    _accessibilityChildrenInRange<R = unknown, P0 = _NSRange>(__accessibilityChildrenInRange: P0): R;
    _accessibilityListChildrenInRange<R = unknown, P0 = _NSRange>(__accessibilityListChildrenInRange: P0): R;
    ...
    _accessibilityVisibleRowsRangeIncludeFullyVisibleOnly<R = _NSRange, P0 = boolean>(__accessibilityVisibleRowsRangeIncludeFullyVisibleOnly: P0): R;
    ...
    setAnimationCompletionHandler<R = void, P0 = CDUnknownBlockType>(_setAnimationCompletionHandler: P0): R;
    ...
    _backgroundImageWithFrame<R = unknown, P0 = CGRect>(__backgroundImageWithFrame: P0): R;
    _needsHighlightSelectionForBackgroundAnimations<R = boolean>(): R;
    _backgroundImageForRow_withFrame<R = unknown, P0 = number, P1 = CGRect>(__backgroundImageForRow: P0, _withFrame: P1): R;
    ...
    _imageForColumn_row_frame<R = unknown, P0 = number, P1 = number, P2 = CGRect>(__imageForColumn: P0, _row: P1, _frame: P2): R;
    ...
    registeredNibsByIdentifier<R = NSDictionary>(): R;
    ...
    selectedColumnIndexes<R = NSIndexSet>(): R;
    ...
    gridColor<R = NSColor>(): R;
    setGridColor<R = void, P0 = NSColor>(_v: P0): R;
    ...
    cornerView<R = NSView>(): R;
    setCornerView<R = void, P0 = NSView>(_v: P0): R;
    ...
    dataSource<R = NSTableViewDataSource>(): R;
    setDataSource<R = void, P0 = NSTableViewDataSource>(_v: P0): R;
    doubleAction<R = string>(): R;
    setDoubleAction<R = void, P0 = string>(_v: P0): R;
    delegate<R = NSTableViewDelegate>(): R;
    setDelegate<R = void, P0 = NSTableViewDelegate>(_v: P0): R;
