...
declare namespace cocoa {
  export interface MSEventHandler<T = any> extends cocoa.NSResponder, cocoa.NSDraggingDestinationProtocol, cocoa.NSTouchBarDelegateProtocol {
    ...
    rulerGuidesRectAroundPoint<R = cocoa.CGRect, P0 = cocoa.CGPoint>(_rulerGuidesRectAroundPoint: P0): R;
    horizontalRulerGuidesForGridAlign<R = unknown, P0 = cocoa.CGPoint>(_horizontalRulerGuidesForGridAlign: P0): R;
    verticalRulerGuidesForGridAlign<R = unknown, P0 = cocoa.CGPoint>(_verticalRulerGuidesForGridAlign: P0): R;
    alignPointToGrid<R = cocoa.CGPoint, P0 = cocoa.CGPoint>(_alignPointToGrid: P0): R;
    ...
    dragDropHintForDropOnPoint<R = unknown, P0 = cocoa.CGPoint>(_dragDropHintForDropOnPoint: P0): R;
    ...
    itemAtPoint_modifierFlags<R = unknown, P0 = cocoa.CGPoint, P1 = number>(_itemAtPoint: P0, _modifierFlags: P1): R;
    ...
    duplicateLayer_toIndex_offset<R = unknown, P0 = unknown, P1 = number, P2 = cocoa.CGVector>(_duplicateLayer: P0, _toIndex: P1, _offset: P2): R;
    duplicateSelectedLayersInGroup_withOffset<R = unknown, P0 = unknown, P1 = cocoa.CGVector>(_duplicateSelectedLayersInGroup: P0, _withOffset: P1): R;
    layersSeparatedByGroups<R = unknown, P0 = unknown>(_layersSeparatedByGroups: P0): R;
    duplicateSelectedLayersWithOffset<R = unknown, P0 = cocoa.CGVector>(_duplicateSelectedLayersWithOffset: P0): R;
    currentMousePointInCanvasCoordinates<R = cocoa.CGPoint>(): R;
    ...
    centerPointForZooming<R = cocoa.CGPoint>(): R;
    selectedRect<R = cocoa.CGRect>(): R;
    ...
    prepareGraphicsStateForGroup_drawingBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_prepareGraphicsStateForGroup: P0, _drawingBlock: P1): R;
    drawMeasurementLabel<R = void>(): R;
    drawGuidesAndMeasurementsInRect<R = void, P0 = cocoa.CGRect>(_drawGuidesAndMeasurementsInRect: P0): R;
    ...
    locationForMeasurementLabel<R = cocoa.CGPoint>(): R;
    measurementLabelAttributes<R = unknown>(): R;
    setMeasurementTextWithDegrees<R = void, P0 = number>(_setMeasurementTextWithDegrees: P0): R;
    setMeasurementTextWithSize<R = void, P0 = cocoa.CGSize>(_setMeasurementTextWithSize: P0): R;
    ...
    absoluteMouseMoved_flags<R = boolean, P0 = cocoa.CGPoint, P1 = number>(_absoluteMouseMoved: P0, _flags: P1): R;
    absoluteMouseUp_flags<R = boolean, P0 = cocoa.CGPoint, P1 = number>(_absoluteMouseUp: P0, _flags: P1): R;
    absoluteMouseDragged_flags<R = boolean, P0 = cocoa.CGPoint, P1 = number>(_absoluteMouseDragged: P0, _flags: P1): R;
    absoluteMouseDown_clickCount_flags<R = boolean, P0 = cocoa.CGPoint, P1 = number, P2 = number>(_absoluteMouseDown: P0, _clickCount: P1, _flags: P2): R;
    ...
    measurementLabelSize<R = cocoa.CGSize>(): R;
    setMeasurementLabelSize<R = void, P0 = cocoa.CGSize>(_v: P0): R;
    activeGestureRecognizers<R = cocoa.NSArray>(): R;
    setActiveGestureRecognizers<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    selectionRect<R = cocoa.CGRect>(): R;
    setSelectionRect<R = void, P0 = cocoa.CGRect>(_v: P0): R;
    overlayRenderers<R = cocoa.NSArray>(): R;
    measurementText<R = cocoa.NSString>(): R;
    setMeasurementText<R = void, P0 = cocoa.NSString>(_v: P0): R;
    cursor<R = cocoa.NSCursor>(): R;
    setCursor<R = void, P0 = cocoa.NSCursor>(_v: P0): R;
    selectionTouchBar<R = cocoa.NSTouchBar>(): R;
    setSelectionTouchBar<R = void, P0 = cocoa.NSTouchBar>(_v: P0): R;
    noSelectionTouchBar<R = cocoa.NSTouchBar>(): R;
    setNoSelectionTouchBar<R = void, P0 = cocoa.NSTouchBar>(_v: P0): R;
    viewCoordinateMouse<R = cocoa.CGPoint>(): R;
    setViewCoordinateMouse<R = void, P0 = cocoa.CGPoint>(_v: P0): R;
    pressedKeys<R = cocoa.NSString>(): R;
    setPressedKeys<R = void, P0 = cocoa.NSString>(_v: P0): R;
    offsetTracker<R = cocoa.MSDuplicateOffsetTracker>(): R;
    setOffsetTracker<R = void, P0 = cocoa.MSDuplicateOffsetTracker>(_v: P0): R;
    manager<R = cocoa.MSEventHandlerManager>(): R;
    setManager<R = void, P0 = cocoa.MSEventHandlerManager>(_v: P0): R;
    wantsLayerHighlight<R = boolean>(): R;
    wantsStandardSelectionControls<R = boolean>(): R;
    applicableActionItemIdentifier<R = cocoa.NSString>(): R;
    shouldExitOnContentViewResize<R = boolean>(): R;
    handlesHistoryCoalescing<R = boolean>(): R;
    measurementBackgroundRect<R = cocoa.CGRect>(): R;
  ...
  namespace classes {
    export interface MSEventHandler<T = any> extends cocoa.classes.NSResponder, cocoa.classes.NSDraggingDestinationProtocol, cocoa.classes.NSTouchBarDelegateProtocol {
