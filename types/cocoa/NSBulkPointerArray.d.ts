...
declare namespace cocoa {
  export interface NSBulkPointerArray<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
    ...
    releasePointersInRange<R = void, P0 = cocoa._NSRange>(_releasePointersInRange: P0): R;
    ...
    clearRangeWithoutRelease<R = void, P0 = cocoa._NSRange>(_clearRangeWithoutRelease: P0): R;
    clearRange<R = void, P0 = cocoa._NSRange>(_clearRange: P0): R;
  ...
  namespace classes {
    export interface NSBulkPointerArray<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
