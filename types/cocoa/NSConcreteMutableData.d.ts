...
declare namespace cocoa {
  export interface NSConcreteMutableData<T = any> extends cocoa.NSMutableData {
  ...
  namespace classes {
    export interface NSConcreteMutableData<T = any> extends cocoa.classes.NSMutableData {  }
  }
}

declare const NSConcreteMutableData: cocoa.classes.NSConcreteMutableData;
