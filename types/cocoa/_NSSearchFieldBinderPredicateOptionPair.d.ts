...
declare namespace cocoa {
  export interface _NSSearchFieldBinderPredicateOptionPair<T = any> extends cocoa.NSObject {
    visitor<R = unknown>(): R;
  ...
  namespace classes {
    export interface _NSSearchFieldBinderPredicateOptionPair<T = any> extends cocoa.classes.NSObject {
