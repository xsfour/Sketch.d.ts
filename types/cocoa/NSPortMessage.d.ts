...
declare namespace cocoa {
  export interface NSPortMessage<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSPortMessage<T = any> extends cocoa.classes.NSObject {
