...
declare namespace cocoa {
  export interface AFHTTPBodyPart<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
    ...
    headers<R = cocoa.NSDictionary>(): R;
    setHeaders<R = void, P0 = cocoa.NSDictionary>(_v: P0): R;
  ...
  namespace classes {
    export interface AFHTTPBodyPart<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
