...
declare namespace cocoa {
  export interface MSTile<T = any> extends cocoa.NSObject {
    ...
    setTexture<R = void, P0 = cocoa.MSGPUTexture>(_v: P0): R;
  }
  namespace classes {
    export interface MSTile<T = any> extends cocoa.classes.NSObject {
      alloc<R = MSTile>(): R;
      new: <R = MSTile>() => R;
    }
  }
...
declare const MSTile: cocoa.classes.MSTile;
