...
declare namespace cocoa {
  export interface NSStream<T = any> {
    // + NSStream(NSSocketStreamCreationExtensions,NSStream,NSStreamBoundPairCreationExtensions):
...
declare const NSStream: cocoa.classes.NSStream;
