...
declare namespace cocoa {
  export interface MSPath<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
    ...
    pointsInRect<R = unknown, P0 = cocoa.CGRect>(_pointsInRect: P0): R;
    pathByApplyingModifierBlock<R = unknown, P0 = cocoa.CDUnknownBlockType>(_pathByApplyingModifierBlock: P0): R;
    _initCachedProperties<R = cocoa.MSPathCachedProperties>(): R;
    _calculateCachedProperies<R = cocoa.MSPathCachedProperties>(): R;
    bezierIndexForPoint_tolerance<R = number, P0 = cocoa.CGPoint, P1 = number>(_bezierIndexForPoint: P0, _tolerance: P1): R;
    pathFromIndex_toIndex<R = unknown, P0 = number, P1 = number>(_pathFromIndex: P0, _toIndex: P1): R;
    endPoint<R = cocoa.CGPoint>(): R;
    ...
    pointOnPathAtLength<R = cocoa.CGPoint, P0 = number>(_pointOnPathAtLength: P0): R;
    ...
    _pathByScalingToBounds<R = unknown, P0 = cocoa.CGRect>(__pathByScalingToBounds: P0): R;
    pathByScalingToBounds<R = unknown, P0 = cocoa.CGRect>(_pathByScalingToBounds: P0): R;
    ...
    transformedPathUsingMapBlock<R = unknown, P0 = cocoa.CDUnknownBlockType>(_transformedPathUsingMapBlock: P0): R;
    transformedPathUsingAffineTransform<R = unknown, P0 = cocoa.CGAffineTransform>(_transformedPathUsingAffineTransform: P0): R;
    createContours<R = unknown>(): R;
    initWithPoints_pointCount_close<R = unknown, P0 = cocoa.CGPoint, P1 = number, P2 = boolean>(_initWithPoints: P0, _pointCount: P1, _close: P2): R;
    initWithCurveFromPoint_to_controlPoint1_controlPoint2<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint>(_initWithCurveFromPoint: P0, _to: P1, _controlPoint1: P2, _controlPoint2: P3): R;
    initWithLineFrom_to<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint>(_initWithLineFrom: P0, _to: P1): R;
    initWithEllipseInRect<R = unknown, P0 = cocoa.CGRect>(_initWithEllipseInRect: P0): R;
    initWithSquircleInRect_radius<R = unknown, P0 = cocoa.CGRect, P1 = number>(_initWithSquircleInRect: P0, _radius: P1): R;
    initWithRoundedRect_radius<R = unknown, P0 = cocoa.CGRect, P1 = number>(_initWithRoundedRect: P0, _radius: P1): R;
    ...
    initWithCGPath<R = unknown, P0 = cocoa.CGPath>(_initWithCGPath: P0): R;
    ...
    outerPathWithRect<R = unknown, P0 = cocoa.CGRect>(_outerPathWithRect: P0): R;
    pathWithDashPattern<R = unknown, P0 = unknown>(_pathWithDashPattern: P0): R;
    addClipForWindingRule_context<R = void, P0 = number, P1 = cocoa.CGContext>(_addClipForWindingRule: P0, _context: P1): R;
    clipContext_windingRule_inBlock<R = void, P0 = cocoa.CGContext, P1 = number, P2 = cocoa.CDUnknownBlockType>(_clipContext: P0, _windingRule: P1, _inBlock: P2): R;
    contours<R = cocoa.NSArray>(): R;
    setContours<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    CGPath<R = cocoa.CGPath>(): R;
    subpaths<R = cocoa.NSArray>(): R;
    elementCount<R = number>(): R;
    isEmpty<R = boolean>(): R;
    isRectangular<R = boolean>(): R;
    controlPointBounds<R = cocoa.CGRect>(): R;
    bounds<R = cocoa.CGRect>(): R;
    safeBounds<R = cocoa.CGRect>(): R;
  }
  namespace classes {
    export interface MSPath<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
      alloc<R = MSPath>(): R;
      new: <R = MSPath>() => R;
      pathWithPoints_pointCount_close<R = unknown, P0 = cocoa.CGPoint, P1 = number, P2 = boolean>(_pathWithPoints: P0, _pointCount: P1, _close: P2): R;
      pathWithCurveFromPoint_to_controlPoint1_controlPoint2<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint>(_pathWithCurveFromPoint: P0, _to: P1, _controlPoint1: P2, _controlPoint2: P3): R;
      pathWithLineFrom_to<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint>(_pathWithLineFrom: P0, _to: P1): R;
      pathWithBezierPath<R = unknown, P0 = unknown>(_pathWithBezierPath: P0): R;
      pathWithCGPath<R = unknown, P0 = cocoa.CGPath>(_pathWithCGPath: P0): R;
      pathWithEllipseInRect<R = unknown, P0 = cocoa.CGRect>(_pathWithEllipseInRect: P0): R;
      pathWithRect<R = unknown, P0 = cocoa.CGRect>(_pathWithRect: P0): R;
