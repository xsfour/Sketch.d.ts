...
declare namespace cocoa {
  export interface NSAccessibilityScrollerPart<T = any> extends cocoa.NSAccessibilityMockUIElement {
  ...
  namespace classes {
    export interface NSAccessibilityScrollerPart<T = any> extends cocoa.classes.NSAccessibilityMockUIElement {
