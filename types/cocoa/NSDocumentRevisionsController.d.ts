...
declare namespace cocoa {
  export interface NSDocumentRevisionsController<T = any> extends cocoa.NSObject, cocoa.NSFilePresenterProtocol {
    startDownloadingCurrentVersion<R = void, P0 = unknown>(_startDownloadingCurrentVersion: P0): R;
    _startDownloadingStackItem_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__startDownloadingStackItem: P0, _completionHandler: P1): R;
    ...
    _doDuplicateRevisionDocument_thenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__doDuplicateRevisionDocument: P0, _thenContinue: P1): R;
    ...
    _displayProgressPanelOnWindow_forDownloadingUbiquitousVersion_canceller<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__displayProgressPanelOnWindow: P0, _forDownloadingUbiquitousVersion: P1, _canceller: P2): R;
    ...
    endVisualizationOfDocument_thenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_endVisualizationOfDocument: P0, _thenContinue: P1): R;
    endVisualizationThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(_endVisualizationThenContinue: P0): R;
    endVisualizationWithOutcome_thenContinueAfterAnimation<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_endVisualizationWithOutcome: P0, _thenContinueAfterAnimation: P1): R;
    endVisualizationWithOutcome_thenContinueAfterAnimation_thenContinueWhenExited<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType, P2 = cocoa.CDUnknownBlockType>(_endVisualizationWithOutcome: P0, _thenContinueAfterAnimation: P1, _thenContinueWhenExited: P2): R;
    ...
    _performFinishAnimationThenContinue_thenContinueWhenExited<R = void, P0 = cocoa.CDUnknownBlockType, P1 = cocoa.CDUnknownBlockType>(__performFinishAnimationThenContinue: P0, _thenContinueWhenExited: P1): R;
    ...
    _outcome<R = number>(): R;
    startVisualizationWithDocument_options_thenContinue<R = void, P0 = unknown, P1 = number, P2 = cocoa.CDUnknownBlockType>(_startVisualizationWithDocument: P0, _options: P1, _thenContinue: P2): R;
    ...
    _startTransitoryAnimationsThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__startTransitoryAnimationsThenContinue: P0): R;
    _scheduleTransitoryAnimationOfWindow_startFrame_endFrame_startSize_endSize_hop_duration<R = unknown, P0 = unknown, P1 = cocoa.CGRect, P2 = cocoa.CGRect, P3 = cocoa.CGSize, P4 = cocoa.CGSize, P5 = boolean, P6 = number>(__scheduleTransitoryAnimationOfWindow: P0, _startFrame: P1, _endFrame: P2, _startSize: P3, _endSize: P4, _hop: P5, _duration: P6): R;
    ...
    _destinationFrameForResizeAfterFinishAnimation<R = cocoa.CGRect>(): R;
    _frameForAnimatingWindowFrame_toSize<R = cocoa.CGRect, P0 = cocoa.CGRect, P1 = cocoa.CGSize>(__frameForAnimatingWindowFrame: P0, _toSize: P1): R;
    _destinationFrameForFinishAnimation<R = cocoa.CGRect>(): R;
    _resizedOriginalDocumentWindowFrame<R = cocoa.CGRect>(): R;
    _hideRevisionWindow<R = void>(): R;
    _showRevisionWindow<R = void, P0 = unknown>(__showRevisionWindow: P0): R;
    _loadSnapshotForStackItem_forceNew_wait_thenContinue<R = void, P0 = unknown, P1 = boolean, P2 = boolean, P3 = cocoa.CDUnknownBlockType>(__loadSnapshotForStackItem: P0, _forceNew: P1, _wait: P2, _thenContinue: P3): R;
    _snapshotForDocument<R = unknown, P0 = unknown>(__snapshotForDocument: P0): R;
    _requestUIForStackItem_wait_thenContinue<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(__requestUIForStackItem: P0, _wait: P1, _thenContinue: P2): R;
    ...
    _startAsynchronouslyFetchingVersionsForURL<R = cocoa.CDUnknownBlockType, P0 = unknown>(__startAsynchronouslyFetchingVersionsForURL: P0): R;
    ...
    _loadDocumentForStackItem_wait_completionBlock<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(__loadDocumentForStackItem: P0, _wait: P1, _completionBlock: P2): R;
    ...
    _preloadRevisionAtIndex_thenContinue<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(__preloadRevisionAtIndex: P0, _thenContinue: P1): R;
    _canPreloadRevisions<R = boolean>(): R;
    _canDeleteCurrentVersion<R = boolean>(): R;
    _preferredSizeForRevision<R = cocoa.CGSize, P0 = unknown>(__preferredSizeForRevision: P0): R;
    _setPreferredSize_forRevision<R = void, P0 = cocoa.CGSize, P1 = unknown>(__setPreferredSize: P0, _forRevision: P1): R;
  ...
  namespace classes {
    export interface NSDocumentRevisionsController<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSFilePresenterProtocol {
      ...
      doOrderingWithoutAnimationForWindow_preventScrollerFlashing_withBlock<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_doOrderingWithoutAnimationForWindow: P0, _preventScrollerFlashing: P1, _withBlock: P2): R;
