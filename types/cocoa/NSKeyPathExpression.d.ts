...
declare namespace cocoa {
  export interface NSKeyPathExpression<T = any> extends cocoa.NSFunctionExpression {
    keyPath<R = unknown>(): R;
  ...
  namespace classes {
    export interface NSKeyPathExpression<T = any> extends cocoa.classes.NSFunctionExpression {
