...
declare namespace cocoa {
  export interface MSBezierCurveCurveJoin<T = any> extends cocoa.MSBezierLineCurveJoin {}
  namespace classes {
    export interface MSBezierCurveCurveJoin<T = any> extends cocoa.classes.MSBezierLineCurveJoin {
      ...
      checkLineLengthIsSaneForEndPoint_endPoint2_line1_line2<R = boolean, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = unknown, P3 = unknown>(_checkLineLengthIsSaneForEndPoint: P0, _endPoint2: P1, _line1: P2, _line2: P3): R;
    }
  }
}
