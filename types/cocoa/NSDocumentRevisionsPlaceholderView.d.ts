...
declare namespace cocoa {
  export interface NSDocumentRevisionsPlaceholderView<T = any> extends cocoa.NSView {
    ...
    message2<R = cocoa.NSString>(): R;
    setMessage2<R = void, P0 = cocoa.NSString>(_v: P0): R;
    message1<R = cocoa.NSString>(): R;
    setMessage1<R = void, P0 = cocoa.NSString>(_v: P0): R;
  }
  namespace classes {
    export interface NSDocumentRevisionsPlaceholderView<T = any> extends cocoa.classes.NSView {
