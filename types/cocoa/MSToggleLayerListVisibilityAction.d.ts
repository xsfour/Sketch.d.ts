...
declare namespace cocoa {
  export interface MSToggleLayerListVisibilityAction<T = any> extends cocoa.MSToggleVisibilityAction {
    label<R = unknown>(): R;
    isActive<R = boolean>(): R;
    toggleLayerListVisibility<R = void, P0 = unknown>(_toggleLayerListVisibility: P0): R;
  }
  namespace classes {
    export interface MSToggleLayerListVisibilityAction<T = any> extends cocoa.classes.MSToggleVisibilityAction {
