...
declare namespace cocoa {
  export interface NSDocumentRevisionsRevertProgressOverlayWindow<T = any> extends cocoa.NSWindow {
    canBecomeKeyWindow<R = boolean>(): R;
  }
  namespace classes {
    export interface NSDocumentRevisionsRevertProgressOverlayWindow<T = any> extends cocoa.classes.NSWindow {
