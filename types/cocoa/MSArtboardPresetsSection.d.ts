...
declare namespace cocoa {
  export interface MSArtboardPresetsSection<T = any> extends cocoa.NSObject {
    ...
    setPresets<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    name<R = cocoa.NSString>(): R;
    dictionaryRepresentation<R = cocoa.NSDictionary>(): R;
  }
  namespace classes {
    export interface MSArtboardPresetsSection<T = any> extends cocoa.classes.NSObject {
...
declare const MSArtboardPresetsSection: cocoa.classes.MSArtboardPresetsSection;
