...
declare namespace cocoa {
  export interface AFJSONResponseSerializer<T = any> extends cocoa.AFHTTPResponseSerializer {
  ...
  namespace classes {
    export interface AFJSONResponseSerializer<T = any> extends cocoa.classes.AFHTTPResponseSerializer {
