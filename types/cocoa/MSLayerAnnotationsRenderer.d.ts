...
declare namespace cocoa {
  export interface MSLayerAnnotationsRenderer<T = any> extends cocoa.MSOptionalRenderer {
  ...
  namespace classes {
    export interface MSLayerAnnotationsRenderer<T = any> extends cocoa.classes.MSOptionalRenderer {
