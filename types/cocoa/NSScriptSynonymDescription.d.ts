...
declare namespace cocoa {
  export interface NSScriptSynonymDescription<T = any> extends cocoa.NSObject {
    dealloc<R = void>(): R;
  ...
  namespace classes {
    export interface NSScriptSynonymDescription<T = any> extends cocoa.classes.NSObject {
