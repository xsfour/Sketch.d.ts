...
declare namespace cocoa {
  export interface MSLayerPickerMenuBuilder<T = any> extends MSMenuBuilder {
    ...
    updatePickerMenuItem_forPage_atPoint<R = void, P0 = unknown, P1 = unknown, P2 = CGPoint>(_updatePickerMenuItem: P0, _forPage: P1, _atPoint: P2): R;
  }
  namespace classes {
    export interface MSLayerPickerMenuBuilder<T = any> extends MSMenuBuilder {
