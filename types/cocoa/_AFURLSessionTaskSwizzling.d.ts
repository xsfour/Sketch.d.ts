...
declare namespace cocoa {
  export interface _AFURLSessionTaskSwizzling<T = any> extends cocoa.NSObject {
    af_suspend<R = void>(): R;
    af_resume<R = void>(): R;
    state<R = number>(): R;
  }
  namespace classes {
    export interface _AFURLSessionTaskSwizzling<T = any> extends cocoa.classes.NSObject {
