...
declare namespace cocoa {
  export interface MSReplaceImageAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSReplaceImageAction<T = any> extends cocoa.classes.MSDocumentAction {
