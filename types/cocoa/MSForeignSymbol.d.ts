...
declare namespace cocoa {
  export interface MSForeignSymbol<T = any> extends cocoa._MSForeignSymbol {
    ...
    tooltipForObject_MSAssetSyncSheetObject<R = unknown, P0 = cocoa.MSModelObject>(_tooltipForObject_MSAssetSyncSheetObject: P0): R;
    type_MSAssetSyncSheetObject<R = number>(): R;
    remoteSymbolID<R = cocoa.NSString>(): R;
  }
  namespace classes {
    export interface MSForeignSymbol<T = any> extends cocoa.classes._MSForeignSymbol {
