...
declare namespace cocoa {
  export interface _NSActionRecordStore<T = any> extends cocoa.NSObject {
    ...
    dealloc<R = void>(): R;
    actionRecords<R = cocoa.NSArray>(): R;
  }
  namespace classes {
    export interface _NSActionRecordStore<T = any> extends cocoa.classes.NSObject {
