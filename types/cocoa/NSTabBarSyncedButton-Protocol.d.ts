...
declare namespace cocoa {
  export interface NSTabBarSyncedButtonProtocol<T = any> extends cocoa.NSObjectProtocol {
  ...
  namespace classes {
    export interface NSTabBarSyncedButtonProtocol<T = any> extends cocoa.classes.NSObjectProtocol {  }
  }
}

declare const NSTabBarSyncedButtonProtocol: cocoa.classes.NSTabBarSyncedButtonProtocol;
