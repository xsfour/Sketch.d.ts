...
declare namespace cocoa {
  export interface _NSFullScreenTransitionController<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSFullScreenTransitionController<T = any> extends cocoa.classes.NSObject {
      alloc<R = _NSFullScreenTransitionController>(): R;
      new: <R = _NSFullScreenTransitionController>() => R;
      flippedCGRectFromNSRect<R = cocoa.CGRect, P0 = cocoa.CGRect>(_flippedCGRectFromNSRect: P0): R;
