...
declare namespace cocoa {
  export interface NSDocumentRevisionsView<T = any> extends cocoa.NSView {
    updateControls<R = void>(): R;
    shouldUnfocusWindowWithMouseDownAtWindowPoint<R = boolean, P0 = cocoa.CGPoint>(_shouldUnfocusWindowWithMouseDownAtWindowPoint: P0): R;
    ...
    goToStackItemAtIndex_thenContinue<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_goToStackItemAtIndex: P0, _thenContinue: P1): R;
    _goToStackItemAtIndex_continuingPreviousAnimation_thenContinue<R = void, P0 = number, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(__goToStackItemAtIndex: P0, _continuingPreviousAnimation: P1, _thenContinue: P2): R;
    ...
    _whenRevisionUpdatesAreAllowedDo<R = void, P0 = cocoa.CDUnknownBlockType>(__whenRevisionUpdatesAreAllowedDo: P0): R;
    _animationDidEnd<R = void>(): R;
    _animationWillStart<R = void>(): R;
    _unfocusedFrameForOriginalDocumentWindow_state<R = cocoa.CGRect, P0 = boolean, P1 = number>(__unfocusedFrameForOriginalDocumentWindow: P0, _state: P1): R;
    layoutWithOriginalDocumentWindow_originalVisibleFrame<R = void, P0 = unknown, P1 = cocoa.CGRect>(_layoutWithOriginalDocumentWindow: P0, _originalVisibleFrame: P1): R;
    ...
    _animateLayerAtIndex_fromPosition_toPosition_duration_completionHandler<R = void, P0 = number, P1 = number, P2 = number, P3 = number, P4 = cocoa.CDUnknownBlockType>(__animateLayerAtIndex: P0, _fromPosition: P1, _toPosition: P2, _duration: P3, _completionHandler: P4): R;
    ...
    _calculateLayerBoundsWithBaseBounds<R = void, P0 = cocoa.CGRect>(__calculateLayerBoundsWithBaseBounds: P0): R;
    _calculateLayerBoundsAtZ_withBaseBounds<R = cocoa.CGRect, P0 = number, P1 = cocoa.CGRect>(__calculateLayerBoundsAtZ: P0, _withBaseBounds: P1): R;
    ...
    _layerBoundsAtPosition<R = cocoa.CGRect, P0 = number>(__layerBoundsAtPosition: P0): R;
    initWithController<R = unknown, P0 = unknown>(_initWithController: P0): R;
    stackView<R = cocoa.NSView>(): R;
    setStackView<R = void, P0 = cocoa.NSView>(_v: P0): R;
    focusedRevisionFrame<R = cocoa.CGRect>(): R;
    focusedOriginalFrame<R = cocoa.CGRect>(): R;
    fullTwoUpLayout<R = boolean>(): R;
    originalFrame<R = cocoa.CGRect>(): R;
    revisionFrame<R = cocoa.CGRect>(): R;
    currentStackItemIndex<R = number>(): R;
    setCurrentStackItemIndex<R = void, P0 = number>(_v: P0): R;
  }
  namespace classes {
    export interface NSDocumentRevisionsView<T = any> extends cocoa.classes.NSView {
