...
declare namespace cocoa {
  export interface _NSAutoCalendar<T = any> {
    // + _NSAutoCalendar(_):
    enumerateDatesStartingAfterDate_matchingComponents_options_usingBlock<R = void, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa.CDUnknownBlockType>(_enumerateDatesStartingAfterDate: P0, _matchingComponents: P1, _options: P2, _usingBlock: P3): R;
    ...
    rangeOfUnit_inUnit_forDate<R = cocoa._NSRange, P0 = number, P1 = number, P2 = unknown>(_rangeOfUnit: P0, _inUnit: P1, _forDate: P2): R;
    maximumRangeOfUnit<R = cocoa._NSRange, P0 = number>(_maximumRangeOfUnit: P0): R;
    minimumRangeOfUnit<R = cocoa._NSRange, P0 = number>(_minimumRangeOfUnit: P0): R;
