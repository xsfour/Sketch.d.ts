...
declare namespace cocoa {
  export interface MSConstraintPinTopAction<T = any> extends cocoa.MSConstraintAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSConstraintPinTopAction<T = any> extends cocoa.classes.MSConstraintAction {
