...
declare namespace cocoa {
  export interface NSAccessibilityIndexedMockUIElement<T = any> extends cocoa.NSAccessibilityMockUIElement {
  ...
  namespace classes {
    export interface NSAccessibilityIndexedMockUIElement<T = any> extends cocoa.classes.NSAccessibilityMockUIElement {
