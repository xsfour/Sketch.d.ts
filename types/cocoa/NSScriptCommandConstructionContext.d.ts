...
declare namespace cocoa {
  export interface NSScriptCommandConstructionContext<T = any> extends cocoa.NSObject {}
  namespace classes {
    export interface NSScriptCommandConstructionContext<T = any> extends cocoa.classes.NSObject {
