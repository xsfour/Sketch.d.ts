...
declare namespace cocoa {
  export interface MSNormalBaseEventHandler<T = any> extends cocoa.MSEventHandler {
  ...
  namespace classes {
    export interface MSNormalBaseEventHandler<T = any> extends cocoa.classes.MSEventHandler {
