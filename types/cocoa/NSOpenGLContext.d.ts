...
declare namespace cocoa {
  export interface NSOpenGLContext<T = any> extends cocoa.NSObject, cocoa.NSLockingProtocol {
    ...
    dealloc<R = void>(): R;
    initWithCGLContextObj<R = unknown, P0 = cocoa._CGLContextObject>(_initWithCGLContextObj: P0): R;
    ...
    CGLContextObj<R = cocoa._CGLContextObject>(): R;
    ...
    defaultFramebufferDimensions<R = cocoa.CGSize>(): R;
  }
  namespace classes {
    export interface NSOpenGLContext<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSLockingProtocol {
      alloc<R = NSOpenGLContext>(): R;
      new: <R = NSOpenGLContext>() => R;
      clearCurrentContext<R = void>(): R;
      currentContext<R = unknown>(): R;
      initialize<R = void>(): R;
      openGLContextWithCGLContextObj<R = unknown, P0 = cocoa._CGLContextObject>(_openGLContextWithCGLContextObj: P0): R;
    }
  }
}
