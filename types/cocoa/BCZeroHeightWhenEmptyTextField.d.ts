...
declare namespace cocoa {
  export interface BCZeroHeightWhenEmptyTextField<T = any> extends cocoa.NSTextField {
    paddingIfNotEmpty<R = number>(): R;
    setPaddingIfNotEmpty<R = void, P0 = number>(_v: P0): R;
  }
  namespace classes {
    export interface BCZeroHeightWhenEmptyTextField<T = any> extends cocoa.classes.NSTextField {
