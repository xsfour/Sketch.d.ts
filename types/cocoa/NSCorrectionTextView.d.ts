...
declare namespace cocoa {
  export interface NSCorrectionTextView<T = any> extends cocoa.NSView {
    ...
    drawImage<R = boolean, P0 = cocoa.CGRect>(_drawImage: P0): R;
    ...
    correctionPanel<R = cocoa.NSCorrectionPanel>(): R;
    setCorrectionPanel<R = void, P0 = cocoa.NSCorrectionPanel>(_v: P0): R;
  ...
  namespace classes {
    export interface NSCorrectionTextView<T = any> extends cocoa.classes.NSView {
