...
declare namespace cocoa {
  export interface FBContourOverlap<T = any> extends cocoa.NSObject {
    ...
    reset<R = void>(): R;
    runsWithBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_runsWithBlock: P0): R;
    ...
    overlapRuns<R = cocoa.NSArray>(): R;
    runs_<R = cocoa.NSMutableArray>(): R;
  }
  namespace classes {
    export interface FBContourOverlap<T = any> extends cocoa.classes.NSObject {
