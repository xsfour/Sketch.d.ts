...
declare namespace cocoa {
  export interface NSKeyPathSpecifierExpression<T = any> extends cocoa.NSExpression {
    hash<R = number>(): R;
    keyPath<R = unknown>(): R;
  ...
  namespace classes {
    export interface NSKeyPathSpecifierExpression<T = any> extends cocoa.classes.NSExpression {
