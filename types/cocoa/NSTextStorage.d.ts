...
declare namespace cocoa {
  export interface NSTextStorage<T = any> {
    // + NSTextStorage(NSPrivateScripting,NSScripting,NSUndo,CollectAttributes,MSCalculateBounds,SketchRenderingSupport):
    ...
    words<R = unknown>(): R;
    _undoRedoAttributedSubstringFromRange<R = unknown, P0 = cocoa._NSRange>(__undoRedoAttributedSubstringFromRange: P0): R;
    ...
    attributeValuesByRangeForKey_range<R = unknown, P0 = unknown, P1 = cocoa._NSRange>(_attributeValuesByRangeForKey: P0, _range: P1): R;
    attributeValuesByRangeForKey<R = unknown, P0 = unknown>(_attributeValuesByRangeForKey: P0): R;
    computeFlexibleLayout<R = cocoa.CGRect>(): R;
    calculateFlexibleBounds<R = cocoa.CGRect, P0 = cocoa.CGRect>(_calculateFlexibleBounds: P0): R;
    computeFixedLayout<R = cocoa.CGRect>(): R;
    calculateFixedBounds<R = cocoa.CGRect, P0 = cocoa.CGRect>(_calculateFixedBounds: P0): R;
    glyphBounds<R = cocoa.CGRect>(): R;
    boundsForTextBehaviour_original<R = cocoa.CGRect, P0 = number, P1 = cocoa.CGRect>(_boundsForTextBehaviour: P0, _original: P1): R;
    applyTextColor_forRange_context<R = void, P0 = unknown, P1 = cocoa._NSRange, P2 = unknown>(_applyTextColor: P0, _forRange: P1, _context: P2): R;
    addAttribute_value_range_temporarily<R = void, P0 = unknown, P1 = unknown, P2 = cocoa._NSRange, P3 = boolean>(_addAttribute: P0, _value: P1, _range: P2, _temporarily: P3): R;
  }
  namespace classes {
    export interface NSTextStorage<T = any> {
      // + NSTextStorage(NSPrivateScripting,NSScripting,NSUndo,CollectAttributes,MSCalculateBounds,SketchRenderingSupport):
...
declare const NSTextStorage: cocoa.classes.NSTextStorage;
