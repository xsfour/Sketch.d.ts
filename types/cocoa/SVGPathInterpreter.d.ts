...
declare namespace cocoa {
  export interface SVGPathInterpreter<T = any> extends cocoa.NSObject {
    ...
    appendqComponents_toBezierPath<R = void, P0 = unknown, P1 = unknown>(_appendqComponents: P0, _toBezierPath: P1): R;
    lastControlReflectedQuadratic<R = cocoa.CGPoint>(): R;
    appendSComponents_toBezierPath<R = void, P0 = unknown, P1 = unknown>(_appendSComponents: P0, _toBezierPath: P1): R;
    appendsComponents_toBezierPath<R = void, P0 = unknown, P1 = unknown>(_appendsComponents: P0, _toBezierPath: P1): R;
    appendsComponents_toBezierPath_lastPoint<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CGPoint>(_appendsComponents: P0, _toBezierPath: P1, _lastPoint: P2): R;
    appendCComponents_toBezierPath<R = void, P0 = unknown, P1 = unknown>(_appendCComponents: P0, _toBezierPath: P1): R;
    appendcComponents_toBezierPath<R = void, P0 = unknown, P1 = unknown>(_appendcComponents: P0, _toBezierPath: P1): R;
    appendcComponents_toBezierPath_lastPoint<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CGPoint>(_appendcComponents: P0, _toBezierPath: P1, _lastPoint: P2): R;
    lastControlReflectedCubic<R = cocoa.CGPoint>(): R;
    lastControlPointReflectedForPreviousCommandIn<R = cocoa.CGPoint, P0 = string>(_lastControlPointReflectedForPreviousCommandIn: P0): R;
    reflectLastControlPoint<R = cocoa.CGPoint>(): R;
    appendCurveQuadPoint1_quadPoint2_toBezierPath<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = unknown>(_appendCurveQuadPoint1: P0, _quadPoint2: P1, _toBezierPath: P2): R;
    ...
    lastControl<R = cocoa.CGPoint>(): R;
    setLastControl<R = void, P0 = cocoa.CGPoint>(_v: P0): R;
    lastPoint<R = cocoa.CGPoint>(): R;
    setLastPoint<R = void, P0 = cocoa.CGPoint>(_v: P0): R;
  }
  namespace classes {
    export interface SVGPathInterpreter<T = any> extends cocoa.classes.NSObject {
