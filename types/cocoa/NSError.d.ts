...
declare namespace cocoa {
  export interface NSError<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol, cocoa.NSSecureCodingProtocol {
    _cfTypeID<R = number>(): R;
    initWithCoder<R = unknown, P0 = unknown>(_initWithCoder: P0): R;
    encodeWithCoder<R = void, P0 = unknown>(_encodeWithCoder: P0): R;
    redactedDescription<R = unknown>(): R;
    description<R = unknown>(): R;
    _retainedUserInfoCallBackForKey<R = cocoa.__CFString, P0 = unknown>(__retainedUserInfoCallBackForKey: P0): R;
    ...
    localizedRecoveryOptions<R = cocoa.NSArray>(): R;
    localizedRecoverySuggestion<R = cocoa.NSString>(): R;
    localizedFailureReason<R = cocoa.NSString>(): R;
    localizedDescription<R = cocoa.NSString>(): R;
    userInfo<R = cocoa.NSDictionary>(): R;
    domain<R = cocoa.NSString>(): R;
    code<R = number>(): R;
  }
  namespace classes {
    export interface NSError<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol, cocoa.classes.NSSecureCodingProtocol {
      alloc<R = NSError>(): R;
      new: <R = NSError>() => R;
      userInfoValueProviderForDomain<R = cocoa.CDUnknownBlockType, P0 = unknown>(_userInfoValueProviderForDomain: P0): R;
      setUserInfoValueProviderForDomain_provider<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_setUserInfoValueProviderForDomain: P0, _provider: P1): R;
      ...
      _registerFormatter_forErrorKey_parameters<R = void, P0 = cocoa.CDUnknownFunctionPointerType, P1 = unknown, P2 = string>(__registerFormatter: P0, _forErrorKey: P1, _parameters: P2): R;
