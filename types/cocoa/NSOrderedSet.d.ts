...
declare namespace cocoa {
  export interface NSOrderedSet<T = any> {
    // + NSOrderedSet(NSKeyValueCoding,NSKeyValueCodingPrivate,NSKeyValueObserverRegistration,NSKeyValueSorting,NSOrderedSet,NSPredicateSupport):
...
declare const NSOrderedSet: cocoa.classes.NSOrderedSet;
