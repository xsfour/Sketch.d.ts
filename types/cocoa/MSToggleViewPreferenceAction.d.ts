...
declare namespace cocoa {
  export interface MSToggleViewPreferenceAction<T = any> extends cocoa.MSDocumentAction {
  ...
  namespace classes {
    export interface MSToggleViewPreferenceAction<T = any> extends cocoa.classes.MSDocumentAction {
