...
declare namespace cocoa {
  export interface MSSeparatorConfigurableView<T = any> extends cocoa.NSView {
  ...
  namespace classes {
    export interface MSSeparatorConfigurableView<T = any> extends cocoa.classes.NSView {
