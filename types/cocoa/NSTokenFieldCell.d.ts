...
declare namespace cocoa {
  export interface NSTokenFieldCell<T = any> extends NSTextFieldCell {
    ...
    layoutManager_shouldUseSelectedTextAttributes_atCharacterIndex_effectiveRange<R = unknown, P0 = unknown, P1 = unknown, P2 = number, P3 = _NSRange>(_layoutManager: P0, _shouldUseSelectedTextAttributes: P1, _atCharacterIndex: P2, _effectiveRange: P3): R;
    ...
    tokenAttachment_doubleClickedInRect_ofView_atCharacterIndex<R = boolean, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = number>(_tokenAttachment: P0, _doubleClickedInRect: P1, _ofView: P2, _atCharacterIndex: P3): R;
    ...
    _representedObjectsForString_andAttributedString_range<R = unknown, P0 = unknown, P1 = unknown, P2 = _NSRange>(__representedObjectsForString: P0, _andAttributedString: P1, _range: P2): R;
    ...
    delegate<R = NSTokenFieldCellDelegate>(): R;
    setDelegate<R = void, P0 = NSTokenFieldCellDelegate>(_v: P0): R;
