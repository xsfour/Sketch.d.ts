...
declare namespace cocoa {
  export interface NSCheapMutableString<T = any> extends cocoa.NSMutableString {
    length<R = number>(): R;
    dealloc<R = void>(): R;
  ...
  namespace classes {
    export interface NSCheapMutableString<T = any> extends cocoa.classes.NSMutableString {
