...
declare namespace cocoa {
  export interface NSKeyValueSlowMutableArray<T = any> extends cocoa.NSKeyValueMutableArray {
  ...
  namespace classes {
    export interface NSKeyValueSlowMutableArray<T = any> extends cocoa.classes.NSKeyValueMutableArray {  }
  }
}

declare const NSKeyValueSlowMutableArray: cocoa.classes.NSKeyValueSlowMutableArray;
