...
declare namespace cocoa {
  export interface BCReceiptValidationException<T = any> extends cocoa.NSException {
    status<R = number>(): R;
  }
  namespace classes {
    export interface BCReceiptValidationException<T = any> extends cocoa.classes.NSException {
