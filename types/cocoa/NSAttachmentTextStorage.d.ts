...
declare namespace cocoa {
  export interface NSAttachmentTextStorage<T = any> extends cocoa.NSTextStorage {
  ...
  namespace classes {
    export interface NSAttachmentTextStorage<T = any> extends cocoa.classes.NSTextStorage {  }
  }
}
