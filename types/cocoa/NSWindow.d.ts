...
declare namespace cocoa {
  export interface NSWindow<T = any> extends NSResponder, NSTouchBarProviderContainerProtocol, NSAppearanceCustomizationInternalProtocol, NSAnimatablePropertyContainerProtocol, NSMenuItemValidationProtocol, NSUserInterfaceValidationsProtocol, NSUserInterfaceItemIdentificationProtocol, NSAppearanceCustomizationProtocol, NSAccessibilityElementProtocol, NSAccessibilityProtocol {
    ...
    editTitleWithCompletionHandler<R = void, P0 = CDUnknownBlockType>(_editTitleWithCompletionHandler: P0): R;
    ...
    _internalEditTitleWithCompletionHandler<R = void, P0 = CDUnknownBlockType>(__internalEditTitleWithCompletionHandler: P0): R;
    ...
    _titlebarFloatingWindowFrame<R = CGRect>(): R;
    ...
    _checkForImplicitRemovalFromMovementGroupWhenMovingToFrame<R = void, P0 = CGRect>(__checkForImplicitRemovalFromMovementGroupWhenMovingToFrame: P0): R;
    ...
    _maskRoundedBottomCorners<R = void, P0 = CGRect>(__maskRoundedBottomCorners: P0): R;
    _intersectBottomCornersWithRect<R = CGRect, P0 = CGRect>(__intersectBottomCornersWithRect: P0): R;
    ...
    _endWindowBlockingModalSession_returnCode<R = void, P0 = _NSModalSession, P1 = number>(__endWindowBlockingModalSession: P0, _returnCode: P1): R;
    ...
    beginCriticalSheet_completionHandler<R = void, P0 = unknown, P1 = CDUnknownBlockType>(_beginCriticalSheet: P0, _completionHandler: P1): R;
    beginSheet_completionHandler<R = void, P0 = unknown, P1 = CDUnknownBlockType>(_beginSheet: P0, _completionHandler: P1): R;
    _beginSheet_completionHandler_isCritical<R = void, P0 = unknown, P1 = CDUnknownBlockType, P2 = boolean>(__beginSheet: P0, _completionHandler: P1, _isCritical: P2): R;
    _beginWindowBlockingModalSessionForSheet_service_completionHandler_isCritical<R = void, P0 = unknown, P1 = unknown, P2 = CDUnknownBlockType, P3 = boolean>(__beginWindowBlockingModalSessionForSheet: P0, _service: P1, _completionHandler: P2, _isCritical: P3): R;
    ...
    cascadeTopLeftFromPoint<R = CGPoint, P0 = CGPoint>(_cascadeTopLeftFromPoint: P0): R;
    _commonMinMaxSizeChanged<R = void>(): R;
    _adjustMinAndMaxSizeForSheet<R = void, P0 = boolean>(__adjustMinAndMaxSizeForSheet: P0): R;
    _confirmSize_force<R = boolean, P0 = CGSize, P1 = boolean>(__confirmSize: P0, _force: P1): R;
    _validSize_forFullScreen_force<R = void, P0 = CGSize, P1 = boolean, P2 = boolean>(__validSize: P0, _forFullScreen: P1, _force: P2): R;
    _validSize_force<R = void, P0 = CGSize, P1 = boolean>(__validSize: P0, _force: P1): R;
    _overrideDefeatingConstrainFrameRect_toScreen<R = CGRect, P0 = CGRect, P1 = unknown>(__overrideDefeatingConstrainFrameRect: P0, _toScreen: P1): R;
    ...
    _enforceMenuBarAvoidanceForFrame_onScreen<R = CGRect, P0 = CGRect, P1 = unknown>(__enforceMenuBarAvoidanceForFrame: P0, _onScreen: P1): R;
    _enforceFullScreenRestrictionForFrame<R = CGRect, P0 = CGRect>(__enforceFullScreenRestrictionForFrame: P0): R;
    ...
    _bestScreenByGeometryOfFrame_avoidingFullScreen<R = unknown, P0 = CGRect, P1 = boolean>(__bestScreenByGeometryOfFrame: P0, _avoidingFullScreen: P1): R;
    _bestScreenByGeometryOfFrame_respectingSpaceAssignment<R = unknown, P0 = CGRect, P1 = boolean>(__bestScreenByGeometryOfFrame: P0, _respectingSpaceAssignment: P1): R;
    ...
    _setFrameFromString_overrideTopLeft_preferActiveDisplay_constrainFullFrame_force<R = boolean, P0 = unknown, P1 = CGPoint, P2 = boolean, P3 = boolean, P4 = boolean>(__setFrameFromString: P0, _overrideTopLeft: P1, _preferActiveDisplay: P2, _constrainFullFrame: P3, _force: P4): R;
    _convertAdjustedFrameFromDefaults<R = CGRect, P0 = CGRect>(__convertAdjustedFrameFromDefaults: P0): R;
    ...
    _stringWithFrame_onScreen_adjustingForToolbar<R = unknown, P0 = CGRect, P1 = unknown, P2 = boolean>(__stringWithFrame: P0, _onScreen: P1, _adjustingForToolbar: P2): R;
    discardCachedImage<R = void>(): R;
    restoreCachedImage<R = void>(): R;
    cacheImageInRect<R = void, P0 = CGRect>(_cacheImageInRect: P0): R;
    ...
    __close<R = void>(): R;
    convertScreenToBase<R = CGPoint, P0 = CGPoint>(_convertScreenToBase: P0): R;
    ...
    convertPointFromScreen<R = CGPoint, P0 = CGPoint>(_convertPointFromScreen: P0): R;
    convertPointToScreen<R = CGPoint, P0 = CGPoint>(_convertPointToScreen: P0): R;
    convertRectFromScreen<R = CGRect, P0 = CGRect>(_convertRectFromScreen: P0): R;
    convertRectToScreen<R = CGRect, P0 = CGRect>(_convertRectToScreen: P0): R;
    ...
    _setTransformDidCompleteHandler<R = void, P0 = CDUnknownBlockType>(__setTransformDidCompleteHandler: P0): R;
    ...
    _setCGColorSpace<R = number, P0 = CGColorSpace>(__setCGColorSpace: P0): R;
    ...
    _copyNeedsDisplayRegionInRect_validateSubtractedRegion<R = unknown, P0 = CGRect, P1 = boolean>(__copyNeedsDisplayRegionInRect: P0, _validateSubtractedRegion: P1): R;
    _adjustNeedsDisplayRegionForNewFrame<R = void, P0 = CGRect>(__adjustNeedsDisplayRegionForNewFrame: P0): R;
    _setNeedsDisplayInRegion<R = void, P0 = unknown>(__setNeedsDisplayInRegion: P0): R;
    _setNeedsDisplayInRect<R = void, P0 = CGRect>(__setNeedsDisplayInRect: P0): R;
    _needsDisplayForEntireRect<R = boolean, P0 = CGRect>(__needsDisplayForEntireRect: P0): R;
    ...
    _setTransformForAnimation_anchorPoint<R = void, P0 = CGAffineTransform, P1 = CGPoint>(__setTransformForAnimation: P0, _anchorPoint: P1): R;
    _enumerateAnimatedGlobalWindowsUsingBlock<R = void, P0 = CDUnknownBlockType>(__enumerateAnimatedGlobalWindowsUsingBlock: P0): R;
    ...
    _frameFromMoveData<R = CGRect, P0 = unknown>(__frameFromMoveData: P0): R;
    ...
    _makeCatchupAnimationWithMoveData_catchupSize<R = void, P0 = unknown, P1 = CGSize>(__makeCatchupAnimationWithMoveData: P0, _catchupSize: P1): R;
    ...
    _makeGhostFeedbackWindowWithFrame<R = unknown, P0 = CGRect>(__makeGhostFeedbackWindowWithFrame: P0): R;
    _makeGhostContentViewWithFrame<R = unknown, P0 = CGRect>(__makeGhostContentViewWithFrame: P0): R;
    ...
    _windowDockRectEdgesFromPoint<R = number, P0 = CGPoint>(__windowDockRectEdgesFromPoint: P0): R;
    ...
    _bestFrameForScreenBasedOnFrame<R = CGRect, P0 = CGRect>(__bestFrameForScreenBasedOnFrame: P0): R;
    ...
    _setFrameAfterMove<R = void, P0 = CGRect>(__setFrameAfterMove: P0): R;
    _setFrameOriginForDockMove<R = void, P0 = CGPoint>(__setFrameOriginForDockMove: P0): R;
    _moveChildrenByOffset<R = void, P0 = CGSize>(__moveChildrenByOffset: P0): R;
    _moveByOffset<R = void, P0 = CGSize>(__moveByOffset: P0): R;
    _screenChanged<R = void, P0 = unknown>(__screenChanged: P0): R;
    setMouseConfinementRect<R = void, P0 = CGRect>(_setMouseConfinementRect: P0): R;
    mouseConfinementRect<R = CGRect>(): R;
    ...
    _startWindowDragWithEvent_options_animate_completionHandler<R = void, P0 = unknown, P1 = number, P2 = boolean, P3 = CDUnknownBlockType>(__startWindowDragWithEvent: P0, _options: P1, _animate: P2, _completionHandler: P3): R;
    ...
    _dragWindowRelativeToMouseDown<R = void, P0 = CGPoint>(__dragWindowRelativeToMouseDown: P0): R;
    _shouldStartWindowDragForEvent<R = boolean, P0 = unknown>(__shouldStartWindowDragForEvent: P0): R;
    _beginWindowDragWithEvent_options_completionHandler<R = void, P0 = unknown, P1 = number, P2 = CDUnknownBlockType>(__beginWindowDragWithEvent: P0, _options: P1, _completionHandler: P2): R;
    ...
    _dragWindowRelativeToMouseDown_options<R = void, P0 = CGPoint, P1 = number>(__dragWindowRelativeToMouseDown: P0, _options: P1): R;
    ...
    _setFrame<R = void, P0 = CGRect>(__setFrame: P0): R;
    _setFrame_updateBorderViewSize<R = void, P0 = CGRect, P1 = boolean>(__setFrame: P0, _updateBorderViewSize: P1): R;
    ...
    _setContentRect<R = void, P0 = CGRect>(__setContentRect: P0): R;
    ...
    _setFrame_display_allowImplicitAnimation_stashSize<R = void, P0 = CGRect, P1 = boolean, P2 = boolean, P3 = boolean>(__setFrame: P0, _display: P1, _allowImplicitAnimation: P2, _stashSize: P3): R;
    topLeftPoint<R = CGPoint>(): R;
    ...
    _cgsWindowRelativeMoveChildrenWithGroupWithDelta<R = void, P0 = CGPoint>(__cgsWindowRelativeMoveChildrenWithGroupWithDelta: P0): R;
    ...
    _customTitleFrame<R = CGRect>(): R;
    _titleFrameForEditingWithProposedFrame<R = CGRect, P0 = CGRect>(__titleFrameForEditingWithProposedFrame: P0): R;
    ...
    contentRectForFrameRect<R = CGRect, P0 = CGRect>(_contentRectForFrameRect: P0): R;
    contentRectForFrameRect_styleMask<R = CGRect, P0 = CGRect, P1 = number>(_contentRectForFrameRect: P0, _styleMask: P1): R;
    frameRectForContentRect<R = CGRect, P0 = CGRect>(_frameRectForContentRect: P0): R;
    frameRectForContentRect_styleMask<R = CGRect, P0 = CGRect, P1 = number>(_frameRectForContentRect: P0, _styleMask: P1): R;
    _pixelRectInPoints<R = CGRect, P0 = CGRect>(__pixelRectInPoints: P0): R;
    _pointRectInPixels<R = CGRect, P0 = CGRect>(__pointRectInPixels: P0): R;
    ...
    _initFromGlobalWindow_inRect<R = unknown, P0 = number, P1 = CGRect>(__initFromGlobalWindow: P0, _inRect: P1): R;
    _initFromGlobalWindow_inRect_styleMask<R = unknown, P0 = number, P1 = CGRect, P2 = number>(__initFromGlobalWindow: P0, _inRect: P1, _styleMask: P2): R;
    ...
    initWithContentRect_styleMask_backing_defer_screen<R = unknown, P0 = CGRect, P1 = number, P2 = number, P3 = boolean, P4 = unknown>(_initWithContentRect: P0, _styleMask: P1, _backing: P2, _defer: P3, _screen: P4): R;
    ...
    _commonInitFrame_styleMask_backing_defer<R = void, P0 = CGRect, P1 = number, P2 = number, P3 = boolean>(__commonInitFrame: P0, _styleMask: P1, _backing: P2, _defer: P3): R;
    _initContent_styleMask_backing_defer_screen_contentView<R = unknown, P0 = CGRect, P1 = number, P2 = number, P3 = boolean, P4 = unknown, P5 = unknown>(__initContent: P0, _styleMask: P1, _backing: P2, _defer: P3, _screen: P4, _contentView: P5): R;
    ...
    _setTrackingRect_inside_owner_userData<R = number, P0 = CGRect, P1 = boolean, P2 = unknown, P3 = void>(__setTrackingRect: P0, _inside: P1, _owner: P2, _userData: P3): R;
    _setTrackingRect_inside_owner_userData_useTrackingNum<R = number, P0 = CGRect, P1 = boolean, P2 = unknown, P3 = void, P4 = number>(__setTrackingRect: P0, _inside: P1, _owner: P2, _userData: P3, _useTrackingNum: P4): R;
    _setTrackingRects_insideList_owner_userDataList_trackingNums_count<R = void, P0 = CGRect, P1 = string, P2 = unknown, P3 = void, P4 = number, P5 = number>(__setTrackingRects: P0, _insideList: P1, _owner: P2, _userDataList: P3, _trackingNums: P4, _count: P5): R;
    _setTrackingRect_inside_owner_userData_useTrackingNum_install<R = unknown, P0 = CGRect, P1 = boolean, P2 = unknown, P3 = void, P4 = number, P5 = boolean>(__setTrackingRect: P0, _inside: P1, _owner: P2, _userData: P3, _useTrackingNum: P4, _install: P5): R;
    ...
    _removeCursorRect_cursor_forView<R = boolean, P0 = CGRect, P1 = unknown, P2 = unknown>(__removeCursorRect: P0, _cursor: P1, _forView: P2): R;
    ...
    _minSizeForDrawers<R = CGSize>(): R;
    _minContentSizeForDrawers<R = CGSize>(): R;
    _standardFrameForDrawersInRect<R = CGRect, P0 = CGRect>(__standardFrameForDrawersInRect: P0): R;
    _sizeAllDrawersWithRect<R = void, P0 = CGRect>(__sizeAllDrawersWithRect: P0): R;
    _sizeAllDrawers<R = void>(): R;
    _positionAllDrawers<R = void>(): R;
    _displayAllDrawersIfNeeded<R = void>(): R;
    _moveAllDrawersByOffset<R = void, P0 = CGSize>(__moveAllDrawersByOffset: P0): R;
    ...
    _collapsedOrigin<R = CGPoint>(): R;
    _stashCollapsedOrigin<R = void, P0 = CGPoint>(__stashCollapsedOrigin: P0): R;
    _stashedOrigin<R = CGPoint>(): R;
    _stashOrigin<R = void, P0 = CGPoint>(__stashOrigin: P0): R;
    ...
    _positionSheet_constrained_andDisplay<R = CGRect, P0 = unknown, P1 = boolean, P2 = boolean>(__positionSheet: P0, _constrained: P1, _andDisplay: P2): R;
    _adjustFrame_constrained_forSheet_positioningFrame<R = CGRect, P0 = CGRect, P1 = boolean, P2 = unknown, P3 = CGRect>(__adjustFrame: P0, _constrained: P1, _forSheet: P2, _positioningFrame: P3): R;
    _xOffsetForSheetFrame_inParentFrame<R = number, P0 = CGRect, P1 = CGRect>(__xOffsetForSheetFrame: P0, _inParentFrame: P1): R;
    _centerSheetFrame_inParentFrame<R = CGRect, P0 = CGRect, P1 = CGRect>(__centerSheetFrame: P0, _inParentFrame: P1): R;
    _keepOnScreenSheetFrame<R = CGRect, P0 = CGRect>(__keepOnScreenSheetFrame: P0): R;
    ...
    _moveSheetByItself_delta<R = void, P0 = unknown, P1 = CGPoint>(__moveSheetByItself: P0, _delta: P1): R;
    ...
    _adjustWindowFrame_fromScreen_toScreen<R = void, P0 = CGRect, P1 = unknown, P2 = unknown>(__adjustWindowFrame: P0, _fromScreen: P1, _toScreen: P2): R;
    ...
    _withWindowLayoutsForScreen_performBlock<R = void, P0 = unknown, P1 = CDUnknownBlockType>(__withWindowLayoutsForScreen: P0, _performBlock: P1): R;
    _withWindowLayoutsByScreenLayout<R = void, P0 = CDUnknownBlockType>(__withWindowLayoutsByScreenLayout: P0): R;
    _hiliteWindow_fromWindow<R = void, P0 = OpaqueWindowPtr, P1 = unknown>(__hiliteWindow: P0, _fromWindow: P1): R;
    initWithWindowRef<R = unknown, P0 = void>(_initWithWindowRef: P0): R;
    _setWindowRef<R = void, P0 = OpaqueWindowPtr>(__setWindowRef: P0): R;
    snapshotFromRect_options<R = unknown, P0 = CGRect, P1 = number>(_snapshotFromRect: P0, _options: P1): R;
    _cgImageInRect_options<R = CGImage, P0 = CGRect, P1 = number>(__cgImageInRect: P0, _options: P1): R;
    ...
    _createWindowsMenuEntryWithTitle_enabled<R = __CFDictionary, P0 = unknown, P1 = boolean>(__createWindowsMenuEntryWithTitle: P0, _enabled: P1): R;
    ...
    _titlebarButtonsPreventingActivationRegion<R = CGSRegionObject>(): R;
    _titlebarCommandModifierExclusionRegion<R = CGSRegionObject>(): R;
    _titlebarActivationRegion<R = CGSRegionObject>(): R;
    _regionForOpaqueViewsBlockingDraggableFrame<R = CGSRegionObject, P0 = CGRect>(__regionForOpaqueViewsBlockingDraggableFrame: P0): R;
    ...
    _cgImageScreenShotIncludingShadow_clipRect_visualEffectViewWithDesktopBleedOnly_spaceID<R = CGImage, P0 = boolean, P1 = CGRect, P2 = boolean, P3 = number>(__cgImageScreenShotIncludingShadow: P0, _clipRect: P1, _visualEffectViewWithDesktopBleedOnly: P2, _spaceID: P3): R;
    _cgImageScreenShotIncludingSpaceID<R = CGImage, P0 = number>(__cgImageScreenShotIncludingSpaceID: P0): R;
    _cgImageScreenShot<R = CGImage>(): R;
    ...
    _shadowOffsetForActiveAppearance<R = CGSize, P0 = boolean>(__shadowOffsetForActiveAppearance: P0): R;
    _shadowOffset<R = CGSize>(): R;
    ...
    _windowRefCreatedForCarbonControl<R = OpaqueWindowPtr>(): R;
    _windowRefCreatedForCarbonApp<R = OpaqueWindowPtr>(): R;
    ...
    _windowRef<R = OpaqueWindowPtr>(): R;
    _carbonWindowClass<R = number>(): R;
    _baseTransform<R = CGAffineTransform>(): R;
    ...
    _closestElementToPosition_inElements<R = unknown, P0 = CGPoint, P1 = unknown>(__closestElementToPosition: P0, _inElements: P1): R;
    ...
    _accessibilityFrameForElement<R = CGRect, P0 = unknown>(__accessibilityFrameForElement: P0): R;
    ...
    _beginDraggingSessionWithItems_clipRect_event_source<R = unknown, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = unknown>(__beginDraggingSessionWithItems: P0, _clipRect: P1, _event: P2, _source: P3): R;
    ...
    mouseLocationOutsideOfEventStream<R = CGPoint>(): R;
    ...
    trackEventsMatchingMask_timeout_mode_handler<R = void, P0 = number, P1 = number, P2 = unknown, P3 = CDUnknownBlockType>(_trackEventsMatchingMask: P0, _timeout: P1, _mode: P2, _handler: P3): R;
    ...
    _convertPointFromScreen<R = CGPoint, P0 = CGPoint>(__convertPointFromScreen: P0): R;
    ...
    _frameForVisualizedConstraintsWindow<R = CGRect, P0 = unknown>(__frameForVisualizedConstraintsWindow: P0): R;
    ...
    _validFrameForFrame_resizedFromEdge<R = CGRect, P0 = CGRect, P1 = number>(__validFrameForFrame: P0, _resizedFromEdge: P1): R;
    _commonValidFrameForResizeFrame_fromResizeEdge<R = CGRect, P0 = CGRect, P1 = number>(__commonValidFrameForResizeFrame: P0, _fromResizeEdge: P1): R;
    _allowsSizeSnapping<R = boolean>(): R;
    _unsnapFrameWithEvent<R = void, P0 = unknown>(__unsnapFrameWithEvent: P0): R;
    _setLiveResizedFrame_animated<R = void, P0 = CGRect, P1 = boolean>(__setLiveResizedFrame: P0, _animated: P1): R;
    _snapSizeToFrame_withEvent<R = void, P0 = CGRect, P1 = unknown>(__snapSizeToFrame: P0, _withEvent: P1): R;
    _resizeSetFrame_withEvent<R = void, P0 = CGRect, P1 = unknown>(__resizeSetFrame: P0, _withEvent: P1): R;
    ...
    _snapWindowSizeWithFrame_resizeDirection_state<R = CGRect, P0 = CGRect, P1 = number, P2 = unknown>(__snapWindowSizeWithFrame: P0, _resizeDirection: P1, _state: P2): R;
    _sizeSnappedFrameForOppositeEdge_frame_state<R = CGRect, P0 = number, P1 = CGRect, P2 = unknown>(__sizeSnappedFrameForOppositeEdge: P0, _frame: P1, _state: P2): R;
    _doScreenSizeSnappingFromResizedEdge_frame_state<R = CGRect, P0 = number, P1 = CGRect, P2 = unknown>(__doScreenSizeSnappingFromResizedEdge: P0, _frame: P1, _state: P2): R;
    _shouldDoScreenSizeSnappingFromResizedEdge_frame_state<R = boolean, P0 = number, P1 = CGRect, P2 = unknown>(__shouldDoScreenSizeSnappingFromResizedEdge: P0, _frame: P1, _state: P2): R;
    _setFrameWidthDelta_resizingFromRight_frame<R = void, P0 = number, P1 = boolean, P2 = CGRect>(__setFrameWidthDelta: P0, _resizingFromRight: P1, _frame: P2): R;
    _setFrameHeightDelta_resizingFromTop_frame<R = void, P0 = number, P1 = boolean, P2 = CGRect>(__setFrameHeightDelta: P0, _resizingFromTop: P1, _frame: P2): R;
    _unsnapSizeFromFrame_fromEdge_state<R = CGRect, P0 = CGRect, P1 = number, P2 = unknown>(__unsnapSizeFromFrame: P0, _fromEdge: P1, _state: P2): R;
    ...
    _frame_resizedFromEdge_withDelta_withEvent_withState<R = CGRect, P0 = CGRect, P1 = number, P2 = CGSize, P3 = unknown, P4 = unknown>(__frame: P0, _resizedFromEdge: P1, _withDelta: P2, _withEvent: P3, _withState: P4): R;
    _isConsideredSheetForResizing<R = boolean>(): R;
    _resizingShouldSnapToWindows<R = boolean>(): R;
    _frame_resizedFromEdge_withDelta_withEvent<R = CGRect, P0 = CGRect, P1 = number, P2 = CGSize, P3 = unknown>(__frame: P0, _resizedFromEdge: P1, _withDelta: P2, _withEvent: P3): R;
    ...
    _windowResizeEventHandlingRectForRect<R = CGRect, P0 = CGRect>(__windowResizeEventHandlingRectForRect: P0): R;
    _getEdgeResizingRects_allowedEdges<R = void, P0 = CGRect, P1 = number>(__getEdgeResizingRects: P0, _allowedEdges: P1): R;
    _getEdgeResizingRects<R = void, P0 = CGRect>(__getEdgeResizingRects: P0): R;
    ...
    _edgeResizingCursorUpdate_atLocation<R = boolean, P0 = unknown, P1 = CGPoint>(__edgeResizingCursorUpdate: P0, _atLocation: P1): R;
    _resizeDirectionForMouseLocation<R = number, P0 = CGPoint>(__resizeDirectionForMouseLocation: P0): R;
    ...
    setUnsnappedFrame<R = void, P0 = CGRect>(_setUnsnappedFrame: P0): R;
    unsnappedFrame<R = CGRect>(): R;
    ...
    _adjustedOriginAroundAnchorPointForSize<R = CGPoint, P0 = CGSize>(__adjustedOriginAroundAnchorPointForSize: P0): R;
    _changeWindowFrameFromConstraintsIfNecessary<R = void>(): R;
    _layout_anchorPointInEngine<R = CGPoint>(): R;
    _layout_anchorPoint<R = CGPoint>(): R;
    _invalidateWindowConstraintsMinMaxSizeCache<R = void>(): R;
    _fromConstraintsCalculateWindowMinSize_maxSize_allowDynamicLayout_changingOnlySlightly<R = void, P0 = CGSize, P1 = CGSize, P2 = boolean, P3 = boolean>(__fromConstraintsCalculateWindowMinSize: P0, _maxSize: P1, _allowDynamicLayout: P2, _changingOnlySlightly: P3): R;
    _fromConstraintsGetWindowMinSize_maxSize_allowDynamicLayout_changingOnlySlightly<R = void, P0 = CGSize, P1 = CGSize, P2 = boolean, P3 = boolean>(__fromConstraintsGetWindowMinSize: P0, _maxSize: P1, _allowDynamicLayout: P2, _changingOnlySlightly: P3): R;
    _getConstrainedWindowMinSize_maxSize_changingOnlySlightly<R = void, P0 = CGSize, P1 = CGSize, P2 = boolean>(__getConstrainedWindowMinSize: P0, _maxSize: P1, _changingOnlySlightly: P2): R;
    _getConstrainedWindowMinSize_maxSize<R = void, P0 = CGSize, P1 = CGSize>(__getConstrainedWindowMinSize: P0, _maxSize: P1): R;
    _fromConstraintsSetWindowFrame<R = void, P0 = CGRect>(__fromConstraintsSetWindowFrame: P0): R;
    _validateSizeUsingConstraints<R = void, P0 = CGSize>(__validateSizeUsingConstraints: P0): R;
    _setWindowResizeConstraintSize<R = void, P0 = CGSize>(__setWindowResizeConstraintSize: P0): R;
    _refreshWindowResizeConstraintsWithSize<R = void, P0 = CGSize>(__refreshWindowResizeConstraintsWithSize: P0): R;
    ...
    _createSiblingTileForWindow_preferredPositions_responseHandler<R = void, P0 = unknown, P1 = number, P2 = CDUnknownBlockType>(__createSiblingTileForWindow: P0, _preferredPositions: P1, _responseHandler: P2): R;
    _queryCanAddSiblingTileForWindow_responseHandler<R = void, P0 = unknown, P1 = CDUnknownBlockType>(__queryCanAddSiblingTileForWindow: P0, _responseHandler: P1): R;
    _fullScreenTileFrame<R = CGRect>(): R;
    ...
    _actualMinFullScreenContentSize<R = CGSize>(): R;
    _minFullScreenContentSizeForFrame<R = CGSize, P0 = CGRect>(__minFullScreenContentSizeForFrame: P0): R;
    _setTileMinSize_tileMaxSize_tilePreferredSize<R = void, P0 = CGSize, P1 = CGSize, P2 = CGSize>(__setTileMinSize: P0, _tileMaxSize: P1, _tilePreferredSize: P2): R;
    ...
    _beginATUWindowDragForGreenButtonPressAtLocation<R = void, P0 = CGPoint>(__beginATUWindowDragForGreenButtonPressAtLocation: P0): R;
    ...
    _frameForFullScreenModeInRect<R = CGRect, P0 = CGRect>(__frameForFullScreenModeInRect: P0): R;
    _frameForFullScreenMode<R = CGRect>(): R;
    ...
    _cgsWindow<R = NSCGSWindow>(): R;
    tabGroup<R = NSWindowTabGroup>(): R;
    tabbedWindows<R = NSArray>(): R;
    ...
    appearanceSource<R = NSAppearanceCustomization>(): R;
    setAppearanceSource<R = void, P0 = NSAppearanceCustomization>(_v: P0): R;
    ...
    childWindows<R = NSArray>(): R;
    sheetParent<R = NSWindow>(): R;
    sheet<R = boolean>(): R;
    attachedSheet<R = NSWindow>(): R;
    sheets<R = NSArray>(): R;
    ...
    setContentMaxSize<R = void, P0 = CGSize>(_v: P0): R;
    contentMinSize<R = CGSize>(): R;
    setContentMinSize<R = void, P0 = CGSize>(_v: P0): R;
    maxSize<R = CGSize>(): R;
    ...
    deepestScreen<R = NSScreen>(): R;
    frameAutosaveName<R = NSString>(): R;
    ...
    miniwindowTitle<R = NSString>(): R;
    setMiniwindowTitle<R = void, P0 = NSString>(_v: P0): R;
    miniwindowImage<R = NSImage>(): R;
    setMiniwindowImage<R = void, P0 = NSImage>(_v: P0): R;
    canHide<R = boolean>(): R;
    ...
    contentAspectRatio<R = CGSize>(): R;
    setContentAspectRatio<R = void, P0 = CGSize>(_v: P0): R;
    contentResizeIncrements<R = CGSize>(): R;
    setContentResizeIncrements<R = void, P0 = CGSize>(_v: P0): R;
    aspectRatio<R = CGSize>(): R;
    setAspectRatio<R = void, P0 = CGSize>(_v: P0): R;
    resizeIncrements<R = CGSize>(): R;
    setResizeIncrements<R = void, P0 = CGSize>(_v: P0): R;
    frame<R = CGRect>(): R;
    contentLayoutGuide<R = unknown>(): R;
    contentLayoutRect<R = CGRect>(): R;
    titlebarAccessoryViewControllers<R = NSArray>(): R;
    setTitlebarAccessoryViewControllers<R = void, P0 = NSArray>(_v: P0): R;
    windowNumber<R = number>(): R;
    delegate<R = NSWindowDelegate>(): R;
    setDelegate<R = void, P0 = NSWindowDelegate>(_v: P0): R;
    contentView<R = NSView>(): R;
    setContentView<R = void, P0 = NSView>(_v: P0): R;
    representedFilename<R = NSString>(): R;
    setRepresentedFilename<R = void, P0 = NSString>(_v: P0): R;
    representedURL<R = NSURL>(): R;
    setRepresentedURL<R = void, P0 = NSURL>(_v: P0): R;
    title<R = NSString>(): R;
    ...
    _contextForLayerHosting<R = CAContext>(): R;
    ...
    _beforeTabPickerResponder<R = NSResponder>(): R;
    set_beforeTabPickerResponder<R = void, P0 = NSResponder>(_v: P0): R;
    _tabBarItem<R = NSTabBarItem>(): R;
    tab<R = NSWindowTab>(): R;
    _windowStackController<R = NSWindowStackController>(): R;
    set_windowStackController<R = void, P0 = NSWindowStackController>(_v: P0): R;
    _tabBarAccessoryViewController<R = NSTitlebarAccessoryViewController>(): R;
    set_tabBarAccessoryViewController<R = void, P0 = NSTitlebarAccessoryViewController>(_v: P0): R;
  ...
  namespace classes {
    export interface NSWindow<T = any> extends NSResponder, NSTouchBarProviderContainerProtocol, NSAppearanceCustomizationInternalProtocol, NSAnimatablePropertyContainerProtocol, NSMenuItemValidationProtocol, NSUserInterfaceValidationsProtocol, NSUserInterfaceItemIdentificationProtocol, NSAppearanceCustomizationProtocol, NSAccessibilityElementProtocol, NSAccessibilityProtocol {
      ...
      _modalSessionForShownService<R = _NSModalSession, P0 = unknown>(__modalSessionForShownService: P0): R;
      removeFrameUsingName<R = void, P0 = unknown>(_removeFrameUsingName: P0): R;
      _savedFrameFromString<R = CGRect, P0 = unknown>(__savedFrameFromString: P0): R;
      ...
      windowNumberAtPoint_belowWindowWithWindowNumber<R = number, P0 = CGPoint, P1 = number>(_windowNumberAtPoint: P0, _belowWindowWithWindowNumber: P1): R;
      _minimizeAll<R = void>(): R;
      _batchMinimizeWindowsWithBlock<R = boolean, P0 = CDUnknownBlockType>(__batchMinimizeWindowsWithBlock: P0): R;
      _baseModalWindowLevel<R = number>(): R;
      _setBaseWindowModalLevel<R = void, P0 = number>(__setBaseWindowModalLevel: P0): R;
      _batchOrderWindows_withBlock<R = boolean, P0 = number, P1 = CDUnknownBlockType>(__batchOrderWindows: P0, _withBlock: P1): R;
      ...
      coreUIRenderer<R = OpaqueCUIRendererRef>(): R;
      ...
      _mouseHysteresisCheck_withExpiration_andDistance_finalMouseLocation<R = number, P0 = unknown, P1 = unknown, P2 = CGSize, P3 = CGPoint>(__mouseHysteresisCheck: P0, _withExpiration: P1, _andDistance: P2, _finalMouseLocation: P3): R;
