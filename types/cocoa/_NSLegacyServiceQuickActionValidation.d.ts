...
declare namespace cocoa {
  export interface _NSLegacyServiceQuickActionValidation<T = any> extends cocoa.NSObject, cocoa._NSQuickActionValidationProtocol {
  ...
  namespace classes {
    export interface _NSLegacyServiceQuickActionValidation<T = any> extends cocoa.classes.NSObject, cocoa.classes._NSQuickActionValidationProtocol {
