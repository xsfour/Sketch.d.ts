...
declare namespace cocoa {
  export interface _NSUndoLightInvocation<T = any> extends cocoa._NSUndoObject {
  ...
  namespace classes {
    export interface _NSUndoLightInvocation<T = any> extends cocoa.classes._NSUndoObject {
