...
declare namespace cocoa {
  export interface NSThemeAutosaveButton<T = any> extends cocoa.NSButton, cocoa.NSPopoverDelegateProtocol {
    ...
    _showDocumentPopoverThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__showDocumentPopoverThenContinue: P0): R;
    _repositionPopover<R = void>(): R;
    _popoverPositioningRectInSuperview<R = cocoa.CGRect>(): R;
    ...
    _showOrHideArrowAnimate_completionBlock<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(__showOrHideArrowAnimate: P0, _completionBlock: P1): R;
    _cancelFadeAnimationDelay<R = void>(): R;
    _setAnimationCompletionBlock_withDuration<R = void, P0 = cocoa.CDUnknownBlockType, P1 = number>(__setAnimationCompletionBlock: P0, _withDuration: P1): R;
    ...
    nonModalDocumentError<R = cocoa.NSError>(): R;
    setNonModalDocumentError<R = void, P0 = cocoa.NSError>(_v: P0): R;
    documentAutosavingError<R = cocoa.NSError>(): R;
    setDocumentAutosavingError<R = void, P0 = cocoa.NSError>(_v: P0): R;
    displayedPopover<R = cocoa.NSPopover>(): R;
  ...
  namespace classes {
    export interface NSThemeAutosaveButton<T = any> extends cocoa.classes.NSButton, cocoa.classes.NSPopoverDelegateProtocol {
