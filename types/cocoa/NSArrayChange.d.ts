...
declare namespace cocoa {
  export interface NSArrayChange<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSArrayChange<T = any> extends cocoa.classes.NSObject {
...
declare const NSArrayChange: cocoa.classes.NSArrayChange;
