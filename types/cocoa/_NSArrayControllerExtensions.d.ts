...
declare namespace cocoa {
  export interface _NSArrayControllerExtensions<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSArrayControllerExtensions<T = any> extends cocoa.classes.NSObject {
