...
declare namespace cocoa {
  export interface NSOpenGLPixelBuffer<T = any> extends cocoa.NSObject {
    ...
    CGLPBufferObj<R = cocoa._CGLPBufferObject>(): R;
    dealloc<R = void>(): R;
    initWithCGLPBufferObj<R = unknown, P0 = cocoa._CGLPBufferObject>(_initWithCGLPBufferObj: P0): R;
  ...
  namespace classes {
    export interface NSOpenGLPixelBuffer<T = any> extends cocoa.classes.NSObject {
      alloc<R = NSOpenGLPixelBuffer>(): R;
      new: <R = NSOpenGLPixelBuffer>() => R;
      initialize<R = void>(): R;
      openGLPixelBufferWithCGLPBufferObj<R = unknown, P0 = cocoa._CGLPBufferObject>(_openGLPixelBufferWithCGLPBufferObj: P0): R;
    }
  }
}
