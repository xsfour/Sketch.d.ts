...
declare namespace cocoa {
  export interface NSFileHandle<T = any> extends cocoa.NSObject, cocoa.NSSecureCodingProtocol {
    _closeOnDealloc<R = void>(): R;
    setReadabilityHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_setReadabilityHandler: P0): R;
    readabilityHandler<R = cocoa.CDUnknownBlockType>(): R;
    setWriteabilityHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_setWriteabilityHandler: P0): R;
    writeabilityHandler<R = cocoa.CDUnknownBlockType>(): R;
    ...
    availableData<R = cocoa.NSData>(): R;
  }
  namespace classes {
    export interface NSFileHandle<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSSecureCodingProtocol {
