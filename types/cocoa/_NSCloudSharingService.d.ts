...
declare namespace cocoa {
  export interface _NSCloudSharingService<T = any> extends cocoa.NSSharingService, cocoa.NSPopoverDelegateProtocol, cocoa.NSWindowDelegateProtocol {
    ...
    _showParticipantListServiceInPopoverWithItems_anchoringView_relativeToRect_preferredEdge<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CGRect, P3 = number>(__showParticipantListServiceInPopoverWithItems: P0, _anchoringView: P1, _relativeToRect: P2, _preferredEdge: P3): R;
    ...
    _showAddPeopleServiceForItem_relativeToWindow_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__showAddPeopleServiceForItem: P0, _relativeToWindow: P1, _completionHandler: P2): R;
  ...
  namespace classes {
    export interface _NSCloudSharingService<T = any> extends cocoa.classes.NSSharingService, cocoa.classes.NSPopoverDelegateProtocol, cocoa.classes.NSWindowDelegateProtocol {
