...
declare namespace cocoa {
  export interface NSKeyValueSlowMutableCollectionGetter<T = any> extends cocoa.NSKeyValueProxyGetter {
  ...
  namespace classes {
    export interface NSKeyValueSlowMutableCollectionGetter<T = any> extends cocoa.classes.NSKeyValueProxyGetter {
