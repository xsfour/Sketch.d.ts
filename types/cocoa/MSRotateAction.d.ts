...
declare namespace cocoa {
  export interface MSRotateAction<T = any> extends cocoa.MSEventHandlerAction {
    label<R = unknown>(): R;
    tooltip<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSRotateAction<T = any> extends cocoa.classes.MSEventHandlerAction {
