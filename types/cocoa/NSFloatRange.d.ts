...
declare namespace cocoa {
  export interface NSFloatRange<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSFloatRange<T = any> extends cocoa.classes.NSObject {
...
declare const NSFloatRange: cocoa.classes.NSFloatRange;
