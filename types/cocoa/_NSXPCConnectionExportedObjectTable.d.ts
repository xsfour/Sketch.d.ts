...
declare namespace cocoa {
  export interface _NSXPCConnectionExportedObjectTable<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSXPCConnectionExportedObjectTable<T = any> extends cocoa.classes.NSObject {
