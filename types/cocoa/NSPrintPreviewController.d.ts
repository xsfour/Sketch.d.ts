...
declare namespace cocoa {
  export interface NSPrintPreviewController<T = any> extends cocoa.NSViewController {
    ...
    stop<R = void>(): R;
    start<R = void>(): R;
    setMaxViewFrameSize<R = void, P0 = cocoa.CGSize>(_setMaxViewFrameSize: P0): R;
    _checkSizeValidity<R = boolean, P0 = cocoa.CGSize>(__checkSizeValidity: P0): R;
    _checkOriginValidity<R = boolean, P0 = cocoa.CGPoint>(__checkOriginValidity: P0): R;
    _tileView<R = void>(): R;
  ...
  namespace classes {
    export interface NSPrintPreviewController<T = any> extends cocoa.classes.NSViewController {
