...
declare namespace cocoa {
  export interface NSAccessibilitySliderValueIndicator<T = any> extends cocoa.NSAccessibilityMockUIElement {
  ...
  namespace classes {
    export interface NSAccessibilitySliderValueIndicator<T = any> extends cocoa.classes.NSAccessibilityMockUIElement {
