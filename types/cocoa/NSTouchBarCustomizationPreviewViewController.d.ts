...
declare namespace cocoa {
  export interface NSTouchBarCustomizationPreviewViewController<T = any> extends cocoa.NSViewController, cocoa.NSTouchBarCustomizationPreviewInteractionCoordinatorDelegateProtocol, cocoa.NSCollectionViewDelegateDFRCustomizationLayoutProtocol, cocoa.NSCollectionViewDataSourceProtocol, cocoa.NSTouchBarCustomizationPreviewFlexibleSectionLayoutDelegateProtocol, cocoa.NSTouchBarCustomizationPreviewMiniControlStripSectionLayoutDelegateProtocol {
    cxx_destruct<R = void>(): R;
    indexPathForInsertingItemWithFrame_withApproximateIndex<R = unknown, P0 = cocoa.CGRect, P1 = unknown>(_indexPathForInsertingItemWithFrame: P0, _withApproximateIndex: P1): R;
    ...
    paddingForSection<R = cocoa.NSEdgeInsets, P0 = number>(_paddingForSection: P0): R;
    containmentRectForSection<R = cocoa.CGRect, P0 = number>(_containmentRectForSection: P0): R;
    ...
    updateModel_animated<R = void, P0 = cocoa.CDUnknownBlockType, P1 = boolean>(_updateModel: P0, _animated: P1): R;
    ...
    cursorMouseUpAtPoint<R = cocoa.CGPoint, P0 = cocoa.CGPoint>(_cursorMouseUpAtPoint: P0): R;
    cursorMouseDownAtPoint<R = void, P0 = cocoa.CGPoint>(_cursorMouseDownAtPoint: P0): R;
    cursorMovedToPoint_withDelta_mouseIsDown<R = cocoa.CGPoint, P0 = cocoa.CGPoint, P1 = cocoa.CGSize, P2 = boolean>(_cursorMovedToPoint: P0, _withDelta: P1, _mouseIsDown: P2): R;
    cursorExitAtPoint_withItem<R = void, P0 = cocoa.CGPoint, P1 = unknown>(_cursorExitAtPoint: P0, _withItem: P1): R;
    cursorEnterAtPoint_mouseIsDown_withPreset<R = cocoa.CGPoint, P0 = cocoa.CGPoint, P1 = boolean, P2 = unknown>(_cursorEnterAtPoint: P0, _mouseIsDown: P1, _withPreset: P2): R;
    cursorEnterAtPoint_mouseIsDown_withItem<R = cocoa.CGPoint, P0 = cocoa.CGPoint, P1 = boolean, P2 = unknown>(_cursorEnterAtPoint: P0, _mouseIsDown: P1, _withItem: P2): R;
    ...
    systemBarRect<R = cocoa.CGRect>(): R;
    setSystemBarRect<R = void, P0 = cocoa.CGRect>(_v: P0): R;
    cursorPoint<R = cocoa.CGPoint>(): R;
    setCursorPoint<R = void, P0 = cocoa.CGPoint>(_v: P0): R;
    systemTrayRect<R = cocoa.CGRect>(): R;
    setSystemTrayRect<R = void, P0 = cocoa.CGRect>(_v: P0): R;
    applicationRect<R = cocoa.CGRect>(): R;
    setApplicationRect<R = void, P0 = cocoa.CGRect>(_v: P0): R;
    escKeyRect<R = cocoa.CGRect>(): R;
    setEscKeyRect<R = void, P0 = cocoa.CGRect>(_v: P0): R;
    delegate<R = cocoa.NSTouchBarCustomizationPreviewViewControllerDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSTouchBarCustomizationPreviewViewControllerDelegate>(_v: P0): R;
    expandedControlStripItemTree<R = cocoa.NSTouchBarItemTree>(): R;
    setExpandedControlStripItemTree<R = void, P0 = cocoa.NSTouchBarItemTree>(_v: P0): R;
    miniControlStripItemTree<R = cocoa.NSTouchBarItemTree>(): R;
    setMiniControlStripItemTree<R = void, P0 = cocoa.NSTouchBarItemTree>(_v: P0): R;
    applicationItemTree<R = cocoa.NSTouchBarItemTree>(): R;
    setApplicationItemTree<R = void, P0 = cocoa.NSTouchBarItemTree>(_v: P0): R;
  ...
  namespace classes {
    export interface NSTouchBarCustomizationPreviewViewController<T = any> extends cocoa.classes.NSViewController, cocoa.classes.NSTouchBarCustomizationPreviewInteractionCoordinatorDelegateProtocol, cocoa.classes.NSCollectionViewDelegateDFRCustomizationLayoutProtocol, cocoa.classes.NSCollectionViewDataSourceProtocol, cocoa.classes.NSTouchBarCustomizationPreviewFlexibleSectionLayoutDelegateProtocol, cocoa.classes.NSTouchBarCustomizationPreviewMiniControlStripSectionLayoutDelegateProtocol {
