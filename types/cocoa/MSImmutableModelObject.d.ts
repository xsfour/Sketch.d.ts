...
declare namespace cocoa {
  export interface MSImmutableModelObject<T = any> extends cocoa.MSModelObjectCommon, cocoa.MSModelObjectProtocol, cocoa.MSCodingProtocol {
    ...
    enumerateMigrations_fromVersion_toVersion_block<R = void, P0 = string, P1 = number, P2 = number, P3 = cocoa.CDUnknownBlockType>(_enumerateMigrations: P0, _fromVersion: P1, _toVersion: P2, _block: P3): R;
    performInitWithUnarchiver<R = void, P0 = unknown>(_performInitWithUnarchiver: P0): R;
    initWithUnarchiver_decodeBlock<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_initWithUnarchiver: P0, _decodeBlock: P1): R;
    ...
    overlayRectForAncestors_document<R = cocoa.CGRect, P0 = unknown, P1 = unknown>(_overlayRectForAncestors: P0, _document: P1): R;
    influenceRectForAncestors_document<R = cocoa.CGRect, P0 = unknown, P1 = unknown>(_influenceRectForAncestors: P0, _document: P1): R;
    subObjectsForTreeDiff<R = cocoa.NSArray>(): R;
  ...
  namespace classes {
    export interface MSImmutableModelObject<T = any> extends cocoa.classes.MSModelObjectCommon, cocoa.classes.MSModelObjectProtocol, cocoa.classes.MSCodingProtocol {
