...
declare namespace cocoa {
  export interface NSContentSizeLayoutConstraint<T = any> extends cocoa.NSLayoutConstraint {
  ...
  namespace classes {
    export interface NSContentSizeLayoutConstraint<T = any> extends cocoa.classes.NSLayoutConstraint {
