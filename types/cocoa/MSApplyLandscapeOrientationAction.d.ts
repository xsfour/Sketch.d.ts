...
declare namespace cocoa {
  export interface MSApplyLandscapeOrientationAction<T = any> extends cocoa.MSApplyOrientationAction {
    label<R = unknown>(): R;
    applyLandscapeOrientation<R = void, P0 = unknown>(_applyLandscapeOrientation: P0): R;
  }
  namespace classes {
    export interface MSApplyLandscapeOrientationAction<T = any> extends cocoa.classes.MSApplyOrientationAction {
