...
declare namespace cocoa {
  export interface NSSliderAccessory<T0 = void, T1 = void, T2 = void> extends NSObject, NSCodingProtocol, NSAccessibilityProtocol, NSAccessibilityElementProtocol {
    ...
    container<R = NSSliderAccessoryContainer>(): R;
    setContainer<R = void, P0 = NSSliderAccessoryContainer>(_v: P0): R;
    behavior<R = NSSliderAccessoryBehavior>(): R;
    setBehavior<R = void, P0 = NSSliderAccessoryBehavior>(_v: P0): R;
    enabled<R = boolean>(): R;
    ...
    enclosingSlider<R = NSSlider>(): R;
    setEnclosingSlider<R = void, P0 = NSSlider>(_v: P0): R;
