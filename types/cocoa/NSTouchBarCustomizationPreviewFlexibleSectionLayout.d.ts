...
declare namespace cocoa {
  export interface NSTouchBarCustomizationPreviewFlexibleSectionLayout<T = any> extends cocoa.NSTouchBarCustomizationPreviewSectionLayout {
    defaultItemPadding<R = number>(): R;
    setDefaultItemPadding<R = void, P0 = number>(_v: P0): R;
  }
  namespace classes {
    export interface NSTouchBarCustomizationPreviewFlexibleSectionLayout<T = any> extends cocoa.classes.NSTouchBarCustomizationPreviewSectionLayout {
