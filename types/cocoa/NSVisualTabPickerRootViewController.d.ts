...
declare namespace cocoa {
  export interface NSVisualTabPickerRootViewController<T = any> extends cocoa.NSViewController, cocoa.NSVisualTabPickerSearchFieldDelegateProtocol, cocoa.NSVisualTabPickerGridViewDataSourceProtocol, cocoa.NSVisualTabPickerGridViewDelegateProtocol {
    ...
    _filterObjectsInArray_usingBlock<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__filterObjectsInArray: P0, _usingBlock: P1): R;
    ...
    _makeTabPickerBackdropVisualEffectViewWithFrame<R = unknown, P0 = cocoa.CGRect>(__makeTabPickerBackdropVisualEffectViewWithFrame: P0): R;
    ...
    sidebarSnapshot<R = cocoa.NSImage>(): R;
    setSidebarSnapshot<R = void, P0 = cocoa.NSImage>(_v: P0): R;
    tabBarSnapshot<R = cocoa.NSImage>(): R;
    setTabBarSnapshot<R = void, P0 = cocoa.NSImage>(_v: P0): R;
    ...
    delegate<R = cocoa.NSVisualTabPickerDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSVisualTabPickerDelegate>(_v: P0): R;
  ...
  namespace classes {
    export interface NSVisualTabPickerRootViewController<T = any> extends cocoa.classes.NSViewController, cocoa.classes.NSVisualTabPickerSearchFieldDelegateProtocol, cocoa.classes.NSVisualTabPickerGridViewDataSourceProtocol, cocoa.classes.NSVisualTabPickerGridViewDelegateProtocol {
