...
declare namespace cocoa {
  export interface NSBitmapGraphicsContext<T = any> extends cocoa.NSWindowGraphicsContext {
  ...
  namespace classes {
    export interface NSBitmapGraphicsContext<T = any> extends cocoa.classes.NSWindowGraphicsContext {
