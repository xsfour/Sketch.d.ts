...
declare namespace cocoa {
  export interface _NSJSONRoundTrippingNumber<T = any> extends cocoa.NSObject, cocoa.NSSecureCodingProtocol {
  ...
  namespace classes {
    export interface _NSJSONRoundTrippingNumber<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSSecureCodingProtocol {
