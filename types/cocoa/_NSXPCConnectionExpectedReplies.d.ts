...
declare namespace cocoa {
  export interface _NSXPCConnectionExpectedReplies<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSXPCConnectionExpectedReplies<T = any> extends cocoa.classes.NSObject {
