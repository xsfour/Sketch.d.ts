...
declare namespace cocoa {
  export interface NSPrintThumbnailView<T = any> extends cocoa.NSView {
  ...
  namespace classes {
    export interface NSPrintThumbnailView<T = any> extends cocoa.classes.NSView {
...
declare const NSPrintThumbnailView: cocoa.classes.NSPrintThumbnailView;
