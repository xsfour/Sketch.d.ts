...
declare namespace cocoa {
  export interface MSShowReplaceColorSheetAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    showReplaceColorSheet<R = void, P0 = unknown>(_showReplaceColorSheet: P0): R;
    validate<R = boolean>(): R;
  }
  namespace classes {
    export interface MSShowReplaceColorSheetAction<T = any> extends cocoa.classes.MSDocumentAction {
