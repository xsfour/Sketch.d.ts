...
declare namespace cocoa {
  export interface MSConstraintPinLeftAction<T = any> extends cocoa.MSConstraintAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSConstraintPinLeftAction<T = any> extends cocoa.classes.MSConstraintAction {
