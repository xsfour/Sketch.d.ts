...
declare namespace cocoa {
  export interface _NSCloudSharingOverQuotaRecoveryAttempter<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSCloudSharingOverQuotaRecoveryAttempter<T = any> extends cocoa.classes.NSObject {
