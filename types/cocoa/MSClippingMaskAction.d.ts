...
declare namespace cocoa {
  export interface MSClippingMaskAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSClippingMaskAction<T = any> extends cocoa.classes.MSDocumentAction {
