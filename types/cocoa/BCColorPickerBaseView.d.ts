...
declare namespace cocoa {
  export interface BCColorPickerBaseView<T = any> extends cocoa.NSControl {
    cxx_destruct<R = void>(): R;
    drawMarkerInRect<R = void, P0 = cocoa.CGRect>(_drawMarkerInRect: P0): R;
    markerShadow<R = unknown>(): R;
    drawCheckerboardPatternInRect<R = void, P0 = cocoa.CGRect>(_drawCheckerboardPatternInRect: P0): R;
  ...
  namespace classes {
    export interface BCColorPickerBaseView<T = any> extends cocoa.classes.NSControl {
      alloc<R = BCColorPickerBaseView>(): R;
      new: <R = BCColorPickerBaseView>() => R;
      darkShadow<R = unknown>(): R;
      drawFrameInRect_forView_block<R = void, P0 = cocoa.CGRect, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_drawFrameInRect: P0, _forView: P1, _block: P2): R;
      drawFrameInRect_outlineWidth_block<R = void, P0 = cocoa.CGRect, P1 = number, P2 = cocoa.CDUnknownBlockType>(_drawFrameInRect: P0, _outlineWidth: P1, _block: P2): R;
    }
  }
}
