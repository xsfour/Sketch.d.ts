...
declare namespace cocoa {
  export interface MSRotateCounterclockwiseAction<T = any> extends cocoa.MSEventHandlerAction {
    label<R = unknown>(): R;
    rotate90CC<R = void, P0 = unknown>(_rotate90CC: P0): R;
  }
  namespace classes {
    export interface MSRotateCounterclockwiseAction<T = any> extends cocoa.classes.MSEventHandlerAction {
