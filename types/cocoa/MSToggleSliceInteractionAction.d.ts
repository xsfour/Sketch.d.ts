...
declare namespace cocoa {
  export interface MSToggleSliceInteractionAction<T = any> extends cocoa.MSToggleViewPreferenceAction {
  ...
  namespace classes {
    export interface MSToggleSliceInteractionAction<T = any> extends cocoa.classes.MSToggleViewPreferenceAction {
