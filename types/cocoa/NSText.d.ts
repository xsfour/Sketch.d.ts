...
declare namespace cocoa {
  export interface NSText<T = any> extends cocoa.NSView, cocoa.NSChangeSpellingProtocol, cocoa.NSIgnoreMisspelledWordsProtocol {
    scrollRangeToVisible<R = void, P0 = cocoa._NSRange>(_scrollRangeToVisible: P0): R;
    ...
    sizeToFit<R = void>(): R;
    setFont_range<R = void, P0 = unknown, P1 = cocoa._NSRange>(_setFont: P0, _range: P1): R;
    setTextColor_range<R = void, P0 = unknown, P1 = cocoa._NSRange>(_setTextColor: P0, _range: P1): R;
    ...
    replaceCharactersInRange_withRTFD<R = void, P0 = cocoa._NSRange, P1 = unknown>(_replaceCharactersInRange: P0, _withRTFD: P1): R;
    replaceCharactersInRange_withRTF<R = void, P0 = cocoa._NSRange, P1 = unknown>(_replaceCharactersInRange: P0, _withRTF: P1): R;
    RTFDFromRange<R = unknown, P0 = cocoa._NSRange>(_RTFDFromRange: P0): R;
    RTFFromRange<R = unknown, P0 = cocoa._NSRange>(_RTFFromRange: P0): R;
    ...
    accessibilityStyleRangeForCharacterIndex<R = cocoa._NSRange, P0 = number>(_accessibilityStyleRangeForCharacterIndex: P0): R;
    accessibilityAXAttributedStringForCharacterRange_parent<R = unknown, P0 = cocoa._NSRange, P1 = unknown>(_accessibilityAXAttributedStringForCharacterRange: P0, _parent: P1): R;
    accessibilityRTFForCharacterRange<R = unknown, P0 = cocoa._NSRange>(_accessibilityRTFForCharacterRange: P0): R;
    accessibilityBoundsForCharacterRange<R = cocoa.CGRect, P0 = cocoa._NSRange>(_accessibilityBoundsForCharacterRange: P0): R;
    accessibilityCharacterRangeForPosition<R = cocoa._NSRange, P0 = cocoa.CGPoint>(_accessibilityCharacterRangeForPosition: P0): R;
    accessibilityCharacterRangeForLineNumber<R = cocoa._NSRange, P0 = number>(_accessibilityCharacterRangeForLineNumber: P0): R;
    accessibilityLineNumberForCharacterIndex<R = number, P0 = number>(_accessibilityLineNumberForCharacterIndex: P0): R;
    accessibilitySetVisibleCharacterRange<R = void, P0 = cocoa._NSRange>(_accessibilitySetVisibleCharacterRange: P0): R;
    accessibilityIsVisibleCharacterRangeSettable<R = boolean>(): R;
    accessibilityTextView<R = unknown>(): R;
    accessibilitySetSelectedRange<R = void, P0 = cocoa._NSRange>(_accessibilitySetSelectedRange: P0): R;
    accessibilityIsSelectedRangeSettable<R = boolean>(): R;
    accessibilitySelectedRange<R = cocoa._NSRange>(): R;
    ...
    setSelectedRange<R = void, P0 = cocoa._NSRange>(_v: P0): R;
    ...
    delegate<R = cocoa.NSTextDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSTextDelegate>(_v: P0): R;
  ...
  namespace classes {
    export interface NSText<T = any> extends cocoa.classes.NSView, cocoa.classes.NSChangeSpellingProtocol, cocoa.classes.NSIgnoreMisspelledWordsProtocol {
      alloc<R = NSText>(): R;
      new: <R = NSText>() => R;
