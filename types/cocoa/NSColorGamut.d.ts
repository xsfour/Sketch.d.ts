...
declare namespace cocoa {
  export interface NSColorGamut<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
    ...
    hash<R = number>(): R;
    containsCGColor<R = boolean, P0 = cocoa.CGColor>(_containsCGColor: P0): R;
    volume<R = number>(): R;
    infinite<R = boolean>(): R;
    empty<R = boolean>(): R;
  }
  namespace classes {
    export interface NSColorGamut<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
      alloc<R = NSColorGamut>(): R;
      new: <R = NSColorGamut>() => R;
      gamutWithCGColorSpace<R = unknown, P0 = cocoa.CGColorSpace>(_gamutWithCGColorSpace: P0): R;
