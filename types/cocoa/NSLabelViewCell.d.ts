...
declare namespace cocoa {
  export interface NSLabelViewCell<T = any> extends cocoa.NSActionCell {
    ...
    _handleMouseMovedForEvent_withFrame_inView<R = void, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown>(__handleMouseMovedForEvent: P0, _withFrame: P1, _inView: P2): R;
    _currentLabelName<R = unknown>(): R;
    _nameForLabelPart<R = unknown, P0 = number>(__nameForLabelPart: P0): R;
    _partAtPoint_inFrame<R = number, P0 = cocoa.CGPoint, P1 = cocoa.CGRect>(__partAtPoint: P0, _inFrame: P1): R;
    _drawPart_withFrame<R = void, P0 = number, P1 = cocoa.CGRect>(__drawPart: P0, _withFrame: P1): R;
    _drawBackgroundForPartRect_isPressedOrHovered<R = void, P0 = cocoa.CGRect, P1 = boolean>(__drawBackgroundForPartRect: P0, _isPressedOrHovered: P1): R;
    _boundsForLabel_withFrame<R = cocoa.CGRect, P0 = unknown, P1 = cocoa.CGRect>(__boundsForLabel: P0, _withFrame: P1): R;
    _labelAttributes<R = unknown>(): R;
    part_boundsWithFrame<R = cocoa.CGRect, P0 = number, P1 = cocoa.CGRect>(_part: P0, _boundsWithFrame: P1): R;
    ...
    _rectForPart<R = cocoa.CGRect, P0 = number>(__rectForPart: P0): R;
  ...
  namespace classes {
    export interface NSLabelViewCell<T = any> extends cocoa.classes.NSActionCell {
