...
declare namespace cocoa {
  export interface _NSPersonNameComponentsStyleFormatterAbbreviated<T = any> extends cocoa._NSPersonNameComponentsStyleFormatter {
  ...
  namespace classes {
    export interface _NSPersonNameComponentsStyleFormatterAbbreviated<T = any> extends cocoa.classes._NSPersonNameComponentsStyleFormatter {
