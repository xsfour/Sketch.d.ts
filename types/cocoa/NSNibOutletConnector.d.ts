...
declare namespace cocoa {
  export interface NSNibOutletConnector<T = any> extends cocoa.NSNibConnector {
  ...
  namespace classes {
    export interface NSNibOutletConnector<T = any> extends cocoa.classes.NSNibConnector {
