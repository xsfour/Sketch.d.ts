...
declare namespace cocoa {
  export interface NSTouchBarCustomizationPalettePresetItem<T = any> extends cocoa.NSCollectionViewItem {
  ...
  namespace classes {
    export interface NSTouchBarCustomizationPalettePresetItem<T = any> extends cocoa.classes.NSCollectionViewItem {
