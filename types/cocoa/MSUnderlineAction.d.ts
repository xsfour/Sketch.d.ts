...
declare namespace cocoa {
  export interface MSUnderlineAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSUnderlineAction<T = any> extends cocoa.classes.MSDocumentAction {
