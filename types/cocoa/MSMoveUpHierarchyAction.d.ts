...
declare namespace cocoa {
  export interface MSMoveUpHierarchyAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSMoveUpHierarchyAction<T = any> extends cocoa.classes.MSDocumentAction {
