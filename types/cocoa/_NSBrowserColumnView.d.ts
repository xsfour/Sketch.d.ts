...
declare namespace cocoa {
  export interface _NSBrowserColumnView<T = any> extends cocoa.NSScrollView {
    ...
    columnResizeButtonRect<R = cocoa.CGRect>(): R;
    ...
    _columnDividerLineRect<R = cocoa.CGRect>(): R;
  }
  namespace classes {
    export interface _NSBrowserColumnView<T = any> extends cocoa.classes.NSScrollView {
