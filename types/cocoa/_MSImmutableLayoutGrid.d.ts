...
declare namespace cocoa {
  export interface _MSImmutableLayoutGrid<T = any> extends cocoa.MSImmutableBaseGrid {
  ...
  namespace classes {
    export interface _MSImmutableLayoutGrid<T = any> extends cocoa.classes.MSImmutableBaseGrid {
