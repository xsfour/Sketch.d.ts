...
declare namespace cocoa {
  export interface NSScreen<T = any> extends cocoa.NSObject {
    _isActiveScreen<R = boolean>(): R;
    _currentSpace<R = number>(): R;
    imageInRect_underWindow<R = unknown, P0 = cocoa.CGRect, P1 = unknown>(_imageInRect: P0, _underWindow: P1): R;
    ...
    addUpdateHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_addUpdateHandler: P0): R;
    supportedWindowDepths<R = number>(): R;
    deviceDescription<R = cocoa.NSDictionary>(): R;
    visibleFrame<R = cocoa.CGRect>(): R;
  ...
  namespace classes {
    export interface NSScreen<T = any> extends cocoa.classes.NSObject {
      alloc<R = NSScreen>(): R;
      new: <R = NSScreen>() => R;
      _cgScreenPointForPoint<R = cocoa.CGPoint, P0 = cocoa.CGPoint>(__cgScreenPointForPoint: P0): R;
