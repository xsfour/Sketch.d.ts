...
declare namespace cocoa {
  export interface BCZipableFile<T = any> extends cocoa.NSObject {
    ...
    objectToEncode<R = cocoa.NSObject>(): R;
    subPath<R = cocoa.NSString>(): R;
  }
  namespace classes {
    export interface BCZipableFile<T = any> extends cocoa.classes.NSObject {
