...
declare namespace cocoa {
  export interface NSSegmentItemImageCell<T = any> extends cocoa.NSImageCell {
  ...
  namespace classes {
    export interface NSSegmentItemImageCell<T = any> extends cocoa.classes.NSImageCell {
