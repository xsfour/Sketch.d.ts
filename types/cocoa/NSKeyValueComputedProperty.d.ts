...
declare namespace cocoa {
  export interface NSKeyValueComputedProperty<T = any> extends cocoa.NSKeyValueProperty {
  ...
  namespace classes {
    export interface NSKeyValueComputedProperty<T = any> extends cocoa.classes.NSKeyValueProperty {
...
declare const NSKeyValueComputedProperty: cocoa.classes.NSKeyValueComputedProperty;
