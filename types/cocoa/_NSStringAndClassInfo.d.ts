...
declare namespace cocoa {
  export interface _NSStringAndClassInfo<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
  ...
  namespace classes {
    export interface _NSStringAndClassInfo<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
