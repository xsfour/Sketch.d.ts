...
declare namespace cocoa {
  export interface _NSGestureRecognizerTransformAnalyzer<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSGestureRecognizerTransformAnalyzer<T = any> extends cocoa.classes.NSObject {
