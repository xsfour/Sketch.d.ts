...
declare namespace cocoa {
  export interface _MSImmutableGradientStop<T = any> extends cocoa.MSImmutableModelObject {
  ...
  namespace classes {
    export interface _MSImmutableGradientStop<T = any> extends cocoa.classes.MSImmutableModelObject {
