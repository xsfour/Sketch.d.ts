...
declare namespace cocoa {
  export interface _NSCGSWindowMovementChildren<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSCGSWindowMovementChildren<T = any> extends cocoa.classes.NSObject {
