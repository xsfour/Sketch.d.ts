...
declare namespace cocoa {
  export interface NSKeyValueObservance<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSKeyValueObservance<T = any> extends cocoa.classes.NSObject {
...
declare const NSKeyValueObservance: cocoa.classes.NSKeyValueObservance;
