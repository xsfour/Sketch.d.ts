...
declare namespace cocoa {
  export interface NSTextStorageCharacterArray<T = any> extends cocoa.NSArray {
  ...
  namespace classes {
    export interface NSTextStorageCharacterArray<T = any> extends cocoa.classes.NSArray {  }
  }
}
