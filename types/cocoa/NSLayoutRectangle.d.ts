...
declare namespace cocoa {
  export interface NSLayoutRectangle<T = any> extends cocoa.NSLayoutRect {
    ...
    centerPoint<R = cocoa.NSLayoutPoint>(): R;
  }
  namespace classes {
    export interface NSLayoutRectangle<T = any> extends cocoa.classes.NSLayoutRect {
...
declare const NSLayoutRectangle: cocoa.classes.NSLayoutRectangle;
