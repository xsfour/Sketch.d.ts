...
declare namespace cocoa {
  export interface AppController<T = any> extends cocoa.NSObject, cocoa.NSApplicationDelegateProtocol, cocoa.NSWindowDelegateProtocol, cocoa.NSMenuDelegateProtocol, cocoa.NSUserNotificationCenterDelegateProtocol, cocoa.MSDataMenuProviderDelegateProtocol, cocoa.MSDataSupplierManagerDelegateProtocol {
    ...
    runPluginCommand_fromMenu_context_onComplete<R = unknown, P0 = unknown, P1 = boolean, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(_runPluginCommand: P0, _fromMenu: P1, _context: P2, _onComplete: P3): R;
    ...
    fontWatcher<R = cocoa.MSFontWatcher>(): R;
    setFontWatcher<R = void, P0 = cocoa.MSFontWatcher>(_v: P0): R;
    componentsPanelController<R = cocoa.MSComponentsPanelController>(): R;
    setComponentsPanelController<R = void, P0 = cocoa.MSComponentsPanelController>(_v: P0): R;
    visualSettings<R = cocoa.NSArray>(): R;
    setVisualSettings<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    documentationSearcher<R = cocoa.MSDocumentationSearcher>(): R;
    setDocumentationSearcher<R = void, P0 = cocoa.MSDocumentationSearcher>(_v: P0): R;
    hud<R = cocoa.MSHUDWindowController>(): R;
    setHud<R = void, P0 = cocoa.MSHUDWindowController>(_v: P0): R;
    migrationSemaphore<R = cocoa.OS_dispatch_semaphore>(): R;
    setMigrationSemaphore<R = void, P0 = cocoa.OS_dispatch_semaphore>(_v: P0): R;
    scriptPath<R = cocoa.NSString>(): R;
    setScriptPath<R = void, P0 = cocoa.NSString>(_v: P0): R;
    ...
    librariesController<R = cocoa.MSAssetLibraryController>(): R;
    actionController<R = cocoa.MSActionController>(): R;
    updateController<R = cocoa.MSUpdateController>(): R;
    licenseManager<R = cocoa.BCLicenseManager>(): R;
    setLicenseManager<R = void, P0 = cocoa.BCLicenseManager>(_v: P0): R;
    pluginManager<R = cocoa.MSPluginManagerWithActions>(): R;
    setPluginManager<R = void, P0 = cocoa.MSPluginManagerWithActions>(_v: P0): R;
    crashLogManager<R = cocoa.MSCrashLogManager>(): R;
    dataFeedProvider<R = cocoa.MSDataMenuProvider>(): R;
    mirrorDataProvider<R = cocoa.MSMirrorDataProvider>(): R;
    setMirrorDataProvider<R = void, P0 = cocoa.MSMirrorDataProvider>(_v: P0): R;
    mirrorController<R = cocoa.SMKMirrorController>(): R;
    setMirrorController<R = void, P0 = cocoa.SMKMirrorController>(_v: P0): R;
    pasteboardManager<R = cocoa.MSPasteboardManager>(): R;
    setPasteboardManager<R = void, P0 = cocoa.MSPasteboardManager>(_v: P0): R;
    updateTimer<R = cocoa.NSTimer>(): R;
    setUpdateTimer<R = void, P0 = cocoa.NSTimer>(_v: P0): R;
    cloudEnvironmentMenuItem<R = cocoa.NSMenuItem>(): R;
    setCloudEnvironmentMenuItem<R = void, P0 = cocoa.NSMenuItem>(_v: P0): R;
    dataFeedMenuItem<R = cocoa.NSMenuItem>(): R;
    setDataFeedMenuItem<R = void, P0 = cocoa.NSMenuItem>(_v: P0): R;
    insertSharedTextStyleMenuItem<R = cocoa.NSMenuItem>(): R;
    setInsertSharedTextStyleMenuItem<R = void, P0 = cocoa.NSMenuItem>(_v: P0): R;
    insertSymbolMenuItem<R = cocoa.NSMenuItem>(): R;
    setInsertSymbolMenuItem<R = void, P0 = cocoa.NSMenuItem>(_v: P0): R;
    debugMenuItem<R = cocoa.NSMenuItem>(): R;
    setDebugMenuItem<R = void, P0 = cocoa.NSMenuItem>(_v: P0): R;
    prototypingMenuItem<R = cocoa.NSMenuItem>(): R;
    setPrototypingMenuItem<R = void, P0 = cocoa.NSMenuItem>(_v: P0): R;
    printMenu<R = cocoa.NSMenu>(): R;
    setPrintMenu<R = void, P0 = cocoa.NSMenu>(_v: P0): R;
    templatesMenu<R = cocoa.NSMenu>(): R;
    setTemplatesMenu<R = void, P0 = cocoa.NSMenu>(_v: P0): R;
    pluginsMenuItem<R = cocoa.NSMenuItem>(): R;
    setPluginsMenuItem<R = void, P0 = cocoa.NSMenuItem>(_v: P0): R;
    ...
    lastRun<R = cocoa.MSPluginCommand>(): R;
  ...
  namespace classes {
    export interface AppController<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSApplicationDelegateProtocol, cocoa.classes.NSWindowDelegateProtocol, cocoa.classes.NSMenuDelegateProtocol, cocoa.classes.NSUserNotificationCenterDelegateProtocol, cocoa.classes.MSDataMenuProviderDelegateProtocol, cocoa.classes.MSDataSupplierManagerDelegateProtocol {
