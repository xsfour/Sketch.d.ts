...
declare namespace cocoa {
  export interface NSColorPickerPencilView<T = any> extends cocoa.NSView {
    ...
    _enumeratePencilsWithBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__enumeratePencilsWithBlock: P0): R;
    ...
    _pencilAtViewPoint<R = unknown, P0 = cocoa.CGPoint>(__pencilAtViewPoint: P0): R;
    _frameOfPencil<R = cocoa.CGRect, P0 = unknown>(__frameOfPencil: P0): R;
    _unobscuredFrameOfPencil<R = cocoa.CGRect, P0 = unknown>(__unobscuredFrameOfPencil: P0): R;
    _calculateFrameForPencil_atRow_column<R = cocoa.CGRect, P0 = unknown, P1 = number, P2 = number>(__calculateFrameForPencil: P0, _atRow: P1, _column: P2): R;
    _calculateFrameForPencil<R = cocoa.CGRect, P0 = unknown>(__calculateFrameForPencil: P0): R;
    ...
    _pencils<R = cocoa.NSArray>(): R;
    _colorList<R = cocoa.NSColorList>(): R;
    _selectedPencil<R = cocoa.NSColoredPencil>(): R;
    _shouldShowFocusRing<R = boolean>(): R;
    _hasFocusRing<R = boolean>(): R;
    _focusedPencil<R = cocoa.NSColoredPencil>(): R;
  }
  namespace classes {
    export interface NSColorPickerPencilView<T = any> extends cocoa.classes.NSView {
