...
declare namespace cocoa {
  export interface MSAutoCappingNumberFormatter<T = any> extends cocoa.MSMathNumberFormatter {
  ...
  namespace classes {
    export interface MSAutoCappingNumberFormatter<T = any> extends cocoa.classes.MSMathNumberFormatter {
