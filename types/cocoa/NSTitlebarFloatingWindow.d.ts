...
declare namespace cocoa {
  export interface NSTitlebarFloatingWindow<T = any> extends cocoa.NSWindow {
    ...
    originalWindow<R = cocoa.NSWindow>(): R;
    setOriginalWindow<R = void, P0 = cocoa.NSWindow>(_v: P0): R;
  }
  namespace classes {
    export interface NSTitlebarFloatingWindow<T = any> extends cocoa.classes.NSWindow {
