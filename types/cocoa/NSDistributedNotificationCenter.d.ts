...
declare namespace cocoa {
  export interface NSDistributedNotificationCenter<T = any> extends cocoa.NSNotificationCenter {
    ...
    addObserverForName_object_suspensionBehavior_queue_usingBlock<R = unknown, P0 = unknown, P1 = unknown, P2 = number, P3 = unknown, P4 = cocoa.CDUnknownBlockType>(_addObserverForName: P0, _object: P1, _suspensionBehavior: P2, _queue: P3, _usingBlock: P4): R;
  ...
  namespace classes {
    export interface NSDistributedNotificationCenter<T = any> extends cocoa.classes.NSNotificationCenter {
