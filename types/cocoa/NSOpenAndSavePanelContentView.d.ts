...
declare namespace cocoa {
  export interface NSOpenAndSavePanelContentView<T = any> extends cocoa.NSView {
    handleClientSideWindowDragEvents<R = boolean>(): R;
    setHandleClientSideWindowDragEvents<R = void, P0 = boolean>(_v: P0): R;
  }
  namespace classes {
    export interface NSOpenAndSavePanelContentView<T = any> extends cocoa.classes.NSView {
