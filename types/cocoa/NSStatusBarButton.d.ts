...
declare namespace cocoa {
  export interface NSStatusBarButton<T = any> extends cocoa.NSButton {
    setDoubleAction<R = void, P0 = string>(_setDoubleAction: P0): R;
    doubleAction<R = string>(): R;
    selectionInset<R = cocoa.NSEdgeInsets>(): R;
    setSelectionInset<R = void, P0 = cocoa.NSEdgeInsets>(_setSelectionInset: P0): R;
    ...
    initWithFrame_inStatusBar<R = unknown, P0 = cocoa.CGRect, P1 = unknown>(_initWithFrame: P0, _inStatusBar: P1): R;
  ...
  namespace classes {
    export interface NSStatusBarButton<T = any> extends cocoa.classes.NSButton {
