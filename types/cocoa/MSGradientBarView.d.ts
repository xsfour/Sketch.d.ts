...
declare namespace cocoa {
  export interface MSGradientBarView<T = any> extends cocoa.BCColorPickerBaseView {
    ...
    drawSelectedMarkerInRect_color<R = void, P0 = cocoa.CGRect, P1 = unknown>(_drawSelectedMarkerInRect: P0, _color: P1): R;
    ...
    normaliseRect<R = cocoa.CGRect, P0 = cocoa.CGRect>(_normaliseRect: P0): R;
    rectForMarkerAtIndex<R = cocoa.CGRect, P0 = number>(_rectForMarkerAtIndex: P0): R;
    ...
    delegate<R = cocoa.MSGradientBarViewDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.MSGradientBarViewDelegate>(_v: P0): R;
  }
  namespace classes {
    export interface MSGradientBarView<T = any> extends cocoa.classes.BCColorPickerBaseView {
