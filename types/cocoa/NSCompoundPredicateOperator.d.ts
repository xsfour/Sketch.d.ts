...
declare namespace cocoa {
  export interface NSCompoundPredicateOperator<T = any> extends cocoa.NSPredicateOperator {
  ...
  namespace classes {
    export interface NSCompoundPredicateOperator<T = any> extends cocoa.classes.NSPredicateOperator {
