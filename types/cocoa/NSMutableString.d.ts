...
declare namespace cocoa {
  export interface NSMutableString<T = any> extends cocoa.NSString {
    initWithCapacity<R = unknown, P0 = number>(_initWithCapacity: P0): R;
    applyTransform_reverse_range_updatedRange<R = boolean, P0 = unknown, P1 = boolean, P2 = cocoa._NSRange, P3 = cocoa._NSRange>(_applyTransform: P0, _reverse: P1, _range: P2, _updatedRange: P3): R;
    replaceOccurrencesOfString_withString_options_range<R = number, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa._NSRange>(_replaceOccurrencesOfString: P0, _withString: P1, _options: P2, _range: P3): R;
    setString<R = void, P0 = unknown>(_setString: P0): R;
    appendFormat<R = void, P0 = unknown>(_appendFormat: P0): R;
    replaceCharactersInRange_withCharacters_length<R = void, P0 = cocoa._NSRange, P1 = number, P2 = number>(_replaceCharactersInRange: P0, _withCharacters: P1, _length: P2): R;
    replaceCharactersInRange_withCString_length<R = void, P0 = cocoa._NSRange, P1 = string, P2 = number>(_replaceCharactersInRange: P0, _withCString: P1, _length: P2): R;
    ...
    _cfTrim<R = void, P0 = cocoa.__CFString>(__cfTrim: P0): R;
    _cfPad_length_padIndex<R = void, P0 = cocoa.__CFString, P1 = number, P2 = number>(__cfPad: P0, _length: P1, _padIndex: P2): R;
    ...
    _replaceOccurrencesOfRegularExpressionPattern_withTemplate_options_range<R = number, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa._NSRange>(__replaceOccurrencesOfRegularExpressionPattern: P0, _withTemplate: P1, _options: P2, _range: P3): R;
  }
  namespace classes {
    export interface NSMutableString<T = any> extends cocoa.classes.NSString {
