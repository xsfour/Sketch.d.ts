...
declare namespace cocoa {
  export interface NSPersistentUIWindowSnapshotter<T = any> extends cocoa.NSObject {
    ...
    finishPendingSnapshotsImmediatelyWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_finishPendingSnapshotsImmediatelyWithCompletionHandler: P0): R;
    ...
    accessWindowBits_handler<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_accessWindowBits: P0, _handler: P1): R;
    ...
    cryptoKey<R = cocoa.NSData>(): R;
    setCryptoKey<R = void, P0 = cocoa.NSData>(_v: P0): R;
    cryptoUUID<R = cocoa.NSData>(): R;
    setCryptoUUID<R = void, P0 = cocoa.NSData>(_v: P0): R;
  }
  namespace classes {
    export interface NSPersistentUIWindowSnapshotter<T = any> extends cocoa.classes.NSObject {
