...
declare namespace cocoa {
  export interface NSKeyValueFastMutableArray2<T = any> extends cocoa.NSKeyValueFastMutableArray {
  ...
  namespace classes {
    export interface NSKeyValueFastMutableArray2<T = any> extends cocoa.classes.NSKeyValueFastMutableArray {  }
  }
}
