...
declare namespace cocoa {
  export interface NSGridRow<T = any> extends cocoa.NSObject, cocoa.NSCodingProtocol {
  ...
  namespace classes {
    export interface NSGridRow<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCodingProtocol {
      alloc<R = NSGridRow>(): R;
      new: <R = NSGridRow>() => R;
    }
  }
...
declare const NSGridRow: cocoa.classes.NSGridRow;
