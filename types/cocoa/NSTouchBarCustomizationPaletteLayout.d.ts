...
declare namespace cocoa {
  export interface NSTouchBarCustomizationPaletteLayout<T = any> extends cocoa.NSCollectionViewLayout {
  ...
  namespace classes {
    export interface NSTouchBarCustomizationPaletteLayout<T = any> extends cocoa.classes.NSCollectionViewLayout {
