...
declare namespace cocoa {
  export interface MSInsertSliceAction<T = any> extends cocoa.MSDocumentAction {
    tooltip<R = unknown>(): R;
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSInsertSliceAction<T = any> extends cocoa.classes.MSDocumentAction {
