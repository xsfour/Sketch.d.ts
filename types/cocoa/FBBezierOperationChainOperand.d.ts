...
declare namespace cocoa {
  export interface FBBezierOperationChainOperand<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface FBBezierOperationChainOperand<T = any> extends cocoa.classes.NSObject {
