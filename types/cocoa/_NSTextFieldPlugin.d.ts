...
declare namespace cocoa {
  export interface _NSTextFieldPlugin<T = any> extends cocoa._NSValueBinderPlugin {
    editingColorAdjustableObject<R = unknown, P0 = unknown>(_editingColorAdjustableObject: P0): R;
    acceptsStyleChanges<R = boolean>(): R;
  }
  namespace classes {
    export interface _NSTextFieldPlugin<T = any> extends cocoa.classes._NSValueBinderPlugin {
