...
declare namespace cocoa {
  export interface NSVisualTabPickerShadowTileView<T = any> extends cocoa.NSView {
  ...
  namespace classes {
    export interface NSVisualTabPickerShadowTileView<T = any> extends cocoa.classes.NSView {
