...
declare namespace cocoa {
  export interface _NSObservableKVO1Adaptor<T0 = void, T1 = void, T2 = void> extends _NSObservableObservation {
  ...
  namespace _NSObservableKVO1Adaptor {
    export interface CLASS<T0 = void, T1 = void, T2 = void> extends _NSObservableObservation {
      alloc<R = _NSObservableKVO1Adaptor>(): R;
      new: <R = _NSObservableKVO1Adaptor>() => R;
    }
  }
}
