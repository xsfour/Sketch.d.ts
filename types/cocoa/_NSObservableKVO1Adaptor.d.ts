...
declare namespace cocoa {
  export interface _NSObservableKVO1Adaptor<T = any> extends cocoa._NSObservableObservation {
  ...
  namespace classes {
    export interface _NSObservableKVO1Adaptor<T = any> extends cocoa.classes._NSObservableObservation {
