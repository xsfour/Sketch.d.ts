...
declare namespace cocoa {
  export interface FBBezierGraph<T = any> extends cocoa.NSObject {
    ...
    bezierGraphWithTransform<R = unknown, P0 = cocoa.CGAffineTransform>(_bezierGraphWithTransform: P0): R;
    description<R = unknown>(): R;
    debugFindCurvesThatShouldIntersectWith_withBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_debugFindCurvesThatShouldIntersectWith: P0, _withBlock: P1): R;
    ...
    findCrossingsOnContainers_onRay_beforeMinimum_afterMaximum_crossingsBefore_crossingsAfter<R = boolean, P0 = unknown, P1 = unknown, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint, P4 = unknown, P5 = unknown>(_findCrossingsOnContainers: P0, _onRay: P1, _beforeMinimum: P2, _afterMaximum: P3, _crossingsBefore: P4, _crossingsAfter: P5): R;
    findBoundsOfContour_onRay_minimum_maximum<R = boolean, P0 = unknown, P1 = unknown, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint>(_findBoundsOfContour: P0, _onRay: P1, _minimum: P2, _maximum: P3): R;
    ...
    debugPathForContainmentOfContour_transform<R = unknown, P0 = unknown, P1 = cocoa.CGAffineTransform>(_debugPathForContainmentOfContour: P0, _transform: P1): R;
    debugPathForContainmentOfContour<R = unknown, P0 = unknown>(_debugPathForContainmentOfContour: P0): R;
    closestCrossingToPoint<R = unknown, P0 = cocoa.CGPoint>(_closestCrossingToPoint: P0): R;
    ...
    performOperationWithGraph_inBlock<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_performOperationWithGraph: P0, _inBlock: P1): R;
    ...
    dealloc<R = void>(): R;
    initWithBezierPath_orCGPath<R = unknown, P0 = unknown, P1 = cocoa.CGPath>(_initWithBezierPath: P0, _orCGPath: P1): R;
    ...
    setCGPath<R = void, P0 = cocoa.CGPath>(_v: P0): R;
    contours<R = cocoa.NSArray>(): R;
    nonEmptyContours<R = cocoa.NSArray>(): R;
    bounds<R = cocoa.CGRect>(): R;
  }
  namespace classes {
    export interface FBBezierGraph<T = any> extends cocoa.classes.NSObject {
      ...
      bezierGraphWithCGPath<R = unknown, P0 = cocoa.CGPath>(_bezierGraphWithCGPath: P0): R;
    }
  }
}
