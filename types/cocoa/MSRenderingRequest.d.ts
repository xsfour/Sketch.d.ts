...
declare namespace cocoa {
  export interface MSRenderingRequest<T = any> extends cocoa.NSObject {
    cxx_destruct<R = void>(): R;
    dealloc<R = void>(): R;
    requestWithOptions<R = unknown, P0 = number>(_requestWithOptions: P0): R;
    initWithDocument_colorSpace_pointScale_zoomLevel_cacheProvider_options<R = unknown, P0 = unknown, P1 = cocoa.CGColorSpace, P2 = number, P3 = number, P4 = unknown, P5 = number>(_initWithDocument: P0, _colorSpace: P1, _pointScale: P2, _zoomLevel: P3, _cacheProvider: P4, _options: P5): R;
    initWithDocument_colorSpace_pointScale_zoomLevel_cacheProvider_backgroundBlurLayer_options<R = unknown, P0 = unknown, P1 = cocoa.CGColorSpace, P2 = number, P3 = number, P4 = unknown, P5 = unknown, P6 = number>(_initWithDocument: P0, _colorSpace: P1, _pointScale: P2, _zoomLevel: P3, _cacheProvider: P4, _backgroundBlurLayer: P5, _options: P6): R;
    options<R = number>(): R;
    backgroundBlurLayer<R = cocoa.MSImmutableLayer>(): R;
  ...
  namespace classes {
    export interface MSRenderingRequest<T = any> extends cocoa.classes.NSObject {
