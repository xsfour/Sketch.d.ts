...
declare namespace cocoa {
  export interface NSMatchingPredicateOperator<T = any> extends cocoa.NSStringPredicateOperator {
    _shouldEscapeForLike<R = boolean>(): R;
    dealloc<R = void>(): R;
    _clearContext<R = void>(): R;
  }
  namespace classes {
    export interface NSMatchingPredicateOperator<T = any> extends cocoa.classes.NSStringPredicateOperator {
