...
declare namespace cocoa {
  export interface NSOutlineButtonCell<T = any> extends cocoa.NSButtonCell {
    ...
    outlineView<R = cocoa.NSOutlineView>(): R;
    setOutlineView<R = void, P0 = cocoa.NSOutlineView>(_v: P0): R;
  ...
  namespace classes {
    export interface NSOutlineButtonCell<T = any> extends cocoa.classes.NSButtonCell {
