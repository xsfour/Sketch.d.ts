...
declare namespace cocoa {
  export interface NSUIActivityResponderMonitor<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSUIActivityResponderMonitor<T = any> extends cocoa.classes.NSObject {
