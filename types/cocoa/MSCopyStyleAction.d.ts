...
declare namespace cocoa {
  export interface MSCopyStyleAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    copyStyle<R = void, P0 = unknown>(_copyStyle: P0): R;
  }
  namespace classes {
    export interface MSCopyStyleAction<T = any> extends cocoa.classes.MSDocumentAction {
