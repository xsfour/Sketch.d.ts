...
declare namespace cocoa {
  export interface MSImmutableGradientStop<T = any> extends cocoa._MSImmutableGradientStop {
    initWithPosition_color<R = unknown, P0 = number, P1 = unknown>(_initWithPosition: P0, _color: P1): R;
  }
  namespace classes {
    export interface MSImmutableGradientStop<T = any> extends cocoa.classes._MSImmutableGradientStop {
