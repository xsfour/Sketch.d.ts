...
declare namespace cocoa {
  export interface _NSThemeWidgetCell<T = any> extends cocoa.NSButtonCell {
    update<R = void>(): R;
    getState<R = number, P0 = unknown>(_getState: P0): R;
    _drawCustomImage_withFrame_inView<R = void, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown>(__drawCustomImage: P0, _withFrame: P1, _inView: P2): R;
    ...
    buttonID<R = number>(): R;
    coreUIDrawWithFrame_inView<R = void, P0 = cocoa.CGRect, P1 = unknown>(_coreUIDrawWithFrame: P0, _inView: P1): R;
  ...
  namespace classes {
    export interface _NSThemeWidgetCell<T = any> extends cocoa.classes.NSButtonCell {
