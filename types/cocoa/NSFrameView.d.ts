...
declare namespace cocoa {
  export interface NSFrameView<T = any> extends cocoa.NSView {
    shouldUseStyledTextInTitleCell<R = boolean, P0 = unknown>(_shouldUseStyledTextInTitleCell: P0): R;
    customizedBackgroundTypeForTitleCell<R = cocoa.__CFString, P0 = unknown>(_customizedBackgroundTypeForTitleCell: P0): R;
    _edgeResizingTrackingAreas<R = unknown>(): R;
    minFrameSize<R = cocoa.CGSize>(): R;
    ...
    miniaturizedSize<R = cocoa.CGSize>(): R;
    ...
    drawWindowBackgroundRegion<R = void, P0 = cocoa.CGSRegionObject>(_drawWindowBackgroundRegion: P0): R;
    drawWindowBackgroundRect<R = void, P0 = cocoa.CGRect>(_drawWindowBackgroundRect: P0): R;
    drawThemeContentFill_inView<R = void, P0 = cocoa.CGRect, P1 = unknown>(_drawThemeContentFill: P0, _inView: P1): R;
    usesCustomDrawing<R = boolean>(): R;
    drawFrame<R = void, P0 = cocoa.CGRect>(_drawFrame: P0): R;
    _drawFrameRects<R = void, P0 = cocoa.CGRect>(__drawFrameRects: P0): R;
    tile<R = void>(): R;
  ...
  namespace classes {
    export interface NSFrameView<T = any> extends cocoa.classes.NSView {
