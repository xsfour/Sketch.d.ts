...
declare namespace cocoa {
  export interface NSStringPredicateOperator<T = any> extends cocoa.NSPredicateOperator {
    flags<R = number>(): R;
  ...
  namespace classes {
    export interface NSStringPredicateOperator<T = any> extends cocoa.classes.NSPredicateOperator {
