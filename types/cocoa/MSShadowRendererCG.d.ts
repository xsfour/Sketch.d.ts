...
declare namespace cocoa {
  export interface MSShadowRendererCG<T = any> extends cocoa.NSObject, cocoa.MSShadowRendererProtocol {
    ...
    clipAndTransformForShadow_forBounds_context_inBlock<R = void, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(_clipAndTransformForShadow: P0, _forBounds: P1, _context: P2, _inBlock: P3): R;
  ...
  namespace classes {
    export interface MSShadowRendererCG<T = any> extends cocoa.classes.NSObject, cocoa.classes.MSShadowRendererProtocol {
...
declare const MSShadowRendererCG: cocoa.classes.MSShadowRendererCG;
