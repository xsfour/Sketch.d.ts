...
declare namespace cocoa {
  export interface MSVisitDocumentationAction<T = any> extends cocoa.MSAction {
    label<R = unknown>(): R;
    visitDocumentation<R = void, P0 = unknown>(_visitDocumentation: P0): R;
  }
  namespace classes {
    export interface MSVisitDocumentationAction<T = any> extends cocoa.classes.MSAction {
