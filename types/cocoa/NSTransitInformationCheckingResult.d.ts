...
declare namespace cocoa {
  export interface NSTransitInformationCheckingResult<T = any> extends cocoa.NSTextCheckingResult {
  ...
  namespace classes {
    export interface NSTransitInformationCheckingResult<T = any> extends cocoa.classes.NSTextCheckingResult {
