...
declare namespace cocoa {
  export interface MSRotateClockwiseAction<T = any> extends cocoa.MSEventHandlerAction {
    label<R = unknown>(): R;
    rotate90C<R = void, P0 = unknown>(_rotate90C: P0): R;
  }
  namespace classes {
    export interface MSRotateClockwiseAction<T = any> extends cocoa.classes.MSEventHandlerAction {
