...
declare namespace cocoa {
  export interface NSSubstringPredicateOperator<T = any> extends cocoa.NSStringPredicateOperator {
    position<R = number>(): R;
  ...
  namespace classes {
    export interface NSSubstringPredicateOperator<T = any> extends cocoa.classes.NSStringPredicateOperator {
