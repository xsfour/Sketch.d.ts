...
declare namespace cocoa {
  export interface MSFlattenSelectionAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    flattenSelection<R = void, P0 = unknown>(_flattenSelection: P0): R;
  }
  namespace classes {
    export interface MSFlattenSelectionAction<T = any> extends cocoa.classes.MSDocumentAction {
