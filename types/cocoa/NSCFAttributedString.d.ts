...
declare namespace cocoa {
  export interface NSCFAttributedString<T = any> extends cocoa.NSMutableAttributedString {
    string<R = unknown>(): R;
    _isDeallocating<R = boolean>(): R;
    _tryRetain<R = boolean>(): R;
  }
  namespace classes {
    export interface NSCFAttributedString<T = any> extends cocoa.classes.NSMutableAttributedString {
