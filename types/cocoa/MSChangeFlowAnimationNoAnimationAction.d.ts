...
declare namespace cocoa {
  export interface MSChangeFlowAnimationNoAnimationAction<T = any> extends cocoa.MSChangeFlowAnimationAction {
    label<R = unknown>(): R;
    changeFlowAnimationToNoAnimation<R = void, P0 = unknown>(_changeFlowAnimationToNoAnimation: P0): R;
  }
  namespace classes {
    export interface MSChangeFlowAnimationNoAnimationAction<T = any> extends cocoa.classes.MSChangeFlowAnimationAction {
