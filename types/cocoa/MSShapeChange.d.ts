...
declare namespace cocoa {
  export interface MSShapeChange<T = any> extends cocoa.NSObject {
    cxx_destruct<R = void>(): R;
    executeWithContext<R = void, P0 = unknown>(_executeWithContext: P0): R;
  }
  namespace classes {
    export interface MSShapeChange<T = any> extends cocoa.classes.NSObject {
      alloc<R = MSShapeChange>(): R;
      new: <R = MSShapeChange>() => R;
      customActionWithBlock<R = unknown, P0 = cocoa.CDUnknownBlockType>(_customActionWithBlock: P0): R;
      ...
      moveByOffset_options<R = unknown, P0 = cocoa.CGSize, P1 = number>(_moveByOffset: P0, _options: P1): R;
      moveHandle_ofCurvePoint_toLocation_options<R = void, P0 = number, P1 = unknown, P2 = cocoa.CGPoint, P3 = number>(_moveHandle: P0, _ofCurvePoint: P1, _toLocation: P2, _options: P3): R;
      moveToPoint_options<R = unknown, P0 = cocoa.CGPoint, P1 = number>(_moveToPoint: P0, _options: P1): R;
    }
  }
}
