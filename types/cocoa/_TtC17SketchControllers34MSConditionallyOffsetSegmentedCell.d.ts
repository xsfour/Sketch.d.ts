...
declare namespace cocoa {
  export interface _TtC17SketchControllers34MSConditionallyOffsetSegmentedCell<T = any> extends cocoa.NSSegmentedCell {
  ...
  namespace classes {
    export interface _TtC17SketchControllers34MSConditionallyOffsetSegmentedCell<T = any> extends cocoa.classes.NSSegmentedCell {
