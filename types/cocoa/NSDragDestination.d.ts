...
declare namespace cocoa {
  export interface NSDragDestination<T = any> extends cocoa.NSObject, cocoa.NSDraggingInfoProtocol, cocoa.NSDraggingInfoPrivateProtocol, cocoa.NSDraggingInfo_PrivateProtocol {
    ...
    _finalSlideLocation<R = cocoa.CGPoint>(): R;
    _setFinalSlideLocation<R = void, P0 = cocoa.CGPoint>(__setFinalSlideLocation: P0): R;
    _draggingFargo<R = number>(): R;
    dealloc<R = void>(): R;
    _setDragRef<R = void, P0 = cocoa.OpaqueCoreDrag>(__setDragRef: P0): R;
    _receiveHandlerRef<R = cocoa.OpaqueCoreDragHandler>(): R;
    _trackingHandlerRef<R = cocoa.OpaqueCoreDragHandler>(): R;
    _setReceiveHandlerRef<R = void, P0 = cocoa.OpaqueCoreDragHandler>(__setReceiveHandlerRef: P0): R;
    _setTrackingHandlerRef<R = void, P0 = cocoa.OpaqueCoreDragHandler>(__setTrackingHandlerRef: P0): R;
    _initWithWindow<R = unknown, P0 = unknown>(__initWithWindow: P0): R;
    _lastDragLocation<R = cocoa.CGPoint>(): R;
    set_lastDragLocation<R = void, P0 = cocoa.CGPoint>(_v: P0): R;
  ...
  namespace classes {
    export interface NSDragDestination<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSDraggingInfoProtocol, cocoa.classes.NSDraggingInfoPrivateProtocol, cocoa.classes.NSDraggingInfo_PrivateProtocol {
