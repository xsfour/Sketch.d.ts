...
declare namespace cocoa {
  export interface NSPredicate<T = any> extends cocoa.NSObject, cocoa.NSSecureCodingProtocol, cocoa.NSCopyingProtocol {
    ...
    predicateFormat<R = cocoa.NSString>(): R;
  }
  namespace classes {
    export interface NSPredicate<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSSecureCodingProtocol, cocoa.classes.NSCopyingProtocol {
      alloc<R = NSPredicate>(): R;
      new: <R = NSPredicate>() => R;
      predicateFromMetadataQueryString<R = unknown, P0 = unknown>(_predicateFromMetadataQueryString: P0): R;
      predicateWithBlock<R = unknown, P0 = cocoa.CDUnknownBlockType>(_predicateWithBlock: P0): R;
      predicateWithValue<R = unknown, P0 = boolean>(_predicateWithValue: P0): R;
      predicateWithFormat_arguments<R = unknown, P0 = unknown, P1 = cocoa.__va_list_tag>(_predicateWithFormat: P0, _arguments: P1): R;
      ...
      retainedLocale<R = cocoa.__CFLocale>(): R;
