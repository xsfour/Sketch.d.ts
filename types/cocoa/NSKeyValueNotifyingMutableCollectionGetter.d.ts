...
declare namespace cocoa {
  export interface NSKeyValueNotifyingMutableCollectionGetter<T = any> extends cocoa.NSKeyValueProxyGetter {
  ...
  namespace classes {
    export interface NSKeyValueNotifyingMutableCollectionGetter<T = any> extends cocoa.classes.NSKeyValueProxyGetter {
