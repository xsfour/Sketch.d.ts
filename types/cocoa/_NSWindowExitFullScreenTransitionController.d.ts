...
declare namespace cocoa {
  export interface _NSWindowExitFullScreenTransitionController<T = any> extends cocoa._NSExitFullScreenTransitionController {
  ...
  namespace classes {
    export interface _NSWindowExitFullScreenTransitionController<T = any> extends cocoa.classes._NSExitFullScreenTransitionController {
