...
declare namespace cocoa {
  export interface NSPersistentUISecureURLHerder<T = any> extends cocoa.NSObject {
    ...
    getLSPersistentFileList<R = cocoa.OpaqueLSSharedFileListRef>(): R;
    dealloc<R = void>(): R;
    initWithBundleID<R = unknown, P0 = unknown>(_initWithBundleID: P0): R;
  }
  namespace classes {
    export interface NSPersistentUISecureURLHerder<T = any> extends cocoa.classes.NSObject {
