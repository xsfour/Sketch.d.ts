...
declare namespace cocoa {
  export interface _NSCGSWindowOrderingProperties<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSCGSWindowOrderingProperties<T = any> extends cocoa.classes.NSObject {
