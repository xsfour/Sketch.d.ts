...
declare namespace cocoa {
  export interface NSISO8601DateFormatter<T = any> extends cocoa.NSFormatter, cocoa.NSSecureCodingProtocol {
  ...
  namespace classes {
    export interface NSISO8601DateFormatter<T = any> extends cocoa.classes.NSFormatter, cocoa.classes.NSSecureCodingProtocol {
