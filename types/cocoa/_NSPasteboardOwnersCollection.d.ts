...
declare namespace cocoa {
  export interface _NSPasteboardOwnersCollection<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSPasteboardOwnersCollection<T = any> extends cocoa.classes.NSObject {
