...
declare namespace cocoa {
  export interface NSWindowBatchOrdering<T = any> extends cocoa.NSObject {
    dealloc<R = void>(): R;
    deallocateAllWindows<R = void>(): R;
    performRelativeToWindow<R = void, P0 = number>(_performRelativeToWindow: P0): R;
    performBatchOrderingForTripletsInRange<R = void, P0 = cocoa._NSRange>(_performBatchOrderingForTripletsInRange: P0): R;
    addCompletionCallback<R = void, P0 = cocoa.CDUnknownBlockType>(_addCompletionCallback: P0): R;
  ...
  namespace classes {
    export interface NSWindowBatchOrdering<T = any> extends cocoa.classes.NSObject {
