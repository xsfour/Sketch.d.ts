...
declare namespace cocoa {
  export interface NSTableRowAndCellTracker<T = any> extends cocoa.NSObject {
    removeAll<R = void>(): R;
    ...
    indexForSpecifierComponent_inRange<R = number, P0 = number, P1 = cocoa._NSRange>(_indexForSpecifierComponent: P0, _inRange: P1): R;
  ...
  namespace classes {
    export interface NSTableRowAndCellTracker<T = any> extends cocoa.classes.NSObject {
