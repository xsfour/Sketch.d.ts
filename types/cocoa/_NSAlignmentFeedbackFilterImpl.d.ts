...
declare namespace cocoa {
  export interface _NSAlignmentFeedbackFilterImpl<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSAlignmentFeedbackFilterImpl<T = any> extends cocoa.classes.NSObject {
