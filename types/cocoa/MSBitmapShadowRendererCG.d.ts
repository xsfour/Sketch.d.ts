...
declare namespace cocoa {
  export interface MSBitmapShadowRendererCG<T = any> extends cocoa.NSObject, cocoa.MSShadowRendererProtocol {
    ...
    renderShadowMask_forBounds_context_cacheObject_inBlock<R = void, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown, P4 = cocoa.CDUnknownBlockType>(_renderShadowMask: P0, _forBounds: P1, _context: P2, _cacheObject: P3, _inBlock: P4): R;
    clipAndTransformForShadow_forBounds_context_cacheObject_inBlock<R = void, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown, P4 = cocoa.CDUnknownBlockType>(_clipAndTransformForShadow: P0, _forBounds: P1, _context: P2, _cacheObject: P3, _inBlock: P4): R;
  ...
  namespace classes {
    export interface MSBitmapShadowRendererCG<T = any> extends cocoa.classes.NSObject, cocoa.classes.MSShadowRendererProtocol {
...
declare const MSBitmapShadowRendererCG: cocoa.classes.MSBitmapShadowRendererCG;
