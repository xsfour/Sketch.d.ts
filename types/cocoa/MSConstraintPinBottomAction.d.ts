...
declare namespace cocoa {
  export interface MSConstraintPinBottomAction<T = any> extends cocoa.MSConstraintAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSConstraintPinBottomAction<T = any> extends cocoa.classes.MSConstraintAction {
