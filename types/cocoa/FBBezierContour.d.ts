...
declare namespace cocoa {
  export interface FBBezierContour<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol {
    ...
    debugPathForWindingRuleContainmentAtEdge_parameter_point_withTransform_andSizeTransform<R = unknown, P0 = unknown, P1 = number, P2 = cocoa.CGPoint, P3 = cocoa.CGAffineTransform, P4 = cocoa.CGAffineTransform>(_debugPathForWindingRuleContainmentAtEdge: P0, _parameter: P1, _point: P2, _withTransform: P3, _andSizeTransform: P4): R;
    debugPathForWindingRuleContainmentWithTransform_andSizeTransform<R = unknown, P0 = cocoa.CGAffineTransform, P1 = cocoa.CGAffineTransform>(_debugPathForWindingRuleContainmentWithTransform: P0, _andSizeTransform: P1): R;
    debugPathForJointsWithTransform_andSizeTransform<R = unknown, P0 = cocoa.CGAffineTransform, P1 = cocoa.CGAffineTransform>(_debugPathForJointsWithTransform: P0, _andSizeTransform: P1): R;
    debugPathForIntersectionType_withTransform_andSizeTransform<R = unknown, P0 = number, P1 = cocoa.CGAffineTransform, P2 = cocoa.CGAffineTransform>(_debugPathForIntersectionType: P0, _withTransform: P1, _andSizeTransform: P2): R;
    description<R = unknown>(): R;
    closestLocationToPoint<R = unknown, P0 = cocoa.CGPoint>(_closestLocationToPoint: P0): R;
    clone<R = unknown>(): R;
    ...
    forEachEdgeOverlapDo<R = void, P0 = cocoa.CDUnknownBlockType>(_forEachEdgeOverlapDo: P0): R;
    ...
    debugPathForContainmentOfCrossing_transform<R = unknown, P0 = unknown, P1 = cocoa.CGAffineTransform>(_debugPathForContainmentOfCrossing: P0, _transform: P1): R;
    ...
    crossingContainmentRay<R = unknown, P0 = cocoa.CGPoint>(_crossingContainmentRay: P0): R;
    intersection_isReallyTheSameAs<R = boolean, P0 = unknown, P1 = unknown>(_intersection: P0, _isReallyTheSameAs: P1): R;
    containsPointUsingNonZeroWindingRule<R = boolean, P0 = cocoa.CGPoint>(_containsPointUsingNonZeroWindingRule: P0): R;
    containsUsingNonZeroWindingRulePoint_onEdge_atParameter<R = boolean, P0 = cocoa.CGPoint, P1 = unknown, P2 = number>(_containsUsingNonZeroWindingRulePoint: P0, _onEdge: P1, _atParameter: P2): R;
    ...
    markSelfCrossingsOnEdge_startParameter_stopParameter_isEntry_withBlock<R = boolean, P0 = unknown, P1 = number, P2 = number, P3 = boolean, P4 = cocoa.CDUnknownBlockType>(_markSelfCrossingsOnEdge: P0, _startParameter: P1, _stopParameter: P2, _isEntry: P3, _withBlock: P4): R;
    ...
    contourWithTransform<R = unknown, P0 = cocoa.CGAffineTransform>(_contourWithTransform: P0): R;
    ...
    contourAndSelfIntersectingContoursContainPoint<R = boolean, P0 = cocoa.CGPoint>(_contourAndSelfIntersectingContoursContainPoint: P0): R;
    ...
    startingEdge_parameter_point_skipHorizontals_skipInflectionPoints<R = void, P0 = unknown, P1 = number, P2 = cocoa.CGPoint, P3 = boolean, P4 = boolean>(_startingEdge: P0, _parameter: P1, _point: P2, _skipHorizontals: P3, _skipInflectionPoints: P4): R;
    testRayForContainment<R = unknown, P0 = cocoa.CGRect>(_testRayForContainment: P0): R;
    ...
    intersectionsWithRay_withBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_intersectionsWithRay: P0, _withBlock: P1): R;
    ...
    edges<R = cocoa.NSArray>(): R;
    selfIntersectingContours<R = cocoa.NSArray>(): R;
    intersectingContours<R = cocoa.NSArray>(): R;
    direction<R = number>(): R;
    cachedDirection<R = cocoa.NSNumber>(): R;
    setCachedDirection<R = void, P0 = cocoa.NSNumber>(_v: P0): R;
    isClosed<R = boolean>(): R;
    CGPath<R = cocoa.CGPath>(): R;
    isEmpty<R = boolean>(): R;
    firstPoint<R = cocoa.CGPoint>(): R;
    boundingRect<R = cocoa.CGRect>(): R;
    bounds<R = cocoa.CGRect>(): R;
    nonPointEdges<R = cocoa.NSArray>(): R;
    crossings<R = cocoa.NSArray>(): R;
    overlaps_<R = cocoa.NSMutableArray>(): R;
    overlaps<R = cocoa.NSArray>(): R;
  }
  namespace classes {
    export interface FBBezierContour<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol {
