...
declare namespace cocoa {
  export interface NSArray<T = any> {
    // + NSArray(AppKitAdditions,NSArray,NSArrayPathExtensions,NSArrayPortCoding,NSDeprecatedKeyValueCoding,NSKeyValueCoding,NSKeyValueCodingPrivate,NSKeyValueObserverRegistration,NSKeyValueSorting,NSPredicateSupport,NSScriptAppleEventConversion,NSScriptKeyValueCoding,NSScriptingInternal,NSScriptingInternalCommandHandling,NSScriptingInternalCounting,NSScriptingInternalDeleting,NSScriptingInternalExisting,NSScriptingInternalSetting,NSSelectionArray,NSSelectionArrayAdditions,_NSBinderKeyValueCodingAdditions,MSBaseArchiver,ModelSupport,ModelSyncSupport,TreeAsDictionarySupport):
...
declare const NSArray: cocoa.classes.NSArray;
