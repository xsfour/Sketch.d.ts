...
declare namespace cocoa {
  export interface _NSVibrancyTransitioningImageView<T = any> extends cocoa.NSView {
    ...
    delegate<R = cocoa._NSVibrancyTransitioningImageViewDelegate>(): R;
    setDelegate<R = void, P0 = cocoa._NSVibrancyTransitioningImageViewDelegate>(_v: P0): R;
    imageViewConfigurationBlock<R = cocoa.CDUnknownBlockType>(): R;
    setImageViewConfigurationBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_v: P0): R;
  }
  namespace classes {
    export interface _NSVibrancyTransitioningImageView<T = any> extends cocoa.classes.NSView {
