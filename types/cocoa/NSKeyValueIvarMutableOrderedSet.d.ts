...
declare namespace cocoa {
  export interface NSKeyValueIvarMutableOrderedSet<T = any> extends cocoa.NSKeyValueMutableOrderedSet {
  ...
  namespace classes {
    export interface NSKeyValueIvarMutableOrderedSet<T = any> extends cocoa.classes.NSKeyValueMutableOrderedSet {  }
  }
}

declare const NSKeyValueIvarMutableOrderedSet: cocoa.classes.NSKeyValueIvarMutableOrderedSet;
