...
declare namespace cocoa {
  export interface MSStyleColorControls<T = any> extends cocoa._MSStyleColorControls {
  ...
  namespace classes {
    export interface MSStyleColorControls<T = any> extends cocoa.classes._MSStyleColorControls {
