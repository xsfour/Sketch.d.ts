...
declare namespace cocoa {
  export interface MSImmutableBaseGrid<T = any> extends cocoa._MSImmutableBaseGrid {
    shouldDrawAtZoom<R = boolean, P0 = number>(_shouldDrawAtZoom: P0): R;
    forceDraw<R = boolean>(): R;
    setForceDraw<R = void, P0 = boolean>(_v: P0): R;
  }
  namespace classes {
    export interface MSImmutableBaseGrid<T = any> extends cocoa.classes._MSImmutableBaseGrid {
