...
declare namespace cocoa {
  export interface NSXMLChildren<T = any> extends cocoa.NSMutableArray {
    makeStale<R = void>(): R;
    ...
    replaceObjectsInRange_withObjectsFromArray<R = void, P0 = cocoa._NSRange, P1 = unknown>(_replaceObjectsInRange: P0, _withObjectsFromArray: P1): R;
    replaceObjectsInRange_withObjectsFromArray_range<R = void, P0 = cocoa._NSRange, P1 = unknown, P2 = cocoa._NSRange>(_replaceObjectsInRange: P0, _withObjectsFromArray: P1, _range: P2): R;
    removeObjectsInRange<R = void, P0 = cocoa._NSRange>(_removeObjectsInRange: P0): R;
    ...
    removeObjectIdenticalTo_inRange<R = void, P0 = unknown, P1 = cocoa._NSRange>(_removeObjectIdenticalTo: P0, _inRange: P1): R;
    removeObject<R = void, P0 = unknown>(_removeObject: P0): R;
    removeObject_inRange<R = void, P0 = unknown, P1 = cocoa._NSRange>(_removeObject: P0, _inRange: P1): R;
  ...
  namespace classes {
    export interface NSXMLChildren<T = any> extends cocoa.classes.NSMutableArray {  }
  }
}
