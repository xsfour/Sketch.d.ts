...
declare namespace cocoa {
  export interface MSSnapper<T = any> extends cocoa.NSObject {
    cxx_destruct<R = void>(): R;
    snappableAnchorsOfItems_exceptLayers<R = unknown, P0 = unknown, P1 = unknown>(_snappableAnchorsOfItems: P0, _exceptLayers: P1): R;
    snapToLines_axis_adjustableAxes_mayResize_originalRect<R = void, P0 = unknown, P1 = number, P2 = number, P3 = boolean, P4 = cocoa.CGRect>(_snapToLines: P0, _axis: P1, _adjustableAxes: P2, _mayResize: P3, _originalRect: P4): R;
    ...
    changeItemToRect_usingAnchor_forLine_adjustableAxes<R = void, P0 = cocoa.CGRect, P1 = unknown, P2 = unknown, P3 = number>(_changeItemToRect: P0, _usingAnchor: P1, _forLine: P2, _adjustableAxes: P3): R;
    ...
    rectBySnappingRect_toClosestDistance_inDirection_mayResize<R = cocoa.CGRect, P0 = cocoa.CGRect, P1 = cocoa.CGRect, P2 = number, P3 = boolean>(_rectBySnappingRect: P0, _toClosestDistance: P1, _inDirection: P2, _mayResize: P3): R;
  ...
  namespace classes {
    export interface MSSnapper<T = any> extends cocoa.classes.NSObject {
      alloc<R = MSSnapper>(): R;
      new: <R = MSSnapper>() => R;
    }
  }
