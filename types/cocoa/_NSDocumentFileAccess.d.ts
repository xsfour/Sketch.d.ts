...
declare namespace cocoa {
  export interface _NSDocumentFileAccess<T = any> extends cocoa._NSDocumentSerializationObject {
    whenFileAccessCanContinueInvokeBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_whenFileAccessCanContinueInvokeBlock: P0): R;
    ...
    superiorFileAccess<R = cocoa._NSDocumentFileAccess>(): R;
    setSuperiorFileAccess<R = void, P0 = cocoa._NSDocumentFileAccess>(_v: P0): R;
    canContinueFileAccess<R = boolean>(): R;
    fileURLStabilized<R = boolean>(): R;
    canFinishFileAccess<R = boolean>(): R;
  }
  namespace classes {
    export interface _NSDocumentFileAccess<T = any> extends cocoa.classes._NSDocumentSerializationObject {
