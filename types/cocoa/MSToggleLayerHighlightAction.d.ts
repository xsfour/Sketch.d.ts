...
declare namespace cocoa {
  export interface MSToggleLayerHighlightAction<T = any> extends cocoa.MSToggleViewPreferenceAction {
    label<R = unknown>(): R;
    toggleLayerHighlight<R = void, P0 = unknown>(_toggleLayerHighlight: P0): R;
  }
  namespace classes {
    export interface MSToggleLayerHighlightAction<T = any> extends cocoa.classes.MSToggleViewPreferenceAction {
