...
declare namespace cocoa {
  export interface NSScriptingAppleEventHandler<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSScriptingAppleEventHandler<T = any> extends cocoa.classes.NSObject {
