...
declare namespace cocoa {
  export interface _NSXPCConnectionImportInfo<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSXPCConnectionImportInfo<T = any> extends cocoa.classes.NSObject {
