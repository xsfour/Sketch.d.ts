...
declare namespace cocoa {
  export interface NSSourceListBackgroundColor<T = any> extends cocoa.NSDynamicNamedColor {
  ...
  namespace classes {
    export interface NSSourceListBackgroundColor<T = any> extends cocoa.classes.NSDynamicNamedColor {
