...
declare namespace cocoa {
  export interface MSOffsetPathAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    offsetPath<R = void, P0 = unknown>(_offsetPath: P0): R;
  }
  namespace classes {
    export interface MSOffsetPathAction<T = any> extends cocoa.classes.MSDocumentAction {
