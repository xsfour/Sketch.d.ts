...
declare namespace cocoa {
  export interface _NSQuickAction<T = any> extends cocoa.NSObject {
    ...
    loadColorOnQueue_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_loadColorOnQueue: P0, _completionHandler: P1): R;
    loadIconOnQueue_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_loadIconOnQueue: P0, _completionHandler: P1): R;
  ...
  namespace classes {
    export interface _NSQuickAction<T = any> extends cocoa.classes.NSObject {
