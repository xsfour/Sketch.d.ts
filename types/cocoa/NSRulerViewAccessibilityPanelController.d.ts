...
declare namespace cocoa {
  export interface NSRulerViewAccessibilityPanelController<T = any> extends cocoa.NSObject {
    ...
    _accessibilityPanel<R = cocoa.NSWindow>(): R;
    set_accessibilityPanel<R = void, P0 = cocoa.NSWindow>(_v: P0): R;
  }
  namespace classes {
    export interface NSRulerViewAccessibilityPanelController<T = any> extends cocoa.classes.NSObject {
