...
declare namespace cocoa {
  export interface NSAccessibilityAXUIElementWrapper<T = any> extends cocoa.NSObject {
    hash<R = number>(): R;
  ...
  namespace classes {
    export interface NSAccessibilityAXUIElementWrapper<T = any> extends cocoa.classes.NSObject {
