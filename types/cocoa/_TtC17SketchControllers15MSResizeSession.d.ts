...
declare namespace cocoa {
  export interface _TtC17SketchControllers15MSResizeSession<T = any> extends cocoa.NSObject {
    cxx_destruct<R = cocoa.CDUnknownBlockType>(): R;
    updateModel<R = unknown>(): R;
    locationInCoordinateSpace<R = cocoa.CGPoint, P0 = unknown>(_locationInCoordinateSpace: P0): R;
    updateWithPoint_modifierFlags<R = void, P0 = cocoa.CGPoint, P1 = number>(_updateWithPoint: P0, _modifierFlags: P1): R;
    ...
    originalCenter<R = cocoa.CGPoint>(): R;
    originalLocationOfOppositeHandle<R = cocoa.CGPoint>(): R;
  ...
  namespace classes {
    export interface _TtC17SketchControllers15MSResizeSession<T = any> extends cocoa.classes.NSObject {
