...
declare namespace cocoa {
  export interface NSNibBindingConnector<T = any> extends cocoa.NSNibConnector, cocoa.NSCodingProtocol {
  ...
  namespace classes {
    export interface NSNibBindingConnector<T = any> extends cocoa.classes.NSNibConnector, cocoa.classes.NSCodingProtocol {
