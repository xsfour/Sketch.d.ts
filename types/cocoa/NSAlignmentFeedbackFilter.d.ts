...
declare namespace cocoa {
  export interface NSAlignmentFeedbackFilter<T = any> extends cocoa.NSObject {
    ...
    alignmentFeedbackTokenForMovementInView_previousPoint_alignedPoint_defaultPoint<R = unknown, P0 = unknown, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint>(_alignmentFeedbackTokenForMovementInView: P0, _previousPoint: P1, _alignedPoint: P2, _defaultPoint: P3): R;
    _updateDragOnLocation_timestamp_modifierFlags_recognizer<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number, P3 = unknown>(__updateDragOnLocation: P0, _timestamp: P1, _modifierFlags: P2, _recognizer: P3): R;
    ...
    _setActuationBlock_coalesce<R = void, P0 = cocoa.CDUnknownBlockType, P1 = boolean>(__setActuationBlock: P0, _coalesce: P1): R;
    _actuationBlock<R = cocoa.CDUnknownBlockType>(): R;
  }
  namespace classes {
    export interface NSAlignmentFeedbackFilter<T = any> extends cocoa.classes.NSObject {
...
declare const NSAlignmentFeedbackFilter: cocoa.classes.NSAlignmentFeedbackFilter;
