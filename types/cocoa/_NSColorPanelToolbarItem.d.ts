...
declare namespace cocoa {
  export interface _NSColorPanelToolbarItem<T = any> extends cocoa.NSToolbarItem {
    representedObject<R = unknown>(): R;
    setRepresentedObject<R = void, P0 = unknown>(_setRepresentedObject: P0): R;
  }
  namespace classes {
    export interface _NSColorPanelToolbarItem<T = any> extends cocoa.classes.NSToolbarItem {
