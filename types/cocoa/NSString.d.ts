...
declare namespace cocoa {
  export interface NSString<T = any> extends cocoa.NSObject, cocoa.NSItemProviderReadingProtocol, cocoa.NSItemProviderWritingProtocol, cocoa.NSCopyingProtocol, cocoa.NSMutableCopyingProtocol, cocoa.NSSecureCodingProtocol {
    initWithCoder<R = unknown, P0 = unknown>(_initWithCoder: P0): R;
    encodeWithCoder<R = void, P0 = unknown>(_encodeWithCoder: P0): R;
    _allowsDirectEncoding<R = boolean>(): R;
    classForCoder<R = unknown>(): R;
    initWithFormat_locale_arguments<R = unknown, P0 = unknown, P1 = unknown, P2 = cocoa.__va_list_tag>(_initWithFormat: P0, _locale: P1, _arguments: P2): R;
    ...
    initWithFormat_arguments<R = unknown, P0 = unknown, P1 = cocoa.__va_list_tag>(_initWithFormat: P0, _arguments: P1): R;
    initWithValidatedFormat_validFormatSpecifiers_locale_arguments_error<R = unknown, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa.__va_list_tag, P4 = unknown>(_initWithValidatedFormat: P0, _validFormatSpecifiers: P1, _locale: P2, _arguments: P3, _error: P4): R;
    ...
    enumerateLinesUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_enumerateLinesUsingBlock: P0): R;
    enumerateSubstringsInRange_options_usingBlock<R = void, P0 = cocoa._NSRange, P1 = number, P2 = cocoa.CDUnknownBlockType>(_enumerateSubstringsInRange: P0, _options: P1, _usingBlock: P2): R;
    paragraphRangeForRange<R = cocoa._NSRange, P0 = cocoa._NSRange>(_paragraphRangeForRange: P0): R;
    lineRangeForRange<R = cocoa._NSRange, P0 = cocoa._NSRange>(_lineRangeForRange: P0): R;
    getParagraphStart_end_contentsEnd_forRange<R = void, P0 = number, P1 = number, P2 = number, P3 = cocoa._NSRange>(_getParagraphStart: P0, _end: P1, _contentsEnd: P2, _forRange: P3): R;
    getLineStart_end_contentsEnd_forRange<R = void, P0 = number, P1 = number, P2 = number, P3 = cocoa._NSRange>(_getLineStart: P0, _end: P1, _contentsEnd: P2, _forRange: P3): R;
    _getBlockStart_end_contentsEnd_forRange_stopAtLineSeparators<R = void, P0 = number, P1 = number, P2 = number, P3 = cocoa._NSRange, P4 = boolean>(__getBlockStart: P0, _end: P1, _contentsEnd: P2, _forRange: P3, _stopAtLineSeparators: P4): R;
    ...
    substringWithRange<R = unknown, P0 = cocoa._NSRange>(_substringWithRange: P0): R;
    _newSubstringWithRange_zone<R = unknown, P0 = cocoa._NSRange, P1 = cocoa._NSZone>(__newSubstringWithRange: P0, _zone: P1): R;
    ...
    stringByReplacingCharactersInRange_withString<R = unknown, P0 = cocoa._NSRange, P1 = unknown>(_stringByReplacingCharactersInRange: P0, _withString: P1): R;
    ...
    stringByReplacingOccurrencesOfString_withString_options_range<R = unknown, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa._NSRange>(_stringByReplacingOccurrencesOfString: P0, _withString: P1, _options: P2, _range: P3): R;
    ...
    localizedStandardRangeOfString<R = cocoa._NSRange, P0 = unknown>(_localizedStandardRangeOfString: P0): R;
    ...
    rangeOfCharacterFromSet<R = cocoa._NSRange, P0 = unknown>(_rangeOfCharacterFromSet: P0): R;
    rangeOfCharacterFromSet_options<R = cocoa._NSRange, P0 = unknown, P1 = number>(_rangeOfCharacterFromSet: P0, _options: P1): R;
    rangeOfCharacterFromSet_options_range<R = cocoa._NSRange, P0 = unknown, P1 = number, P2 = cocoa._NSRange>(_rangeOfCharacterFromSet: P0, _options: P1, _range: P2): R;
    rangeOfString<R = cocoa._NSRange, P0 = unknown>(_rangeOfString: P0): R;
    rangeOfString_options<R = cocoa._NSRange, P0 = unknown, P1 = number>(_rangeOfString: P0, _options: P1): R;
    rangeOfString_options_range<R = cocoa._NSRange, P0 = unknown, P1 = number, P2 = cocoa._NSRange>(_rangeOfString: P0, _options: P1, _range: P2): R;
    rangeOfString_options_range_locale<R = cocoa._NSRange, P0 = unknown, P1 = number, P2 = cocoa._NSRange, P3 = unknown>(_rangeOfString: P0, _options: P1, _range: P2, _locale: P3): R;
    rangeOfComposedCharacterSequencesForRange<R = cocoa._NSRange, P0 = cocoa._NSRange>(_rangeOfComposedCharacterSequencesForRange: P0): R;
    rangeOfComposedCharacterSequenceAtIndex<R = cocoa._NSRange, P0 = number>(_rangeOfComposedCharacterSequenceAtIndex: P0): R;
    ...
    compare_options_range_locale<R = number, P0 = unknown, P1 = number, P2 = cocoa._NSRange, P3 = unknown>(_compare: P0, _options: P1, _range: P2, _locale: P3): R;
    compare_options_range<R = number, P0 = unknown, P1 = number, P2 = cocoa._NSRange>(_compare: P0, _options: P1, _range: P2): R;
    ...
    _createSubstringWithRange<R = unknown, P0 = cocoa._NSRange>(__createSubstringWithRange: P0): R;
    _cfTypeID<R = number>(): R;
    decimalValue<R = unknown>(): R;
    _getBytesAsData_maxLength_usedLength_encoding_options_range_remainingRange<R = boolean, P0 = unknown, P1 = number, P2 = number, P3 = number, P4 = number, P5 = cocoa._NSRange, P6 = cocoa._NSRange>(__getBytesAsData: P0, _maxLength: P1, _usedLength: P2, _encoding: P3, _options: P4, _range: P5, _remainingRange: P6): R;
    _getCharactersAsStringInRange<R = unknown, P0 = cocoa._NSRange>(__getCharactersAsStringInRange: P0): R;
    ...
    _getBracketedStringFromBuffer_string<R = unknown, P0 = cocoa._NSStringBuffer, P1 = unknown>(__getBracketedStringFromBuffer: P0, _string: P1): R;
    ...
    getBytes_maxLength_filledLength_encoding_allowLossyConversion_range_remainingRange<R = boolean, P0 = string, P1 = number, P2 = number, P3 = number, P4 = boolean, P5 = cocoa._NSRange, P6 = cocoa._NSRange>(_getBytes: P0, _maxLength: P1, _filledLength: P2, _encoding: P3, _allowLossyConversion: P4, _range: P5, _remainingRange: P6): R;
    ...
    _web_rangeOfURLHost<R = cocoa._NSRange>(): R;
    _web_rangeOfURLUserPasswordHostPort<R = cocoa._NSRange>(): R;
    ...
    _web_rangeOfURLResourceSpecifier_nowarn<R = cocoa._NSRange>(): R;
    _web_rangeOfURLScheme_nowarn<R = cocoa._NSRange>(): R;
    ...
    enumerateLinguisticTagsInRange_scheme_options_orthography_usingBlock<R = void, P0 = cocoa._NSRange, P1 = unknown, P2 = number, P3 = unknown, P4 = cocoa.CDUnknownBlockType>(_enumerateLinguisticTagsInRange: P0, _scheme: P1, _options: P2, _orthography: P3, _usingBlock: P4): R;
    linguisticTagsInRange_scheme_options_orthography_tokenRanges<R = unknown, P0 = cocoa._NSRange, P1 = unknown, P2 = number, P3 = unknown, P4 = unknown>(_linguisticTagsInRange: P0, _scheme: P1, _options: P2, _orthography: P3, _tokenRanges: P4): R;
    _flushRegularExpressionCaches<R = void>(): R;
    _stringByReplacingOccurrencesOfRegularExpressionPattern_withTemplate_options_range<R = unknown, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa._NSRange>(__stringByReplacingOccurrencesOfRegularExpressionPattern: P0, _withTemplate: P1, _options: P2, _range: P3): R;
    _rangeOfRegularExpressionPattern_options_range_locale<R = cocoa._NSRange, P0 = unknown, P1 = number, P2 = cocoa._NSRange, P3 = unknown>(__rangeOfRegularExpressionPattern: P0, _options: P1, _range: P2, _locale: P3): R;
    significantText<R = cocoa._NSRange>(): R;
    ...
    stringByRemovingPercentEncoding<R = cocoa.NSString>(): R;
    ...
    rangeOfGraphicalSegmentAtIndex<R = cocoa._NSRange, P0 = number>(_rangeOfGraphicalSegmentAtIndex: P0): R;
    ...
    stringByCalculatingPercentagesInContextOfSize_onAxis<R = unknown, P0 = cocoa.CGRect, P1 = number>(_stringByCalculatingPercentagesInContextOfSize: P0, _onAxis: P1): R;
    numberValueInContextOfSize_onAxis<R = unknown, P0 = cocoa.CGRect, P1 = number>(_numberValueInContextOfSize: P0, _onAxis: P1): R;
    ...
    sizeWithFont<R = cocoa.CGSize, P0 = unknown>(_sizeWithFont: P0): R;
    drawCenteredAtPoint_withFont_color<R = void, P0 = cocoa.CGPoint, P1 = unknown, P2 = unknown>(_drawCenteredAtPoint: P0, _withFont: P1, _color: P2): R;
    drawAtPoint_withFont<R = void, P0 = cocoa.CGPoint, P1 = unknown>(_drawAtPoint: P0, _withFont: P1): R;
    wordRanges<R = unknown>(): R;
    enumerateWordRanges<R = void, P0 = cocoa.CDUnknownBlockType>(_enumerateWordRanges: P0): R;
    debugDescription<R = cocoa.NSString>(): R;
    description<R = cocoa.NSString>(): R;
    hash<R = number>(): R;
    superclass<R = unknown>(): R;
    archiveReferenceIdentifier_bc<R = cocoa.NSString>(): R;
    slug<R = cocoa.NSString>(): R;
  }
  namespace classes {
    export interface NSString<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSItemProviderReadingProtocol, cocoa.classes.NSItemProviderWritingProtocol, cocoa.classes.NSCopyingProtocol, cocoa.classes.NSMutableCopyingProtocol, cocoa.classes.NSSecureCodingProtocol {
      alloc<R = NSString>(): R;
      new: <R = NSString>() => R;
