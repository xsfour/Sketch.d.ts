...
declare namespace cocoa {
  export interface MSPreviewImageCache<T = any> extends cocoa.NSObject {
    cxx_destruct<R = void>(): R;
    exportPreviewImageForDocumentFileURL_maximumPixelSize_handler<R = void, P0 = unknown, P1 = number, P2 = cocoa.CDUnknownBlockType>(_exportPreviewImageForDocumentFileURL: P0, _maximumPixelSize: P1, _handler: P2): R;
    ...
    fetchPreviewImageForDocumentAtURL_maximumPixelSize_handler<R = void, P0 = unknown, P1 = number, P2 = cocoa.CDUnknownBlockType>(_fetchPreviewImageForDocumentAtURL: P0, _maximumPixelSize: P1, _handler: P2): R;
    initWithSubdirectoryName<R = unknown, P0 = unknown>(_initWithSubdirectoryName: P0): R;
    subdirectoryName<R = cocoa.NSString>(): R;
    sketchToolRunner<R = cocoa.BCSketchToolRunner>(): R;
    fetchQueue<R = cocoa.NSOperationQueue>(): R;
    directoryURL<R = cocoa.NSURL>(): R;
  }
  namespace classes {
    export interface MSPreviewImageCache<T = any> extends cocoa.classes.NSObject {
