...
declare namespace cocoa {
  export interface _MSImmutableForeignObject<T = any> extends cocoa.MSImmutableModelObject {
  ...
  namespace classes {
    export interface _MSImmutableForeignObject<T = any> extends cocoa.classes.MSImmutableModelObject {
