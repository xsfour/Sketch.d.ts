...
declare namespace cocoa {
  export interface NSFilePresenterProxy<T = any> extends cocoa.NSFileReactorProxy {
    localFileWasEvicted<R = void>(): R;
    promisedFileWasFulfilled<R = void>(): R;
    disconnect<R = void>(): R;
    forwardRelinquishmentForWritingClaim_withID_purposeID_subitemURL_options_completionHandler<R = void, P0 = boolean, P1 = unknown, P2 = unknown, P3 = unknown, P4 = number, P5 = cocoa.CDUnknownBlockType>(_forwardRelinquishmentForWritingClaim: P0, _withID: P1, _purposeID: P2, _subitemURL: P3, _options: P4, _completionHandler: P5): R;
    ...
    accommodateDeletionWithSubitemPath_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_accommodateDeletionWithSubitemPath: P0, _completionHandler: P1): R;
    saveChangesWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_saveChangesWithCompletionHandler: P0): R;
    relinquishToWritingClaimWithID_options_purposeID_subitemPath_resultHandler<R = void, P0 = unknown, P1 = number, P2 = unknown, P3 = unknown, P4 = cocoa.CDUnknownBlockType>(_relinquishToWritingClaimWithID: P0, _options: P1, _purposeID: P2, _subitemPath: P3, _resultHandler: P4): R;
    relinquishToReadingClaimWithID_options_purposeID_resultHandler<R = void, P0 = unknown, P1 = number, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(_relinquishToReadingClaimWithID: P0, _options: P1, _purposeID: P2, _resultHandler: P3): R;
    ...
    startWatchingWithQueue_lastEventID_unannouncedMoveHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_startWatchingWithQueue: P0, _lastEventID: P1, _unannouncedMoveHandler: P2): R;
    ...
    observedUbiquityAttributes<R = cocoa.NSSet>(): R;
    setObservedUbiquityAttributes<R = void, P0 = cocoa.NSSet>(_v: P0): R;
  ...
  namespace classes {
    export interface NSFilePresenterProxy<T = any> extends cocoa.classes.NSFileReactorProxy {
