...
declare namespace cocoa {
  export interface NSSpecifierTest<T = any> extends cocoa.NSScriptWhoseTest {
  ...
  namespace classes {
    export interface NSSpecifierTest<T = any> extends cocoa.classes.NSScriptWhoseTest {
...
declare const NSSpecifierTest: cocoa.classes.NSSpecifierTest;
