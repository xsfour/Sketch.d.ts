...
declare namespace cocoa {
  export interface MSTogglePixelGridAction<T = any> extends cocoa.MSDocumentAction {
  ...
  namespace classes {
    export interface MSTogglePixelGridAction<T = any> extends cocoa.classes.MSDocumentAction {
