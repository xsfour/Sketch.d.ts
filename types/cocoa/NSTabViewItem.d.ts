...
declare namespace cocoa {
  export interface NSTabViewItem<T = any> extends cocoa.NSObject, cocoa.NSCodingProtocol {
    cxx_destruct<R = void>(): R;
    _tabViewWillRemoveFromSuperview<R = void>(): R;
    _resetToolTipIfNecessary<R = void>(): R;
    _removeToolTip<R = void>(): R;
    _addToolTipRect<R = number, P0 = cocoa.CGRect>(__addToolTipRect: P0): R;
    _fullLabel<R = unknown>(): R;
    _computeNominalDisplayedLabelSize<R = cocoa.CGSize>(): R;
    _computeMinimumDisplayedLabelSize<R = cocoa.CGSize>(): R;
    _computeDisplayedSizeOfString<R = cocoa.CGSize, P0 = unknown>(__computeDisplayedSizeOfString: P0): R;
    _computeMinimumDisplayedLabelForWidth<R = unknown, P0 = number>(__computeMinimumDisplayedLabelForWidth: P0): R;
    _rangeOfPrefixOfString_fittingWidth_withFont<R = cocoa._NSRange, P0 = unknown, P1 = number, P2 = unknown>(__rangeOfPrefixOfString: P0, _fittingWidth: P1, _withFont: P2): R;
    ...
    sizeOfLabel<R = cocoa.CGSize, P0 = boolean>(_sizeOfLabel: P0): R;
    _invalidLabelSize<R = void>(): R;
    _drawKeyViewOutline<R = void, P0 = cocoa.CGRect>(__drawKeyViewOutline: P0): R;
    drawLabel_inRect<R = void, P0 = boolean, P1 = cocoa.CGRect>(_drawLabel: P0, _inRect: P1): R;
    interiorBackgroundStyle<R = number>(): R;
    _setActive<R = void, P0 = boolean>(__setActive: P0): R;
    _isReallyPressed<R = boolean>(): R;
    _drawOrientedLabel_inRect<R = void, P0 = boolean, P1 = cocoa.CGRect>(__drawOrientedLabel: P0, _inRect: P1): R;
    _rotateCoordsForDrawLabelInRect<R = boolean, P0 = cocoa.CGRect>(__rotateCoordsForDrawLabelInRect: P0): R;
    ...
    _setTabRect<R = void, P0 = cocoa.CGRect>(__setTabRect: P0): R;
    ...
    _view<R = cocoa.NSView>(): R;
    set_view<R = void, P0 = cocoa.NSView>(_v: P0): R;
    _label<R = cocoa.NSString>(): R;
    set_label<R = void, P0 = cocoa.NSString>(_v: P0): R;
    _initialFirstResponder<R = cocoa.NSView>(): R;
    set_initialFirstResponder<R = void, P0 = cocoa.NSView>(_v: P0): R;
    _color<R = cocoa.NSColor>(): R;
    set_color<R = void, P0 = cocoa.NSColor>(_v: P0): R;
    tabState<R = number>(): R;
  ...
  namespace classes {
    export interface NSTabViewItem<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCodingProtocol {
