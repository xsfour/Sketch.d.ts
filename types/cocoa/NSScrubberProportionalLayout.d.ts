...
declare namespace cocoa {
  export interface NSScrubberProportionalLayout<T = any> extends cocoa.NSScrubberLayout {
  ...
  namespace classes {
    export interface NSScrubberProportionalLayout<T = any> extends cocoa.classes.NSScrubberLayout {
