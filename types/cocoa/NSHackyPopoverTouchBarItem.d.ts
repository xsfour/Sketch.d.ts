...
declare namespace cocoa {
  export interface NSHackyPopoverTouchBarItem<T = any> extends cocoa.NSPopoverTouchBarItem {
    visible<R = boolean>(): R;
    setVisible<R = void, P0 = boolean>(_v: P0): R;
  }
  namespace classes {
    export interface NSHackyPopoverTouchBarItem<T = any> extends cocoa.classes.NSPopoverTouchBarItem {
