...
declare namespace cocoa {
  export interface NSRGBColorValueTransformer<T = any> extends cocoa.NSValueTransformer {
    entryMode<R = number>(): R;
    setEntryMode<R = void, P0 = number>(_v: P0): R;
  }
  namespace classes {
    export interface NSRGBColorValueTransformer<T = any> extends cocoa.classes.NSValueTransformer {
