...
declare namespace cocoa {
  export interface _NSPasteboardItemCollection<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSPasteboardItemCollection<T = any> extends cocoa.classes.NSObject {
