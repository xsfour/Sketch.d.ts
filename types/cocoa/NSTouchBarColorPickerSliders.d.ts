...
declare namespace cocoa {
  export interface NSTouchBarColorPickerSliders<T = any> extends cocoa.NSControl, cocoa.NSTouchBarColorPickerSliderMinimizationDelegateProtocol, cocoa.NSTouchBarColorPickerViewProtocol {
    ...
    colorSpaceColor<R = cocoa.NSColor>(): R;
    action<R = string>(): R;
  ...
  namespace classes {
    export interface NSTouchBarColorPickerSliders<T = any> extends cocoa.classes.NSControl, cocoa.classes.NSTouchBarColorPickerSliderMinimizationDelegateProtocol, cocoa.classes.NSTouchBarColorPickerViewProtocol {
      ...
      orderedColorComponentsEnumerator<R = void, P0 = cocoa.CDUnknownBlockType>(_orderedColorComponentsEnumerator: P0): R;
      enumerateColorComponentsInMask_enumerator<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_enumerateColorComponentsInMask: P0, _enumerator: P1): R;
