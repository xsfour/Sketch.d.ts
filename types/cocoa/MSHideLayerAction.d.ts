...
declare namespace cocoa {
  export interface MSHideLayerAction<T = any> extends cocoa.MSDocumentAction {
  ...
  namespace classes {
    export interface MSHideLayerAction<T = any> extends cocoa.classes.MSDocumentAction {
