...
declare namespace cocoa {
  export interface MSChangeFlowAnimationFromTopAnimationAction<T = any> extends cocoa.MSChangeFlowAnimationAction {
    label<R = unknown>(): R;
    changeFlowAnimationToFromTopAnimation<R = void, P0 = unknown>(_changeFlowAnimationToFromTopAnimation: P0): R;
  }
  namespace classes {
    export interface MSChangeFlowAnimationFromTopAnimationAction<T = any> extends cocoa.classes.MSChangeFlowAnimationAction {
