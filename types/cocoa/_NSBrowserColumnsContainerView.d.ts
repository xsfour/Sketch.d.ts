...
declare namespace cocoa {
  export interface _NSBrowserColumnsContainerView<T = any> extends cocoa.NSView {
  ...
  namespace classes {
    export interface _NSBrowserColumnsContainerView<T = any> extends cocoa.classes.NSView {
