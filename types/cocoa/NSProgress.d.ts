...
declare namespace cocoa {
  export interface NSProgress<T = any> extends cocoa.NSObject, cocoa.NSProgressPublisherProtocol {
    ...
    handleAcknowledgementByAppWithBundleIdentifier_usingBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_handleAcknowledgementByAppWithBundleIdentifier: P0, _usingBlock: P1): R;
    prioritizationHandler<R = cocoa.CDUnknownBlockType>(): R;
    setPrioritizationHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_setPrioritizationHandler: P0): R;
    ...
    _acknowledgementHandlerForAppBundleIdentifier<R = cocoa.CDUnknownBlockType, P0 = unknown>(__acknowledgementHandlerForAppBundleIdentifier: P0): R;
    acknowledgementHandlerForAppBundleIdentifier<R = cocoa.CDUnknownBlockType, P0 = unknown>(_acknowledgementHandlerForAppBundleIdentifier: P0): R;
    _setAcknowledgementHandler_forAppBundleIdentifier<R = void, P0 = cocoa.CDUnknownBlockType, P1 = unknown>(__setAcknowledgementHandler: P0, _forAppBundleIdentifier: P1): R;
    setAcknowledgementHandler_forAppBundleIdentifier<R = void, P0 = cocoa.CDUnknownBlockType, P1 = unknown>(_setAcknowledgementHandler: P0, _forAppBundleIdentifier: P1): R;
    _unpublish<R = void>(): R;
    unpublish<R = void>(): R;
    _publish<R = void>(): R;
    publish<R = void>(): R;
    ...
    _setValueForKeys_settingBlock<R = unknown, P0 = cocoa.CDUnknownBlockType, P1 = cocoa.CDUnknownBlockType>(__setValueForKeys: P0, _settingBlock: P1): R;
    ...
    becomeCurrentWithPendingUnitCount_inBlock<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_becomeCurrentWithPendingUnitCount: P0, _inBlock: P1): R;
    performAsCurrentWithPendingUnitCount_usingBlock<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_performAsCurrentWithPendingUnitCount: P0, _usingBlock: P1): R;
    ...
    handleAcknowledgementByAppWithBundleIdentifer_usingBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_handleAcknowledgementByAppWithBundleIdentifer: P0, _usingBlock: P1): R;
    _receiveProgressMessage_forSequence<R = void, P0 = unknown, P1 = number>(__receiveProgressMessage: P0, _forSequence: P1): R;
    old<R = boolean>(): R;
    kind<R = cocoa.NSString>(): R;
    setKind<R = void, P0 = cocoa.NSString>(_v: P0): R;
    fileCompletedCount<R = cocoa.NSNumber>(): R;
    setFileCompletedCount<R = void, P0 = cocoa.NSNumber>(_v: P0): R;
    fileTotalCount<R = cocoa.NSNumber>(): R;
    setFileTotalCount<R = void, P0 = cocoa.NSNumber>(_v: P0): R;
    fileURL<R = cocoa.NSURL>(): R;
    setFileURL<R = void, P0 = cocoa.NSURL>(_v: P0): R;
    fileOperationKind<R = cocoa.NSString>(): R;
    setFileOperationKind<R = void, P0 = cocoa.NSString>(_v: P0): R;
    throughput<R = cocoa.NSNumber>(): R;
    setThroughput<R = void, P0 = cocoa.NSNumber>(_v: P0): R;
    estimatedTimeRemaining<R = cocoa.NSNumber>(): R;
    setEstimatedTimeRemaining<R = void, P0 = cocoa.NSNumber>(_v: P0): R;
    userInfo<R = cocoa.NSDictionary>(): R;
    fractionCompleted<R = number>(): R;
    indeterminate<R = boolean>(): R;
    description<R = cocoa.NSString>(): R;
    resumingHandler<R = cocoa.CDUnknownBlockType>(): R;
    setResumingHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_v: P0): R;
    pausingHandler<R = cocoa.CDUnknownBlockType>(): R;
    setPausingHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_v: P0): R;
    ...
    localizedAdditionalDescription<R = cocoa.NSString>(): R;
    setLocalizedAdditionalDescription<R = void, P0 = cocoa.NSString>(_v: P0): R;
    localizedDescription<R = cocoa.NSString>(): R;
    setLocalizedDescription<R = void, P0 = cocoa.NSString>(_v: P0): R;
  ...
  namespace classes {
    export interface NSProgress<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSProgressPublisherProtocol {
      ...
      _addSubscriberForFileURL_usingBlock<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__addSubscriberForFileURL: P0, _usingBlock: P1): R;
      addSubscriberForFileURL_usingBlock<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_addSubscriberForFileURL: P0, _usingBlock: P1): R;
      _addSubscriberForCategory_usingPublishingHandler<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__addSubscriberForCategory: P0, _usingPublishingHandler: P1): R;
      _removeSubscriber<R = void, P0 = unknown>(__removeSubscriber: P0): R;
      removeSubscriber<R = void, P0 = unknown>(_removeSubscriber: P0): R;
      _addSubscriberForFileURL_withPublishingHandler<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__addSubscriberForFileURL: P0, _withPublishingHandler: P1): R;
      addSubscriberForFileURL_withPublishingHandler<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_addSubscriberForFileURL: P0, _withPublishingHandler: P1): R;
