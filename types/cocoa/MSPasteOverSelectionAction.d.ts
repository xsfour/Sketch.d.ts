...
declare namespace cocoa {
  export interface MSPasteOverSelectionAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    pasteOverSelection<R = void, P0 = unknown>(_pasteOverSelection: P0): R;
    validate<R = boolean>(): R;
  }
  namespace classes {
    export interface MSPasteOverSelectionAction<T = any> extends cocoa.classes.MSDocumentAction {
