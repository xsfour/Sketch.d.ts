...
declare namespace cocoa {
  export interface _NSFullScreenTileToTabTransitionController<T = any> extends cocoa._NSFullScreenTransitionController {
  ...
  namespace classes {
    export interface _NSFullScreenTileToTabTransitionController<T = any> extends cocoa.classes._NSFullScreenTransitionController {
