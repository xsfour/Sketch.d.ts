...
declare namespace cocoa {
  export interface NSTouchBarLayout<T = any> extends cocoa.NSObject {
    ...
    _aggregateWidthOfItems_sharesLeftEdge_sharesRightEdge_widthMeasurement<R = number, P0 = unknown, P1 = boolean, P2 = boolean, P3 = cocoa.CDUnknownBlockType>(__aggregateWidthOfItems: P0, _sharesLeftEdge: P1, _sharesRightEdge: P2, _widthMeasurement: P3): R;
    _prioritizedItems<R = unknown, P0 = unknown>(__prioritizedItems: P0): R;
    _centerRectGivenItems_remainingLeftWidth_remainingRightWidth_sharesLeftEdge_sharesRightEdge<R = cocoa.CGRect, P0 = unknown, P1 = number, P2 = number, P3 = boolean, P4 = boolean>(__centerRectGivenItems: P0, _remainingLeftWidth: P1, _remainingRightWidth: P2, _sharesLeftEdge: P3, _sharesRightEdge: P4): R;
    _centerRectGivenItems_leftItems_rightItems_totalWidth_xOrigin<R = cocoa.CGRect, P0 = unknown, P1 = unknown, P2 = unknown, P3 = number, P4 = number>(__centerRectGivenItems: P0, _leftItems: P1, _rightItems: P2, _totalWidth: P3, _xOrigin: P4): R;
    ...
    items_centerItems_minSize_maxSize<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CGSize, P3 = cocoa.CGSize>(_items: P0, _centerItems: P1, _minSize: P2, _maxSize: P3): R;
    _calculateLayoutOfItems_centerItems_givenSize_originX<R = unknown, P0 = unknown, P1 = unknown, P2 = cocoa.CGSize, P3 = number>(__calculateLayoutOfItems: P0, _centerItems: P1, _givenSize: P2, _originX: P3): R;
    _attributesOfItems_centerItems_givenSize_sharesLeftEdge_sharesRightEdge_xOrigin<R = unknown, P0 = unknown, P1 = unknown, P2 = cocoa.CGSize, P3 = boolean, P4 = boolean, P5 = number>(__attributesOfItems: P0, _centerItems: P1, _givenSize: P2, _sharesLeftEdge: P3, _sharesRightEdge: P4, _xOrigin: P5): R;
    attributesOfItems_centerItems_givenSize<R = unknown, P0 = unknown, P1 = unknown, P2 = cocoa.CGSize>(_attributesOfItems: P0, _centerItems: P1, _givenSize: P2): R;
  ...
  namespace classes {
    export interface NSTouchBarLayout<T = any> extends cocoa.classes.NSObject {
