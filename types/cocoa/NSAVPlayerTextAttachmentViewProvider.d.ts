...
declare namespace cocoa {
  export interface NSAVPlayerTextAttachmentViewProvider<T = any> extends cocoa.NSTextAttachmentViewProvider {
    observeValueForKeyPath_ofObject_change_context<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = void>(_observeValueForKeyPath: P0, _ofObject: P1, _change: P2, _context: P3): R;
    attachmentBoundsForTextContainer_proposedLineFragment_glyphPosition_characterIndex<R = cocoa.CGRect, P0 = unknown, P1 = cocoa.CGRect, P2 = cocoa.CGPoint, P3 = number>(_attachmentBoundsForTextContainer: P0, _proposedLineFragment: P1, _glyphPosition: P2, _characterIndex: P3): R;
    loadView<R = void>(): R;
    dealloc<R = void>(): R;
    ...
    avPlayer<R = cocoa.AVPlayer>(): R;
    setAvPlayer<R = void, P0 = cocoa.AVPlayer>(_v: P0): R;
    presentationSize<R = cocoa.CGSize>(): R;
  }
  namespace classes {
    export interface NSAVPlayerTextAttachmentViewProvider<T = any> extends cocoa.classes.NSTextAttachmentViewProvider {
