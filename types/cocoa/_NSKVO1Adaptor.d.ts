...
declare namespace cocoa {
  export interface _NSKVO1Adaptor<T = any> extends cocoa._NSConcreteObservation {
  ...
  namespace classes {
    export interface _NSKVO1Adaptor<T = any> extends cocoa.classes._NSConcreteObservation {
