...
declare namespace cocoa {
  export interface NSConcreteNotification<T = any> extends cocoa.NSNotification {
    recycle<R = void>(): R;
    dealloc<R = void>(): R;
  ...
  namespace classes {
    export interface NSConcreteNotification<T = any> extends cocoa.classes.NSNotification {
