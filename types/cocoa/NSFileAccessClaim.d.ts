...
declare namespace cocoa {
  export interface NSFileAccessClaim<T = any> extends cocoa.NSObject, cocoa.NSSecureCodingProtocol {
    ...
    checkIfSymbolicLinkAtURL_withResolutionCount_andIfSoThenReevaluateSelf<R = boolean, P0 = unknown, P1 = number, P2 = cocoa.CDUnknownBlockType>(_checkIfSymbolicLinkAtURL: P0, _withResolutionCount: P1, _andIfSoThenReevaluateSelf: P2): R;
    ...
    prepareItemForUploadingFromURL_thenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_prepareItemForUploadingFromURL: P0, _thenContinue: P1): R;
    ...
    makePresentersOfItemAtLocation_orContainedItem_relinquishUsingProcedureGetter<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_makePresentersOfItemAtLocation: P0, _orContainedItem: P1, _relinquishUsingProcedureGetter: P2): R;
    makeProviderOfItemAtLocation_provideOrAttachPhysicalURLIfNecessaryForPurposeID_writingOptions_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa.CDUnknownBlockType>(_makeProviderOfItemAtLocation: P0, _provideOrAttachPhysicalURLIfNecessaryForPurposeID: P1, _writingOptions: P2, _thenContinue: P3): R;
    makeProviderOfItemAtLocation_provideOrAttachPhysicalURLIfNecessaryForPurposeID_readingOptions_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa.CDUnknownBlockType>(_makeProviderOfItemAtLocation: P0, _provideOrAttachPhysicalURLIfNecessaryForPurposeID: P1, _readingOptions: P2, _thenContinue: P3): R;
    makeProviderOfItemAtLocation_providePhysicalURLThenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_makeProviderOfItemAtLocation: P0, _providePhysicalURLThenContinue: P1): R;
    makeProviderOfItemAtLocation_provideIfNecessaryWithOptions_thenContinue<R = void, P0 = unknown, P1 = number, P2 = cocoa.CDUnknownBlockType>(_makeProviderOfItemAtLocation: P0, _provideIfNecessaryWithOptions: P1, _thenContinue: P2): R;
    ensureProvidersOfItemsAtReadingLocations_writingLocations_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_ensureProvidersOfItemsAtReadingLocations: P0, _writingLocations: P1, _thenContinue: P2): R;
    granted<R = void>(): R;
    ...
    whenFinishedPerformProcedure<R = void, P0 = cocoa.CDUnknownBlockType>(_whenFinishedPerformProcedure: P0): R;
    whenDevaluedPerformProcedure<R = void, P0 = cocoa.CDUnknownBlockType>(_whenDevaluedPerformProcedure: P0): R;
    whenRevokedPerformProcedure<R = void, P0 = cocoa.CDUnknownBlockType>(_whenRevokedPerformProcedure: P0): R;
    ...
    acceptClaimFromClient_arbiterQueue_grantHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_acceptClaimFromClient: P0, _arbiterQueue: P1, _grantHandler: P2): R;
    prepareClaimForGrantingWithArbiterQueue<R = void, P0 = unknown>(_prepareClaimForGrantingWithArbiterQueue: P0): R;
    forwardUsingConnection_crashHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_forwardUsingConnection: P0, _crashHandler: P1): R;
    ...
    claimerWaiter<R = cocoa.OS_dispatch_semaphore>(): R;
    allURLs<R = cocoa.NSArray>(): R;
  }
  namespace classes {
    export interface NSFileAccessClaim<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSSecureCodingProtocol {
