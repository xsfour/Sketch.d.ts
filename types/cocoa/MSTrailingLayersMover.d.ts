...
declare namespace cocoa {
  export interface MSTrailingLayersMover<T = any> extends cocoa.NSObject {}
  namespace classes {
    export interface MSTrailingLayersMover<T = any> extends cocoa.classes.NSObject {
      ...
      spaceBetweenRect_andPreviousRect_inDirection<R = number, P0 = cocoa.CGRect, P1 = cocoa.CGRect, P2 = number>(_spaceBetweenRect: P0, _andPreviousRect: P1, _inDirection: P2): R;
      ...
      changeFrameForLayers_inBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_changeFrameForLayers: P0, _inBlock: P1): R;
    }
  }
}
