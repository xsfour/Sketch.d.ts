...
declare namespace cocoa {
  export interface NSViewDynamicToolTipManager<T = any> extends cocoa.NSObject {
    _currentLocalMousePoint<R = cocoa.CGPoint>(): R;
    ...
    dynamicToolTipRevealoverInfoAtPoint_trackingRect<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGRect>(_dynamicToolTipRevealoverInfoAtPoint: P0, _trackingRect: P1): R;
    dynamicToolTipStringAtPoint_trackingRect<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGRect>(_dynamicToolTipStringAtPoint: P0, _trackingRect: P1): R;
    dynamicToolTipRectAtPoint<R = cocoa.CGRect, P0 = cocoa.CGPoint>(_dynamicToolTipRectAtPoint: P0): R;
  ...
  namespace classes {
    export interface NSViewDynamicToolTipManager<T = any> extends cocoa.classes.NSObject {
