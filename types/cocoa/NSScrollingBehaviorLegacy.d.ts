...
declare namespace cocoa {
  export interface NSScrollingBehaviorLegacy<T = any> extends cocoa.NSScrollingBehavior {
    ...
    _scrollView_snabRubberBandWithVelocity<R = void, P0 = unknown, P1 = cocoa.CGSize>(__scrollView: P0, _snabRubberBandWithVelocity: P1): R;
    ...
    dealloc<R = void>(): R;
    scrollViewRefForCarbonApps<R = cocoa.NSScrollView>(): R;
    setScrollViewRefForCarbonApps<R = void, P0 = cocoa.NSScrollView>(_v: P0): R;
    endGestureMonitor<R = unknown>(): R;
    setEndGestureMonitor<R = void, P0 = unknown>(_v: P0): R;
  }
  namespace classes {
    export interface NSScrollingBehaviorLegacy<T = any> extends cocoa.classes.NSScrollingBehavior {
