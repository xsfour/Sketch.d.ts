...
declare namespace cocoa {
  export interface MSConstraintFixWidthAction<T = any> extends cocoa.MSConstraintAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSConstraintFixWidthAction<T = any> extends cocoa.classes.MSConstraintAction {
