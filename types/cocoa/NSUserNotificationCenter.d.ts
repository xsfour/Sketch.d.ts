...
declare namespace cocoa {
  export interface NSUserNotificationCenter<T = any> extends cocoa.NSObject {
    ...
    _appDelegate<R = cocoa._NSUserNotificationCenterDelegatePrivate>(): R;
    set_appDelegate<R = void, P0 = cocoa._NSUserNotificationCenterDelegatePrivate>(_v: P0): R;
    _displayedNotifications<R = cocoa.NSArray>(): R;
    _maxPresentedNotifications<R = number>(): R;
    _notificationPreferences<R = number>(): R;
    _notificationsDisabled<R = boolean>(): R;
    _presentedAlerts<R = cocoa.NSArray>(): R;
    _preventApplicationLaunching<R = boolean>(): R;
    set_preventApplicationLaunching<R = void, P0 = boolean>(_v: P0): R;
    _registeredPushToken<R = cocoa.NSData>(): R;
    _reverseDeliveredNotifications<R = boolean>(): R;
    set_reverseDeliveredNotifications<R = void, P0 = boolean>(_v: P0): R;
    _todaySummaryNotifications<R = cocoa.NSArray>(): R;
    set_todaySummaryNotifications<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    _tomorrowSummaryNotifications<R = cocoa.NSArray>(): R;
    set_tomorrowSummaryNotifications<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    delegate<R = cocoa.NSUserNotificationCenterDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSUserNotificationCenterDelegate>(_v: P0): R;
    deliveredNotifications<R = cocoa.NSArray>(): R;
    scheduledNotifications<R = cocoa.NSArray>(): R;
    setScheduledNotifications<R = void, P0 = cocoa.NSArray>(_v: P0): R;
  }
  namespace classes {
    export interface NSUserNotificationCenter<T = any> extends cocoa.classes.NSObject {
      ...
      _registerConnectionCallback<R = void, P0 = cocoa.CDUnknownBlockType>(__registerConnectionCallback: P0): R;
      _centerForBundleIdentifier<R = unknown, P0 = unknown>(__centerForBundleIdentifier: P0): R;
      _registerForOnDemandCallback<R = void, P0 = cocoa.CDUnknownBlockType>(__registerForOnDemandCallback: P0): R;
