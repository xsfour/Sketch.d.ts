...
declare namespace cocoa {
  export interface NSSecureStringWrapper<T = any> extends cocoa.NSString {
    length<R = number>(): R;
    dealloc<R = void>(): R;
    initWithBulletCharacter_length<R = unknown, P0 = number, P1 = number>(_initWithBulletCharacter: P0, _length: P1): R;
    initWithOriginalString<R = unknown, P0 = cocoa.__CFString>(_initWithOriginalString: P0): R;
  }
  namespace classes {
    export interface NSSecureStringWrapper<T = any> extends cocoa.classes.NSString {
