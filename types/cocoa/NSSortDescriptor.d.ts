...
declare namespace cocoa {
  export interface NSSortDescriptor<T = any> extends cocoa.NSObject, cocoa.NSSecureCodingProtocol, cocoa.NSCopyingProtocol {
    ...
    dealloc<R = void>(): R;
    initWithKey_ascending_comparator<R = unknown, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_initWithKey: P0, _ascending: P1, _comparator: P2): R;
    ...
    comparator<R = cocoa.CDUnknownBlockType>(): R;
    selector<R = string>(): R;
    ascending<R = boolean>(): R;
    key<R = cocoa.NSString>(): R;
  }
  namespace classes {
    export interface NSSortDescriptor<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSSecureCodingProtocol, cocoa.classes.NSCopyingProtocol {
      alloc<R = NSSortDescriptor>(): R;
      new: <R = NSSortDescriptor>() => R;
      _defaultSelectorName<R = unknown>(): R;
      sortDescriptorWithKey_ascending_comparator<R = unknown, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_sortDescriptorWithKey: P0, _ascending: P1, _comparator: P2): R;
