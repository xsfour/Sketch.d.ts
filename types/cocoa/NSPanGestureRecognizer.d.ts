...
declare namespace cocoa {
  export interface NSPanGestureRecognizer<T = any> extends cocoa.NSGestureRecognizer, cocoa.NSCodingProtocol {
    ...
    _updatePropertiesWithLocation_event<R = void, P0 = cocoa.CGPoint, P1 = unknown>(__updatePropertiesWithLocation: P0, _event: P1): R;
    _updateForMouseDownWithEvent<R = void, P0 = unknown>(__updateForMouseDownWithEvent: P0): R;
    timestamp<R = number>(): R;
    touches<R = unknown>(): R;
    velocityInView<R = cocoa.CGPoint, P0 = unknown>(_velocityInView: P0): R;
    ...
    _auxLocationInWindow<R = cocoa.CGPoint>(): R;
  ...
  namespace classes {
    export interface NSPanGestureRecognizer<T = any> extends cocoa.classes.NSGestureRecognizer, cocoa.classes.NSCodingProtocol {
