...
declare namespace cocoa {
  export interface _NSProgressProxy<T = any> extends cocoa.NSProgress {
    isOld<R = boolean>(): R;
    ...
    setPausingHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_setPausingHandler: P0): R;
    setCancellationHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_setCancellationHandler: P0): R;
    ...
    _invokePublishingHandler<R = void, P0 = cocoa.CDUnknownBlockType>(__invokePublishingHandler: P0): R;
    _initWithForwarder_values_isOld<R = unknown, P0 = unknown, P1 = unknown, P2 = boolean>(__initWithForwarder: P0, _values: P1, _isOld: P2): R;
  }
  namespace classes {
    export interface _NSProgressProxy<T = any> extends cocoa.classes.NSProgress {
