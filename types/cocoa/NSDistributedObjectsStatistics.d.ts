...
declare namespace cocoa {
  export interface NSDistributedObjectsStatistics<T = any> extends cocoa.NSDictionary {
  ...
  namespace classes {
    export interface NSDistributedObjectsStatistics<T = any> extends cocoa.classes.NSDictionary {  }
  }
}
