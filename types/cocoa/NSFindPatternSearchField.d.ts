...
declare namespace cocoa {
  export interface NSFindPatternSearchField<T = any> extends cocoa.NSTextFinderBarSearchField, cocoa.NSFindPatternFieldProtocol {
  ...
  namespace classes {
    export interface NSFindPatternSearchField<T = any> extends cocoa.classes.NSTextFinderBarSearchField, cocoa.classes.NSFindPatternFieldProtocol {
...
declare const NSFindPatternSearchField: cocoa.classes.NSFindPatternSearchField;
