...
declare namespace cocoa {
  export interface NSPersistentUIFileManager<T = any> extends cocoa.NSObject {
    finishPendingChangesImmediatelyWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_finishPendingChangesImmediatelyWithCompletionHandler: P0): R;
    ...
    _trySystemCallDescribedBy_executor<R = boolean, P0 = string, P1 = cocoa.CDUnknownBlockType>(__trySystemCallDescribedBy: P0, _executor: P1): R;
    ...
    _rawStateDirectoryAtLaunch<R = cocoa.NSPersistentUIPreservedStateDirectory>(): R;
    set_rawStateDirectoryAtLaunch<R = void, P0 = cocoa.NSPersistentUIPreservedStateDirectory>(_v: P0): R;
    persistentStateDirectoryURL<R = cocoa.NSURL>(): R;
  }
  namespace classes {
    export interface NSPersistentUIFileManager<T = any> extends cocoa.classes.NSObject {
