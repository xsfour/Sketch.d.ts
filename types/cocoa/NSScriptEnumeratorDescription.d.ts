...
declare namespace cocoa {
  export interface NSScriptEnumeratorDescription<T = any> extends cocoa.NSObject {
    value<R = unknown>(): R;
  ...
  namespace classes {
    export interface NSScriptEnumeratorDescription<T = any> extends cocoa.classes.NSObject {
...
declare const NSScriptEnumeratorDescription: cocoa.classes.NSScriptEnumeratorDescription;
