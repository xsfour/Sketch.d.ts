...
declare namespace cocoa {
  export interface NSStackObservedValue<T = any> extends cocoa.NSObservedValue {
  ...
  namespace classes {
    export interface NSStackObservedValue<T = any> extends cocoa.classes.NSObservedValue {
