...
declare namespace cocoa {
  export interface MSEditColorSpaceAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    editDocumentColorSpace<R = void, P0 = unknown>(_editDocumentColorSpace: P0): R;
  }
  namespace classes {
    export interface MSEditColorSpaceAction<T = any> extends cocoa.classes.MSDocumentAction {
