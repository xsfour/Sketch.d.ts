...
declare namespace cocoa {
  export interface NSScriptArgumentDescription<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSScriptArgumentDescription<T = any> extends cocoa.classes.NSObject {
