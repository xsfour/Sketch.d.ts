...
declare namespace cocoa {
  export interface NSAccessibilityElement<T = any> extends cocoa.NSObject, cocoa.NSAccessibilityProtocol, cocoa.NSAccessibilityElementProtocol {
    dealloc<R = void>(): R;
    ...
    setAccessibilityFrameInParentSpace<R = void, P0 = cocoa.CGRect>(_v: P0): R;
  ...
  namespace classes {
    export interface NSAccessibilityElement<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSAccessibilityProtocol, cocoa.classes.NSAccessibilityElementProtocol {
      alloc<R = NSAccessibilityElement>(): R;
      new: <R = NSAccessibilityElement>() => R;
      accessibilityElementWithRole_frame_label_parent<R = unknown, P0 = unknown, P1 = cocoa.CGRect, P2 = unknown, P3 = unknown>(_accessibilityElementWithRole: P0, _frame: P1, _label: P2, _parent: P3): R;
    }
  }
}
