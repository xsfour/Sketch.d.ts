...
declare namespace cocoa {
  export interface MSImmutableFlowConnection<T = any> extends cocoa._MSImmutableFlowConnection {
  ...
  namespace classes {
    export interface MSImmutableFlowConnection<T = any> extends cocoa.classes._MSImmutableFlowConnection {
