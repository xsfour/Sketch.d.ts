...
declare namespace cocoa {
  export interface MSContentDrawView<T0 = void, T1 = void, T2 = void> extends NSView, MSOverlayRenderingDelegateProtocol, MSEventHandlerManagerDelegateProtocol, MSTiledRendererHostViewProtocol {
    ...
    flowCollector<R = MSFlowRendererCollector>(): R;
    setFlowCollector<R = void, P0 = MSFlowRendererCollector>(_v: P0): R;
    debugDriver<R = MSRenderingDriver>(): R;
    setDebugDriver<R = void, P0 = MSRenderingDriver>(_v: P0): R;
    normalDriver<R = MSRenderingDriver>(): R;
    setNormalDriver<R = void, P0 = MSRenderingDriver>(_v: P0): R;
