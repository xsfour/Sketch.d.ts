...
declare namespace cocoa {
  export interface NSAccessibilityColorUtilities<T = any> extends cocoa.NSObject {}
  namespace classes {
    export interface NSAccessibilityColorUtilities<T = any> extends cocoa.classes.NSObject {
