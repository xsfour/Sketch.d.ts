...
declare namespace cocoa {
  export interface NSTimer<T = any> {
    // + NSTimer(NSTimer):
    ...
    interval<R = number>(): R;
    order<R = number>(): R;
    copyDebugDescription<R = cocoa.__CFString>(): R;
    ...
    initWithFireDate_interval_repeats_block<R = unknown, P0 = unknown, P1 = number, P2 = boolean, P3 = cocoa.CDUnknownBlockType>(_initWithFireDate: P0, _interval: P1, _repeats: P2, _block: P3): R;
  }
  namespace classes {
    export interface NSTimer<T = any> {
      // + NSTimer(NSTimer):
      ...
      scheduledTimerWithTimeInterval_repeats_block<R = unknown, P0 = number, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_scheduledTimerWithTimeInterval: P0, _repeats: P1, _block: P2): R;
      timerWithTimeInterval_repeats_block<R = unknown, P0 = number, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_timerWithTimeInterval: P0, _repeats: P1, _block: P2): R;
...
declare const NSTimer: cocoa.classes.NSTimer;
