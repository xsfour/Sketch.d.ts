...
declare namespace cocoa {
  export interface NSArchiver<T = any> extends cocoa.NSCoder {
    ...
    archiverData<R = cocoa.NSMutableData>(): R;
  }
  namespace classes {
    export interface NSArchiver<T = any> extends cocoa.classes.NSCoder {
