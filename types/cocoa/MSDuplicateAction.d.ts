...
declare namespace cocoa {
  export interface MSDuplicateAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    duplicate<R = void, P0 = unknown>(_duplicate: P0): R;
  }
  namespace classes {
    export interface MSDuplicateAction<T = any> extends cocoa.classes.MSDocumentAction {
