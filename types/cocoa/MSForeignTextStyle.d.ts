...
declare namespace cocoa {
  export interface MSForeignTextStyle<T = any> extends cocoa._MSForeignTextStyle {
  ...
  namespace classes {
    export interface MSForeignTextStyle<T = any> extends cocoa.classes._MSForeignTextStyle {
