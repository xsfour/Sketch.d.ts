...
declare namespace cocoa {
  export interface _NSPredicateOperatorUtilities<T = any> extends cocoa.NSObject {}
  namespace classes {
    export interface _NSPredicateOperatorUtilities<T = any> extends cocoa.classes.NSObject {
