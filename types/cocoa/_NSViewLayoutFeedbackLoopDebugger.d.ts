...
declare namespace cocoa {
  export interface _NSViewLayoutFeedbackLoopDebugger<T = any> extends cocoa.NSObject {
    ...
    willSendSetFrame_toLayerOfView<R = void, P0 = cocoa.CGRect, P1 = unknown>(_willSendSetFrame: P0, _toLayerOfView: P1): R;
    willSendSetPosition_toLayerOfView<R = void, P0 = cocoa.CGPoint, P1 = unknown>(_willSendSetPosition: P0, _toLayerOfView: P1): R;
    willSendSetBounds_toLayerOfView<R = void, P0 = cocoa.CGRect, P1 = unknown>(_willSendSetBounds: P0, _toLayerOfView: P1): R;
    ...
    setCurrentLayoutView<R = void, P0 = cocoa.NSView>(_v: P0): R;
  }
  namespace classes {
    export interface _NSViewLayoutFeedbackLoopDebugger<T = any> extends cocoa.classes.NSObject {
