...
declare namespace cocoa {
  export interface MSAlignRightAction<T = any> extends cocoa.MSBaseAlignAction {
    label<R = unknown>(): R;
    alignRight<R = void, P0 = unknown>(_alignRight: P0): R;
  }
  namespace classes {
    export interface MSAlignRightAction<T = any> extends cocoa.classes.MSBaseAlignAction {
