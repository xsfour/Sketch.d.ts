...
declare namespace cocoa {
  export interface _NSJSONWriter<T = any> extends cocoa.NSObject {
    appendString_range<R = number, P0 = unknown, P1 = cocoa._NSRange>(_appendString: P0, _range: P1): R;
  ...
  namespace classes {
    export interface _NSJSONWriter<T = any> extends cocoa.classes.NSObject {
