...
declare namespace cocoa {
  export interface NSOrderedSetChange<T0 = void, T1 = void, T2 = void> extends NSObject {
...
declare const NSOrderedSetChange: cocoa.NSOrderedSetChange.CLASS;
