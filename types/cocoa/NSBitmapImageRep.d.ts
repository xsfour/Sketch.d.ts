...
declare namespace cocoa {
  export interface NSBitmapImageRep<T = any> extends cocoa.NSImageRep, cocoa.NSSecureCodingProtocol {
    ...
    _initWithSharedBitmap_rect<R = unknown, P0 = void, P1 = cocoa.CGRect>(__initWithSharedBitmap: P0, _rect: P1): R;
    _initWithImageSource_imageNumber_properties<R = unknown, P0 = void, P1 = number, P2 = cocoa.__CFDictionary>(__initWithImageSource: P0, _imageNumber: P1, _properties: P2): R;
    ...
    _loadTierTwoInfoWithCGImage<R = void, P0 = cocoa.CGImage>(__loadTierTwoInfoWithCGImage: P0): R;
    _loadTierOneInfoWithCGImage<R = boolean, P0 = cocoa.CGImage>(__loadTierOneInfoWithCGImage: P0): R;
    _loadTierOneInfoWithImageSource_imageNumber_properties<R = boolean, P0 = cocoa.CGImageSource, P1 = number, P2 = cocoa.__CFDictionary>(__loadTierOneInfoWithImageSource: P0, _imageNumber: P1, _properties: P2): R;
    ...
    _performBlockUsingBackingMutableData<R = void, P0 = cocoa.CDUnknownBlockType>(__performBlockUsingBackingMutableData: P0): R;
    _withoutChangingBackingPerformBlockUsingBackingMutableData<R = void, P0 = cocoa.CDUnknownBlockType>(__withoutChangingBackingPerformBlockUsingBackingMutableData: P0): R;
    _fromCGImage_performBlockUsingMutableData<R = void, P0 = cocoa.CGImage, P1 = cocoa.CDUnknownBlockType>(__fromCGImage: P0, _performBlockUsingMutableData: P1): R;
    _captureDrawing<R = void, P0 = cocoa.CDUnknownBlockType>(__captureDrawing: P0): R;
    _performBlockUsingBackingCGImage<R = void, P0 = cocoa.CDUnknownBlockType>(__performBlockUsingBackingCGImage: P0): R;
    _becomeBackedByCGImage<R = void, P0 = cocoa.CGImage>(__becomeBackedByCGImage: P0): R;
    _withoutChangingBackingPerformBlockUsingBackingCGImage<R = void, P0 = cocoa.CDUnknownBlockType>(__withoutChangingBackingPerformBlockUsingBackingCGImage: P0): R;
    _performBlockUsingBacking<R = void, P0 = cocoa.CDUnknownBlockType>(__performBlockUsingBacking: P0): R;
    ...
    _getCGImageRefCreateIfNecessary<R = cocoa.CGImage>(): R;
    _acquireRetainedCGImageRef<R = cocoa.CGImage>(): R;
    _backing<R = unknown>(): R;
    set_backing<R = void, P0 = unknown>(_v: P0): R;
    TIFFRepresentation<R = cocoa.NSData>(): R;
    ...
    bitmapImageRepByCroppingToRect<R = unknown, P0 = cocoa.CGRect>(_bitmapImageRepByCroppingToRect: P0): R;
    bitSafeFastRectForTrimming<R = cocoa.CGRect, P0 = string>(_bitSafeFastRectForTrimming: P0): R;
    rectForTrimming<R = cocoa.CGRect, P0 = string>(_rectForTrimming: P0): R;
  ...
  namespace classes {
    export interface NSBitmapImageRep<T = any> extends cocoa.classes.NSImageRep, cocoa.classes.NSSecureCodingProtocol {
      ...
      withCurrentThreadRespectingOrientation_performBlock<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(_withCurrentThreadRespectingOrientation: P0, _performBlock: P1): R;
      ...
      _imagesWithData_hfsFileType_extension_zone_expandImageContentNow_includeAllReps<R = unknown, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa._NSZone, P4 = boolean, P5 = boolean>(__imagesWithData: P0, _hfsFileType: P1, _extension: P2, _zone: P3, _expandImageContentNow: P4, _includeAllReps: P5): R;
      _imagesWithData_hfsFileType_extension_zone_expandImageContentNow<R = unknown, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa._NSZone, P4 = boolean>(__imagesWithData: P0, _hfsFileType: P1, _extension: P2, _zone: P3, _expandImageContentNow: P4): R;
      ...
      // + NSBitmapImageRep(Alpha,CHBitmapRepAdditions,MSSmallerArchiving):
      bitmapImageRepWithSize_pixelSize_flags_colorSpace_drawingBlock<R = unknown, P0 = cocoa.CGSize, P1 = cocoa.CGSize, P2 = number, P3 = unknown, P4 = cocoa.CDUnknownBlockType>(_bitmapImageRepWithSize: P0, _pixelSize: P1, _flags: P2, _colorSpace: P3, _drawingBlock: P4): R;
      bitmapImageRepWithSize_flags_colorSpace_drawingBlock<R = unknown, P0 = cocoa.CGSize, P1 = number, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(_bitmapImageRepWithSize: P0, _flags: P1, _colorSpace: P2, _drawingBlock: P3): R;
    }
  }
}
