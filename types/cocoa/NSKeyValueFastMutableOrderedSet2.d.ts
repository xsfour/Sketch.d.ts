...
declare namespace cocoa {
  export interface NSKeyValueFastMutableOrderedSet2<T = any> extends cocoa.NSKeyValueFastMutableOrderedSet {
  ...
  namespace classes {
    export interface NSKeyValueFastMutableOrderedSet2<T = any> extends cocoa.classes.NSKeyValueFastMutableOrderedSet {  }
  }
}
