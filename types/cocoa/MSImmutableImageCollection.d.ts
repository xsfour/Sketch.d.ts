...
declare namespace cocoa {
  export interface MSImmutableImageCollection<T = any> extends cocoa._MSImmutableImageCollection {
  ...
  namespace classes {
    export interface MSImmutableImageCollection<T = any> extends cocoa.classes._MSImmutableImageCollection {
