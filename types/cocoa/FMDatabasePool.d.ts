...
declare namespace cocoa {
  export interface FMDatabasePool<T = any> extends cocoa.NSObject {
    ...
    executeLocked<R = void, P0 = cocoa.CDUnknownBlockType>(_executeLocked: P0): R;
    dealloc<R = void>(): R;
  ...
  namespace classes {
    export interface FMDatabasePool<T = any> extends cocoa.classes.NSObject {
