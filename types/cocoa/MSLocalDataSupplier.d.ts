...
declare namespace cocoa {
  export interface MSLocalDataSupplier<T = any> extends cocoa.MSDataSupplier {
    ...
    generateDataForCount_dataApplier<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_generateDataForCount: P0, _dataApplier: P1): R;
    valid<R = boolean>(): R;
    ...
    dataSource<R = cocoa.NSURL>(): R;
    isBuiltin<R = boolean>(): R;
  }
  namespace classes {
    export interface MSLocalDataSupplier<T = any> extends cocoa.classes.MSDataSupplier {
