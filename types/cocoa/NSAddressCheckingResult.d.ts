...
declare namespace cocoa {
  export interface NSAddressCheckingResult<T0 = void, T1 = void, T2 = void> extends NSTextCheckingResult {
    range<R = _NSRange>(): R;
  ...
  namespace NSAddressCheckingResult {
...
declare const NSAddressCheckingResult: cocoa.NSAddressCheckingResult.CLASS;
