...
declare namespace cocoa {
  export interface MSCenterLayersInCanvasAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    centerLayersInCanvas<R = void, P0 = unknown>(_centerLayersInCanvas: P0): R;
    validate<R = boolean>(): R;
  }
  namespace classes {
    export interface MSCenterLayersInCanvasAction<T = any> extends cocoa.classes.MSDocumentAction {
