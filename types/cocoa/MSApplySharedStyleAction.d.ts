...
declare namespace cocoa {
  export interface MSApplySharedStyleAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSApplySharedStyleAction<T = any> extends cocoa.classes.MSDocumentAction {
