...
declare namespace cocoa {
  export interface NSTextAttachment<T = any> {
    ...
    _processAttachmentWithNewContentsOfItem_hanlder<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__processAttachmentWithNewContentsOfItem: P0, _hanlder: P1): R;
