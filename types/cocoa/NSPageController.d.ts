...
declare namespace cocoa {
  export interface NSPageController<T = any> extends NSViewController, NSAnimatablePropertyContainerProtocol, NSCodingProtocol {
    ...
    _frameOfRepresentedObjectFromDelegate_defaultFrame<R = CGRect, P0 = unknown, P1 = CGRect>(__frameOfRepresentedObjectFromDelegate: P0, _defaultFrame: P1): R;
    ...
    _destinationFrameOfSourceTansitionViewForDirection_destinationValid<R = CGRect, P0 = number, P1 = boolean>(__destinationFrameOfSourceTansitionViewForDirection: P0, _destinationValid: P1): R;
    _teardownTransitionHierarchy<R = void>(): R;
    _setupTransitionHierarchyWithSourceView_frame_destinationView_frame_forDirection_destinationValid<R = void, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = CGRect, P4 = number, P5 = boolean>(__setupTransitionHierarchyWithSourceView: P0, _frame: P1, _destinationView: P2, _frame1: P3, _forDirection: P4, _destinationValid: P5): R;
    ...
    _cacheViewController_withSize_toCompletionHandler<R = void, P0 = unknown, P1 = CGSize, P2 = CDUnknownBlockType>(__cacheViewController: P0, _withSize: P1, _toCompletionHandler: P2): R;
    _snapshotOfViewController_withSize<R = unknown, P0 = unknown, P1 = CGSize>(__snapshotOfViewController: P0, _withSize: P1): R;
    ...
    _animateImage_frame_toImage_frame_direction<R = void, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = CGRect, P4 = number>(__animateImage: P0, _frame: P1, _toImage: P2, _frame1: P3, _direction: P4): R;
    _animateView_frame_toView_frame_direction<R = void, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = CGRect, P4 = number>(__animateView: P0, _frame: P1, _toView: P2, _frame1: P3, _direction: P4): R;
    _performAnimationWithDirection_destinationFrame<R = void, P0 = number, P1 = CGRect>(__performAnimationWithDirection: P0, _destinationFrame: P1): R;
    ...
    currentIdentifier<R = NSString>(): R;
    setCurrentIdentifier<R = void, P0 = NSString>(_v: P0): R;
    selectedViewController<R = NSViewController>(): R;
    setSelectedViewController<R = void, P0 = NSViewController>(_v: P0): R;
    ...
    delegate<R = NSPageControllerDelegate>(): R;
    setDelegate<R = void, P0 = NSPageControllerDelegate>(_v: P0): R;
    arrangedObjects<R = NSArray>(): R;
    setArrangedObjects<R = void, P0 = NSArray>(_v: P0): R;
