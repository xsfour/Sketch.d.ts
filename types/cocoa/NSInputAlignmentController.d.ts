...
declare namespace cocoa {
  export interface NSInputAlignmentController<T = any> extends cocoa.NSObject {
    ...
    delegate<R = cocoa.NSInputAlignmentControllerDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSInputAlignmentControllerDelegate>(_v: P0): R;
  }
  namespace classes {
    export interface NSInputAlignmentController<T = any> extends cocoa.classes.NSObject {
      alloc<R = NSInputAlignmentController>(): R;
      new: <R = NSInputAlignmentController>() => R;
      alignmentDeltaFromMatches<R = cocoa.CGPoint, P0 = unknown>(_alignmentDeltaFromMatches: P0): R;
    }
  }
}
