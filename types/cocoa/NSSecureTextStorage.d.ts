...
declare namespace cocoa {
  export interface NSSecureTextStorage<T = any> extends cocoa.NSTextStorage {
    ...
    lineBreakByHyphenatingBeforeIndex_withinRange<R = number, P0 = number, P1 = cocoa._NSRange>(_lineBreakByHyphenatingBeforeIndex: P0, _withinRange: P1): R;
    lineBreakBeforeIndex_withinRange<R = number, P0 = number, P1 = cocoa._NSRange>(_lineBreakBeforeIndex: P0, _withinRange: P1): R;
  ...
  namespace classes {
    export interface NSSecureTextStorage<T = any> extends cocoa.classes.NSTextStorage {
      initialize<R = void>(): R;
    }
  }
}
