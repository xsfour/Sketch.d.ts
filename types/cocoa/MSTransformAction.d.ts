...
declare namespace cocoa {
  export interface MSTransformAction<T = any> extends cocoa.MSEventHandlerAction {
    label<R = unknown>(): R;
    tooltip<R = unknown>(): R;
    transform<R = void, P0 = unknown>(_transform: P0): R;
  }
  namespace classes {
    export interface MSTransformAction<T = any> extends cocoa.classes.MSEventHandlerAction {
