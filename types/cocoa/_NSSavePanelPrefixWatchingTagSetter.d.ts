...
declare namespace cocoa {
  export interface _NSSavePanelPrefixWatchingTagSetter<T = any> extends cocoa._NSSavePanelTagSetter {
  ...
  namespace classes {
    export interface _NSSavePanelPrefixWatchingTagSetter<T = any> extends cocoa.classes._NSSavePanelTagSetter {
