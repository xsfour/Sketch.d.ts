...
declare namespace cocoa {
  export interface MSDistributeAction<T = any> extends cocoa.MSDocumentAction {
  ...
  namespace classes {
    export interface MSDistributeAction<T = any> extends cocoa.classes.MSDocumentAction {
