...
declare namespace cocoa {
  export interface MSLayerRendererCG<T = any> extends cocoa.NSObject, cocoa.MSLayerRendererProtocol {
  ...
  namespace classes {
    export interface MSLayerRendererCG<T = any> extends cocoa.classes.NSObject, cocoa.classes.MSLayerRendererProtocol {
...
declare const MSLayerRendererCG: cocoa.classes.MSLayerRendererCG;
