...
declare namespace cocoa {
  export interface NSPersonNameComponentsFormatter<T = any> extends cocoa.NSFormatter, cocoa.NSObservableProtocol, cocoa.NSObserverProtocol, cocoa.NSSecureCodingProtocol, cocoa.NSCopyingProtocol {
    ...
    _locale<R = cocoa.NSLocale>(): R;
    set_locale<R = void, P0 = cocoa.NSLocale>(_v: P0): R;
  ...
  namespace classes {
    export interface NSPersonNameComponentsFormatter<T = any> extends cocoa.classes.NSFormatter, cocoa.classes.NSObservableProtocol, cocoa.classes.NSObserverProtocol, cocoa.classes.NSSecureCodingProtocol, cocoa.classes.NSCopyingProtocol {
      ...
      arabicInitialsCreator<R = cocoa.CDUnknownBlockType>(): R;
      tibetanInitialsCreator<R = cocoa.CDUnknownBlockType>(): R;
      thaiInitialsCreator<R = cocoa.CDUnknownBlockType>(): R;
      westernInitialsCreator<R = cocoa.CDUnknownBlockType>(): R;
      ...
      __contents_exclusivelyInCharacterSet<R = boolean, P0 = unknown, P1 = cocoa.USet>(___contents: P0, _exclusivelyInCharacterSet: P1): R;
      __getCharacterSetWithPattern<R = cocoa.USet, P0 = unknown>(___getCharacterSetWithPattern: P0): R;
      ...
      forEachExistingComponentWithComponents_performBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_forEachExistingComponentWithComponents: P0, _performBlock: P1): R;
