...
declare namespace cocoa {
  export interface _NSViewAnimator_NSStackView<T = any> extends cocoa._NSViewAnimator {
    ...
    setEdgeInsets<R = void, P0 = cocoa.NSEdgeInsets>(_setEdgeInsets: P0): R;
  ...
  namespace classes {
    export interface _NSViewAnimator_NSStackView<T = any> extends cocoa.classes._NSViewAnimator {  }
  }
}
