...
declare namespace cocoa {
  export interface NSDrawer<T = any> extends cocoa.NSResponder, cocoa.NSAccessibilityElementProtocol, cocoa.NSAccessibilityProtocol {
    ...
    initWithContentSize_preferredEdge<R = unknown, P0 = cocoa.CGSize, P1 = number>(_initWithContentSize: P0, _preferredEdge: P1): R;
    ...
    _resizeWithDelta_fromFrame_beginOperation_endOperation<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGRect, P2 = boolean, P3 = boolean>(__resizeWithDelta: P0, _fromFrame: P1, _beginOperation: P2, _endOperation: P3): R;
    _slideWithDelta_beginOperation_endOperation<R = void, P0 = cocoa.CGPoint, P1 = boolean, P2 = boolean>(__slideWithDelta: P0, _beginOperation: P1, _endOperation: P2): R;
    _minParentWindowContentSize<R = cocoa.CGSize>(): R;
    _takeFocus<R = void>(): R;
    _changeFirstResponderToParentsFirstResponder<R = void>(): R;
    _changeMainState<R = void>(): R;
    _changeKeyState<R = void>(): R;
    _sizeWithRect<R = void, P0 = cocoa.CGRect>(__sizeWithRect: P0): R;
    _size<R = void>(): R;
    _position<R = void>(): R;
    ...
    _edge<R = number>(): R;
    _initWithContentSize_preferredEdge<R = unknown, P0 = cocoa.CGSize, P1 = number>(__initWithContentSize: P0, _preferredEdge: P1): R;
    ...
    _doResizeDrawerWithDelta_fromFrame<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGRect>(__doResizeDrawerWithDelta: P0, _fromFrame: P1): R;
    _doSlideDrawerWithDelta<R = void, P0 = cocoa.CGPoint>(__doSlideDrawerWithDelta: P0): R;
    _doPositionDrawerAndSize_parentFrame_stashSize<R = void, P0 = cocoa.CGSize, P1 = cocoa.CGRect, P2 = boolean>(__doPositionDrawerAndSize: P0, _parentFrame: P1, _stashSize: P2): R;
    _doPositionDrawerAndSize_parentFrame<R = void, P0 = cocoa.CGSize, P1 = cocoa.CGRect>(__doPositionDrawerAndSize: P0, _parentFrame: P1): R;
    ...
    delegate<R = cocoa.NSDrawerDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSDrawerDelegate>(_v: P0): R;
    ...
    maxContentSize<R = cocoa.CGSize>(): R;
    setMaxContentSize<R = void, P0 = cocoa.CGSize>(_v: P0): R;
    minContentSize<R = cocoa.CGSize>(): R;
    setMinContentSize<R = void, P0 = cocoa.CGSize>(_v: P0): R;
  ...
  namespace classes {
    export interface NSDrawer<T = any> extends cocoa.classes.NSResponder, cocoa.classes.NSAccessibilityElementProtocol, cocoa.classes.NSAccessibilityProtocol {
      alloc<R = NSDrawer>(): R;
      new: <R = NSDrawer>() => R;
