...
declare namespace cocoa {
  export interface MSBaseShapeAction<T = any> extends cocoa.MSBaseInsertAction {
  ...
  namespace classes {
    export interface MSBaseShapeAction<T = any> extends cocoa.classes.MSBaseInsertAction {
