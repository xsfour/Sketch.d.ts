...
declare namespace cocoa {
  export interface NSTableViewListCellProxy<T = any> extends cocoa.NSTableViewCellProxy {
  ...
  namespace classes {
    export interface NSTableViewListCellProxy<T = any> extends cocoa.classes.NSTableViewCellProxy {
