...
declare namespace cocoa {
  export interface NSArrayDetailBinder<T = any> extends cocoa.NSObjectDetailBinder {
  ...
  namespace classes {
    export interface NSArrayDetailBinder<T = any> extends cocoa.classes.NSObjectDetailBinder {
