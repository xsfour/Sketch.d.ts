...
declare namespace cocoa {
  export interface MSLayerPaster<T = any> extends cocoa.NSObject {
    ...
    rightmostArtboardOnPage_intersectingRect<R = unknown, P0 = unknown, P1 = cocoa.CGRect>(_rightmostArtboardOnPage: P0, _intersectingRect: P1): R;
    findFirstAvailablePositionForSize_nextToArtboardsOnPage_inAllowedRect<R = cocoa.CGPoint, P0 = cocoa.CGSize, P1 = unknown, P2 = cocoa.CGRect>(_findFirstAvailablePositionForSize: P0, _nextToArtboardsOnPage: P1, _inAllowedRect: P2): R;
    wouldArtboardWithRect_intersectOtherArtboardsOnPage<R = boolean, P0 = cocoa.CGRect, P1 = unknown>(_wouldArtboardWithRect: P0, _intersectOtherArtboardsOnPage: P1): R;
    ...
    setCombinedOrigin_forLayers<R = void, P0 = cocoa.CGPoint, P1 = unknown>(_setCombinedOrigin: P0, _forLayers: P1): R;
    ...
    insertPasteboardDataIntoParent_atPosition_afterLayer_viewport_fitToParent<R = unknown, P0 = unknown, P1 = cocoa.CGPoint, P2 = unknown, P3 = unknown, P4 = boolean>(_insertPasteboardDataIntoParent: P0, _atPosition: P1, _afterLayer: P2, _viewport: P3, _fitToParent: P4): R;
    ...
    centerSize_inAllowedRect<R = cocoa.CGRect, P0 = cocoa.CGSize, P1 = cocoa.CGRect>(_centerSize: P0, _inAllowedRect: P1): R;
    allowedRectForViewport_root<R = cocoa.CGRect, P0 = unknown, P1 = unknown>(_allowedRectForViewport: P0, _root: P1): R;
    rectByMaintainingOriginalPositionInRoot<R = cocoa.CGRect, P0 = unknown>(_rectByMaintainingOriginalPositionInRoot: P0): R;
    targetRectForPasteboardDataInViewPort_root_canMoveViewport<R = cocoa.CGRect, P0 = unknown, P1 = unknown, P2 = string>(_targetRectForPasteboardDataInViewPort: P0, _root: P1, _canMoveViewport: P2): R;
    ...
    pasteboardLayers<R = cocoa.MSPasteboardLayers>(): R;
    insertedSymbolMasters<R = cocoa.NSMutableArray>(): R;
    objectIDMap<R = cocoa.NSMutableDictionary>(): R;
  }
  namespace classes {
    export interface MSLayerPaster<T = any> extends cocoa.classes.NSObject {
      ...
      insertPasteboardData_intoParent_atPosition_afterLayer_viewport_fitToParent<R = unknown, P0 = unknown, P1 = unknown, P2 = cocoa.CGPoint, P3 = unknown, P4 = unknown, P5 = boolean>(_insertPasteboardData: P0, _intoParent: P1, _atPosition: P2, _afterLayer: P3, _viewport: P4, _fitToParent: P5): R;
