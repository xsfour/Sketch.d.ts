...
declare namespace cocoa {
  export interface NSKeyValueUnnestedProperty<T0 = void, T1 = void, T2 = void> extends NSKeyValueProperty {
    ...
    _initWithContainerClass_key_propertiesBeingInitialized<R = unknown, P0 = unknown, P1 = unknown, P2 = __CFSet>(__initWithContainerClass: P0, _key: P1, _propertiesBeingInitialized: P2): R;
  }
  namespace NSKeyValueUnnestedProperty {
...
declare const NSKeyValueUnnestedProperty: cocoa.NSKeyValueUnnestedProperty.CLASS;
