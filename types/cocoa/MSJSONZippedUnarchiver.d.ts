...
declare namespace cocoa {
  export interface MSJSONZippedUnarchiver<T = any> extends cocoa.MSJSONUnarchiver {
    ...
    zipDecoder<R = cocoa.BCJSONZippedDecoder>(): R;
    setZipDecoder<R = void, P0 = cocoa.BCJSONZippedDecoder>(_v: P0): R;
  }
  namespace classes {
    export interface MSJSONZippedUnarchiver<T = any> extends cocoa.classes.MSJSONUnarchiver {
