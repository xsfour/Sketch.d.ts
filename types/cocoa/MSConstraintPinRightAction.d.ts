...
declare namespace cocoa {
  export interface MSConstraintPinRightAction<T = any> extends cocoa.MSConstraintAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSConstraintPinRightAction<T = any> extends cocoa.classes.MSConstraintAction {
