...
declare namespace cocoa {
  export interface NSMatrix<T = any> extends cocoa.NSControl, cocoa.NSUserInterfaceValidationsProtocol, cocoa.NSViewToolTipOwnerProtocol {
    ...
    _sendDoubleActionToCellAt<R = void, P0 = cocoa.CGPoint>(__sendDoubleActionToCellAt: P0): R;
    ...
    _selectRowRange<R = unknown, P0 = cocoa._SelectionAnchor>(__selectRowRange: P0): R;
    _selectRectRange<R = unknown, P0 = cocoa._SelectionAnchor>(__selectRectRange: P0): R;
    _selectRange_oldArea_lit_includeX<R = unknown, P0 = cocoa._SelectionAnchor, P1 = cocoa._SelectionAnchor, P2 = boolean, P3 = boolean>(__selectRange: P0, _oldArea: P1, _lit: P2, _includeX: P3): R;
    _setSelectionRange<R = unknown, P0 = cocoa._SelectionAnchor>(__setSelectionRange: P0): R;
    ...
    _acceptableRowAboveRow_tryBelowPoint<R = number, P0 = number, P1 = cocoa.CGPoint>(__acceptableRowAboveRow: P0, _tryBelowPoint: P1): R;
    _acceptableRowBelowRow_tryAbovePoint<R = number, P0 = number, P1 = cocoa.CGPoint>(__acceptableRowBelowRow: P0, _tryAbovePoint: P1): R;
    _acceptableRowAboveKeyInVisibleRect<R = number, P0 = cocoa.CGRect>(__acceptableRowAboveKeyInVisibleRect: P0): R;
    _acceptableRowBelowKeyInVisibleRect<R = number, P0 = cocoa.CGRect>(__acceptableRowBelowKeyInVisibleRect: P0): R;
    ...
    _radioHit_row_col<R = boolean, P0 = cocoa.CGPoint, P1 = number, P2 = number>(__radioHit: P0, _row: P1, _col: P2): R;
    _loopHit_row_col<R = boolean, P0 = cocoa.CGPoint, P1 = number, P2 = number>(__loopHit: P0, _row: P1, _col: P2): R;
    _mouseHit_row_col<R = boolean, P0 = cocoa.CGPoint, P1 = number, P2 = number>(__mouseHit: P0, _row: P1, _col: P2): R;
    ...
    _drawCellAtRow_column_inFrame<R = void, P0 = number, P1 = number, P2 = cocoa.CGRect>(__drawCellAtRow: P0, _column: P1, _inFrame: P2): R;
    _getRowRange_andColumnRange_intersectingRect<R = void, P0 = cocoa._NSRange, P1 = cocoa._NSRange, P2 = cocoa.CGRect>(__getRowRange: P0, _andColumnRange: P1, _intersectingRect: P2): R;
    ...
    _getVisibleRowRange_columnRange<R = void, P0 = cocoa._NSRange, P1 = cocoa._NSRange>(__getVisibleRowRange: P0, _columnRange: P1): R;
    ...
    _getRow_column_nearPoint<R = void, P0 = number, P1 = number, P2 = cocoa.CGPoint>(__getRow: P0, _column: P1, _nearPoint: P2): R;
    ...
    _getRow_andCol_ofCell_atRect<R = boolean, P0 = number, P1 = number, P2 = unknown, P3 = cocoa.CGRect>(__getRow: P0, _andCol: P1, _ofCell: P2, _atRect: P3): R;
    _getDrawingRow_andCol<R = unknown, P0 = number, P1 = number>(__getDrawingRow: P0, _andCol: P1): R;
    _boundsRectOccupiedByCells<R = cocoa.CGRect>(): R;
    cellFrameAtRow_column<R = cocoa.CGRect, P0 = number, P1 = number>(_cellFrameAtRow: P0, _column: P1): R;
    ...
    initWithFrame_mode_cellClass_numberOfRows_numberOfColumns<R = unknown, P0 = cocoa.CGRect, P1 = number, P2 = unknown, P3 = number, P4 = number>(_initWithFrame: P0, _mode: P1, _cellClass: P2, _numberOfRows: P3, _numberOfColumns: P4): R;
    initWithFrame_mode_prototype_numberOfRows_numberOfColumns<R = unknown, P0 = cocoa.CGRect, P1 = number, P2 = unknown, P3 = number, P4 = number>(_initWithFrame: P0, _mode: P1, _prototype: P2, _numberOfRows: P3, _numberOfColumns: P4): R;
    ...
    delegate<R = cocoa.NSMatrixDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSMatrixDelegate>(_v: P0): R;
    ...
    cellBackgroundColor<R = cocoa.NSColor>(): R;
    setCellBackgroundColor<R = void, P0 = cocoa.NSColor>(_v: P0): R;
    ...
    setCellSize<R = void, P0 = cocoa.CGSize>(_v: P0): R;
    ...
    selectedCell<R = cocoa.NSCell>(): R;
    cells<R = cocoa.NSArray>(): R;
    allowsEmptySelection<R = boolean>(): R;
    setAllowsEmptySelection<R = void, P0 = boolean>(_v: P0): R;
    mode<R = number>(): R;
    setMode<R = void, P0 = number>(_v: P0): R;
    prototype<R = cocoa.NSCell>(): R;
    setPrototype<R = void, P0 = cocoa.NSCell>(_v: P0): R;
  ...
  namespace classes {
    export interface NSMatrix<T = any> extends cocoa.classes.NSControl, cocoa.classes.NSUserInterfaceValidationsProtocol, cocoa.classes.NSViewToolTipOwnerProtocol {
      alloc<R = NSMatrix>(): R;
      new: <R = NSMatrix>() => R;
