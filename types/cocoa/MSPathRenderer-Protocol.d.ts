...
declare namespace cocoa {
  export interface MSPathRendererProtocol<T = any> extends MSRendererProtocol {
    renderBordersForPath_style_rect_context<R = void, P0 = MSPath, P1 = MSImmutableStyle, P2 = CGRect, P3 = MSRenderingContext>(_renderBordersForPath: P0, _style: P1, _rect: P2, _context: P3): R;
