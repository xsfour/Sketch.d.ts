...
declare namespace cocoa {
  export interface NSURLConnectionDelegateProxy<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface NSURLConnectionDelegateProxy<T = any> extends cocoa.classes.NSObject {
...
declare const NSURLConnectionDelegateProxy: cocoa.classes.NSURLConnectionDelegateProxy;
