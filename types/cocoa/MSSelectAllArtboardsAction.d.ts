...
declare namespace cocoa {
  export interface MSSelectAllArtboardsAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    selectAllArtboards<R = void, P0 = unknown>(_selectAllArtboards: P0): R;
  }
  namespace classes {
    export interface MSSelectAllArtboardsAction<T = any> extends cocoa.classes.MSDocumentAction {
