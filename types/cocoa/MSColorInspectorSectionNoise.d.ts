...
declare namespace cocoa {
  export interface MSColorInspectorSectionNoise<T = any> extends cocoa.MSColorInspectorSection {
    refreshNoiseIntensityTouchBarSlider<R = void>(): R;
    adjustNoiseIntensity<R = void, P0 = unknown>(_adjustNoiseIntensity: P0): R;
  }
  namespace classes {
    export interface MSColorInspectorSectionNoise<T = any> extends cocoa.classes.MSColorInspectorSection {
