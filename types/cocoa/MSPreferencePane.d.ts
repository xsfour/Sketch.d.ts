...
declare namespace cocoa {
  export interface MSPreferencePane<T = any> extends cocoa.NSViewController {
    ...
    preferencesController<R = cocoa.MSPreferencesController>(): R;
  }
  namespace classes {
    export interface MSPreferencePane<T = any> extends cocoa.classes.NSViewController {
