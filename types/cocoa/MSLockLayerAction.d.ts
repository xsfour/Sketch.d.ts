...
declare namespace cocoa {
  export interface MSLockLayerAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSLockLayerAction<T = any> extends cocoa.classes.MSDocumentAction {
