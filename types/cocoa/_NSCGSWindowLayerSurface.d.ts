...
declare namespace cocoa {
  export interface _NSCGSWindowLayerSurface<T = any> extends cocoa.NSCGSWindowLayerSurface {
  ...
  namespace classes {
    export interface _NSCGSWindowLayerSurface<T = any> extends cocoa.classes.NSCGSWindowLayerSurface {
