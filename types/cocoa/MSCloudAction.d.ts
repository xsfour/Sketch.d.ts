...
declare namespace cocoa {
  export interface MSCloudAction<T = any> extends cocoa.MSPopoverAction, cocoa.MSCloudShareUploadControllerDelegateProtocol {
    ...
    prepareCloseWithHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_prepareCloseWithHandler: P0): R;
    ...
    refreshShareWithHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_refreshShareWithHandler: P0): R;
    startUploadUpdating_ownedByOrganization<R = void, P0 = unknown, P1 = unknown>(_startUploadUpdating: P0, _ownedByOrganization: P1): R;
    closeAlertUploadDidFinishHandler<R = cocoa.CDUnknownBlockType>(): R;
    setCloseAlertUploadDidFinishHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_v: P0): R;
    refreshOperation<R = cocoa.SCKAPIOperation>(): R;
    setRefreshOperation<R = void, P0 = cocoa.SCKAPIOperation>(_v: P0): R;
    upload<R = cocoa.MSCloudShareUploadController>(): R;
    setUpload<R = void, P0 = cocoa.MSCloudShareUploadController>(_v: P0): R;
    ...
    progressImages<R = cocoa.NSArray>(): R;
    exportedDocument<R = cocoa.MSCloudExportableDocument>(): R;
  ...
  namespace classes {
    export interface MSCloudAction<T = any> extends cocoa.classes.MSPopoverAction, cocoa.classes.MSCloudShareUploadControllerDelegateProtocol {
      alloc<R = MSCloudAction>(): R;
      new: <R = MSCloudAction>() => R;
      prepareClosingActions_withHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_prepareClosingActions: P0, _withHandler: P1): R;
      prepareTerminationWithHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_prepareTerminationWithHandler: P0): R;
