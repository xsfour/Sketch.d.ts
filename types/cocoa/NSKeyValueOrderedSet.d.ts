...
declare namespace cocoa {
  export interface NSKeyValueOrderedSet<T = any> extends cocoa.NSOrderedSet, cocoa.NSKeyValueProxyCachingProtocol {
  ...
  namespace classes {
    export interface NSKeyValueOrderedSet<T = any> extends cocoa.classes.NSOrderedSet, cocoa.classes.NSKeyValueProxyCachingProtocol {  }
  }
}
