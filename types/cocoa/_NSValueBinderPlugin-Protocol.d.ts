...
declare namespace cocoa {
  export interface _NSValueBinderPluginProtocol<T = any> extends cocoa._NSEditorBinderPluginProtocol {
    applyObjectValue_forBinding_operation_needToRunAlert_error<R = boolean, P0 = unknown, P1 = cocoa.NSString, P2 = number, P3 = string, P4 = unknown>(_applyObjectValue: P0, _forBinding: P1, _operation: P2, _needToRunAlert: P3, _error: P4): R;
    ...
    formatterOfObject<R = cocoa.NSFormatter, P0 = unknown>(_formatterOfObject: P0): R;
    ...
    editingBinderForControl<R = cocoa.NSValueBinder, P0 = cocoa.NSControl>(_editingBinderForControl: P0): R;
    ...
    _actionHasBegun_atIndexPath<R = void, P0 = unknown, P1 = cocoa.NSIndexPath>(__actionHasBegun: P0, _atIndexPath: P1): R;
    ...
    editedMode_forEditingOrAction<R = cocoa.__NSKeyValueCodingControllerModeType, P0 = unknown, P1 = boolean>(_editedMode: P0, _forEditingOrAction: P1): R;
    needsDelegate<R = boolean>(): R;
    valueClass_forBinding<R = unknown, P0 = unknown, P1 = cocoa.NSString>(_valueClass: P0, _forBinding: P1): R;
  ...
  namespace classes {
    export interface _NSValueBinderPluginProtocol<T = any> extends cocoa.classes._NSEditorBinderPluginProtocol {  }
  }
}
