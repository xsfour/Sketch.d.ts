...
declare namespace cocoa {
  export interface NSKeyValueSlowMutableOrderedSet<T = any> extends cocoa.NSKeyValueMutableOrderedSet {
    ...
    _createNonNilMutableOrderedSetValueWithSelector<R = unknown, P0 = string>(__createNonNilMutableOrderedSetValueWithSelector: P0): R;
  ...
  namespace classes {
    export interface NSKeyValueSlowMutableOrderedSet<T = any> extends cocoa.classes.NSKeyValueMutableOrderedSet {  }
  }
}

declare const NSKeyValueSlowMutableOrderedSet: cocoa.classes.NSKeyValueSlowMutableOrderedSet;
