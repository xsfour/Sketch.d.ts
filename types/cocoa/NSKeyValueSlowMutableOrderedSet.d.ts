...
declare namespace cocoa {
  export interface NSKeyValueSlowMutableOrderedSet<T0 = void, T1 = void, T2 = void> extends NSKeyValueMutableOrderedSet {
  ...
  namespace NSKeyValueSlowMutableOrderedSet {
    export interface CLASS<T0 = void, T1 = void, T2 = void> extends NSKeyValueMutableOrderedSet {}
  }
}

declare const NSKeyValueSlowMutableOrderedSet: cocoa.NSKeyValueSlowMutableOrderedSet.CLASS;
