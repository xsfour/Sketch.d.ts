...
declare namespace cocoa {
  export interface NSConcreteOrderedSetChange<T = any> extends cocoa.NSOrderedSetChange {
    value<R = unknown>(): R;
  ...
  namespace classes {
    export interface NSConcreteOrderedSetChange<T = any> extends cocoa.classes.NSOrderedSetChange {
