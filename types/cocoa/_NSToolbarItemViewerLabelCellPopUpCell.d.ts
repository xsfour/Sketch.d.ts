...
declare namespace cocoa {
  export interface _NSToolbarItemViewerLabelCellPopUpCell<T = any> extends cocoa.NSPopUpButtonCell {
    indexOfSelectedItem<R = number>(): R;
    _setTextShadow<R = void, P0 = boolean>(__setTextShadow: P0): R;
    _drawRealTitleWithFrame_inView<R = void, P0 = cocoa.CGRect, P1 = unknown>(__drawRealTitleWithFrame: P0, _inView: P1): R;
  ...
  namespace classes {
    export interface _NSToolbarItemViewerLabelCellPopUpCell<T = any> extends cocoa.classes.NSPopUpButtonCell {
