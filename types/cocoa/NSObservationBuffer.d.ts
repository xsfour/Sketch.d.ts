...
declare namespace cocoa {
  export interface NSObservationBuffer<T = any> extends cocoa.NSObservationTransformer {
    ...
    setBufferFullHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_v: P0): R;
    memoryPressureSensitive<R = boolean>(): R;
    setMemoryPressureSensitive<R = void, P0 = boolean>(_v: P0): R;
  }
  namespace classes {
    export interface NSObservationBuffer<T = any> extends cocoa.classes.NSObservationTransformer {
