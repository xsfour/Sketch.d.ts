...
declare namespace cocoa {
  export interface MSExportSelectionWithExportFormatsAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    exportSelection<R = void, P0 = unknown>(_exportSelection: P0): R;
  }
  namespace classes {
    export interface MSExportSelectionWithExportFormatsAction<T = any> extends cocoa.classes.MSDocumentAction {
