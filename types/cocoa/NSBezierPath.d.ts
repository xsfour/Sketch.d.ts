...
declare namespace cocoa {
  export interface NSBezierPath<T = any> extends cocoa.NSObject, cocoa.NSCopyingProtocol, cocoa.NSSecureCodingProtocol {
    initWithCoder<R = unknown, P0 = unknown>(_initWithCoder: P0): R;
    encodeWithCoder<R = void, P0 = unknown>(_encodeWithCoder: P0): R;
    containsPoint<R = boolean, P0 = cocoa.CGPoint>(_containsPoint: P0): R;
    appendBezierPathWithRoundedRect_xRadius_yRadius<R = void, P0 = cocoa.CGRect, P1 = number, P2 = number>(_appendBezierPathWithRoundedRect: P0, _xRadius: P1, _yRadius: P2): R;
    ...
    appendBezierPathWithNativeGlyphs_advances_count_inFont<R = void, P0 = number, P1 = cocoa.CGSize, P2 = number, P3 = unknown>(_appendBezierPathWithNativeGlyphs: P0, _advances: P1, _count: P2, _inFont: P3): R;
    appendBezierPathWithArcFromPoint_toPoint_radius<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = number>(_appendBezierPathWithArcFromPoint: P0, _toPoint: P1, _radius: P2): R;
    appendBezierPathWithArcWithCenter_radius_startAngle_endAngle<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number, P3 = number>(_appendBezierPathWithArcWithCenter: P0, _radius: P1, _startAngle: P2, _endAngle: P3): R;
    appendBezierPathWithArcWithCenter_radius_startAngle_endAngle_clockwise<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number, P3 = number, P4 = boolean>(_appendBezierPathWithArcWithCenter: P0, _radius: P1, _startAngle: P2, _endAngle: P3, _clockwise: P4): R;
    _appendArcSegmentWithCenter_radius_angle1_angle2<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number, P3 = number>(__appendArcSegmentWithCenter: P0, _radius: P1, _angle1: P2, _angle2: P3): R;
    appendBezierPathWithOvalInRect<R = void, P0 = cocoa.CGRect>(_appendBezierPathWithOvalInRect: P0): R;
    appendBezierPathWithPoints_count<R = void, P0 = cocoa.CGPoint, P1 = number>(_appendBezierPathWithPoints: P0, _count: P1): R;
    appendBezierPathWithRect<R = void, P0 = cocoa.CGRect>(_appendBezierPathWithRect: P0): R;
    appendBezierPath<R = void, P0 = unknown>(_appendBezierPath: P0): R;
    _appendToPath<R = void, P0 = unknown>(__appendToPath: P0): R;
    setAssociatedPoints_atIndex<R = void, P0 = cocoa.CGPoint, P1 = number>(_setAssociatedPoints: P0, _atIndex: P1): R;
    elementAtIndex_associatedPoints<R = number, P0 = number, P1 = cocoa.CGPoint>(_elementAtIndex: P0, _associatedPoints: P1): R;
    ...
    subdivideBezierWithFlatness_startPoint_controlPoint1_controlPoint2_endPoint<R = void, P0 = number, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint, P4 = cocoa.CGPoint>(_subdivideBezierWithFlatness: P0, _startPoint: P1, _controlPoint1: P2, _controlPoint2: P3, _endPoint: P4): R;
    setClip<R = void>(): R;
    addClip<R = void>(): R;
    fill<R = void>(): R;
    stroke<R = void>(): R;
    ...
    relativeCurveToPoint_controlPoint1_controlPoint2<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint>(_relativeCurveToPoint: P0, _controlPoint1: P1, _controlPoint2: P2): R;
    relativeLineToPoint<R = void, P0 = cocoa.CGPoint>(_relativeLineToPoint: P0): R;
    relativeMoveToPoint<R = void, P0 = cocoa.CGPoint>(_relativeMoveToPoint: P0): R;
    removeAllPoints<R = void>(): R;
    closePath<R = void>(): R;
    curveToPoint_controlPoint1_controlPoint2<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint>(_curveToPoint: P0, _controlPoint1: P1, _controlPoint2: P2): R;
    lineToPoint<R = void, P0 = cocoa.CGPoint>(_lineToPoint: P0): R;
    moveToPoint<R = void, P0 = cocoa.CGPoint>(_moveToPoint: P0): R;
    dealloc<R = void>(): R;
    ...
    _deviceCurveToPoint_controlPoint1_controlPoint2<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint>(__deviceCurveToPoint: P0, _controlPoint1: P1, _controlPoint2: P2): R;
    _deviceLineToPoint<R = void, P0 = cocoa.CGPoint>(__deviceLineToPoint: P0): R;
    _deviceMoveToPoint<R = void, P0 = cocoa.CGPoint>(__deviceMoveToPoint: P0): R;
    _addPathSegment_point<R = void, P0 = number, P1 = cocoa.CGPoint>(__addPathSegment: P0, _point: P1): R;
    ...
    _appendBezierPathWithRoundRect_cornerRadius<R = void, P0 = cocoa.CGRect, P1 = number>(__appendBezierPathWithRoundRect: P0, _cornerRadius: P1): R;
    _appendBezierPathWithBottomRoundRect_cornerRadius<R = void, P0 = cocoa.CGRect, P1 = number>(__appendBezierPathWithBottomRoundRect: P0, _cornerRadius: P1): R;
    _appendBezierPathWithTopRoundRect_cornerRadius<R = void, P0 = cocoa.CGRect, P1 = number>(__appendBezierPathWithTopRoundRect: P0, _cornerRadius: P1): R;
    elementCount<R = number>(): R;
    bounds<R = cocoa.CGRect>(): R;
    controlPointBounds<R = cocoa.CGRect>(): R;
    currentPoint<R = cocoa.CGPoint>(): R;
    empty<R = boolean>(): R;
    bezierPathByReversingPath<R = cocoa.NSBezierPath>(): R;
    bezierPathByFlatteningPath<R = cocoa.NSBezierPath>(): R;
    flatness<R = number>(): R;
    ...
    mutableCGPathCopy<R = cocoa.CGPath>(): R;
    createCGPath_bc<R = cocoa.CGPath>(): R;
    outlinePath<R = unknown>(): R;
    clipInBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_clipInBlock: P0): R;
    ...
    appendArrowAtPoint_ms_tangent_size_scale<R = void, P0 = cocoa.CGPoint, P1 = cocoa.MSLine, P2 = number, P3 = number>(_appendArrowAtPoint_ms: P0, _tangent: P1, _size: P2, _scale: P3): R;
    appendCircleAtPoint_ms_radius_scale<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number>(_appendCircleAtPoint_ms: P0, _radius: P1, _scale: P2): R;
    appendSquareAtPoint_ms_size_scale<R = void, P0 = cocoa.CGPoint, P1 = number, P2 = number>(_appendSquareAtPoint_ms: P0, _size: P1, _scale: P2): R;
    debugScale_ms<R = number>(): R;
    fb_appendElement<R = void, P0 = cocoa.NSBezierElement>(_fb_appendElement: P0): R;
    fb_appendPath<R = void, P0 = unknown>(_fb_appendPath: P0): R;
    fb_copyAttributesFrom<R = void, P0 = unknown>(_fb_copyAttributesFrom: P0): R;
    fb_subpathWithRange<R = unknown, P0 = cocoa._NSRange>(_fb_subpathWithRange: P0): R;
    fb_elementAtIndex<R = cocoa.NSBezierElement, P0 = number>(_fb_elementAtIndex: P0): R;
    fb_pointAtIndex<R = cocoa.CGPoint, P0 = number>(_fb_pointAtIndex: P0): R;
    fb_fitCurve<R = unknown, P0 = number>(_fb_fitCurve: P0): R;
    fb_computeCenterTangentAtIndex<R = cocoa.CGPoint, P0 = number>(_fb_computeCenterTangentAtIndex: P0): R;
    fb_computeRightTangentAtIndex<R = cocoa.CGPoint, P0 = number>(_fb_computeRightTangentAtIndex: P0): R;
    fb_computeLeftTangentAtIndex<R = cocoa.CGPoint, P0 = number>(_fb_computeLeftTangentAtIndex: P0): R;
    fb_estimateParametersUsingChordLengthMethodInRange<R = unknown, P0 = cocoa._NSRange>(_fb_estimateParametersUsingChordLengthMethodInRange: P0): R;
    fb_fitBezierInRange_withParameters_leftTangent_rightTangent<R = unknown, P0 = cocoa._NSRange, P1 = unknown, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint>(_fb_fitBezierInRange: P0, _withParameters: P1, _leftTangent: P2, _rightTangent: P3): R;
    fb_fitBezierUsingNaiveMethodInRange_leftTangent_rightTangent<R = unknown, P0 = cocoa._NSRange, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint>(_fb_fitBezierUsingNaiveMethodInRange: P0, _leftTangent: P1, _rightTangent: P2): R;
    fb_findMaximumErrorForBezier_inRange_parameters_maximumIndex<R = number, P0 = unknown, P1 = cocoa._NSRange, P2 = unknown, P3 = number>(_fb_findMaximumErrorForBezier: P0, _inRange: P1, _parameters: P2, _maximumIndex: P3): R;
    fb_refineParameters_forRange_bezier<R = unknown, P0 = unknown, P1 = cocoa._NSRange, P2 = unknown>(_fb_refineParameters: P0, _forRange: P1, _bezier: P2): R;
    fb_fitCubicToRange_leftTangent_rightTangent_errorThreshold<R = unknown, P0 = cocoa._NSRange, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = number>(_fb_fitCubicToRange: P0, _leftTangent: P1, _rightTangent: P2, _errorThreshold: P3): R;
    ...
    bezierPathByApplyingModifierBlock<R = unknown, P0 = cocoa.CDUnknownBlockType>(_bezierPathByApplyingModifierBlock: P0): R;
    subDivideAtPoint<R = unknown, P0 = cocoa.CGPoint>(_subDivideAtPoint: P0): R;
    ...
    pointOnPathAtLength_slope<R = cocoa.CGPoint, P0 = number, P1 = number>(_pointOnPathAtLength: P0, _slope: P1): R;
    ...
    outlinePathWithWidth_containsPoint<R = boolean, P0 = number, P1 = cocoa.CGPoint>(_outlinePathWithWidth: P0, _containsPoint: P1): R;
    ...
    bc_nan_curveToPoint_controlPoint1_controlPoint2<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint>(_bc_nan_curveToPoint: P0, _controlPoint1: P1, _controlPoint2: P2): R;
    bc_nan_lineToPoint<R = void, P0 = cocoa.CGPoint>(_bc_nan_lineToPoint: P0): R;
    bc_nan_moveToPoint<R = void, P0 = cocoa.CGPoint>(_bc_nan_moveToPoint: P0): R;
    svgPathAttribute<R = unknown>(): R;
    addSVGArcWithAngle_radius_from_to_largeArc_sweep<R = void, P0 = number, P1 = cocoa.CGSize, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint, P4 = boolean, P5 = boolean>(_addSVGArcWithAngle: P0, _radius: P1, _from: P2, _to: P3, _largeArc: P4, _sweep: P5): R;
    fb_simplify<R = unknown, P0 = number>(_fb_simplify: P0): R;
  }
  namespace classes {
    export interface NSBezierPath<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSCopyingProtocol, cocoa.classes.NSSecureCodingProtocol {
      ...
      drawPackedGlyphs_atPoint<R = void, P0 = string, P1 = cocoa.CGPoint>(_drawPackedGlyphs: P0, _atPoint: P1): R;
      strokeLineFromPoint_toPoint<R = void, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint>(_strokeLineFromPoint: P0, _toPoint: P1): R;
      clipRect<R = void, P0 = cocoa.CGRect>(_clipRect: P0): R;
      strokeRect<R = void, P0 = cocoa.CGRect>(_strokeRect: P0): R;
      fillRect<R = void, P0 = cocoa.CGRect>(_fillRect: P0): R;
      bezierPathWithRoundedRect_xRadius_yRadius<R = unknown, P0 = cocoa.CGRect, P1 = number, P2 = number>(_bezierPathWithRoundedRect: P0, _xRadius: P1, _yRadius: P2): R;
      bezierPathWithOvalInRect<R = unknown, P0 = cocoa.CGRect>(_bezierPathWithOvalInRect: P0): R;
      bezierPathWithRect<R = unknown, P0 = cocoa.CGRect>(_bezierPathWithRect: P0): R;
      ...
      // + NSBezierPath(Boolean,CHBezierPathAdditions,Clockwise,DebugTools,EPS,FBUtilities,FitCurve,FitCurvePrivate,Fitting,GIF,JSON,MSPath,NSBezierPath_BooleanBridge,NSBezierPath_Enumerator,NSBezierPath_Slopes,NSBezierPath_Various,NaNChecks,SVGBezierPath,Simplify):
      bezierCurveFromPoint_toPoint_controlPoint1_controlPoint2<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint, P2 = cocoa.CGPoint, P3 = cocoa.CGPoint>(_bezierCurveFromPoint: P0, _toPoint: P1, _controlPoint1: P2, _controlPoint2: P3): R;
      bezierPathFromPoint_toPoint<R = unknown, P0 = cocoa.CGPoint, P1 = cocoa.CGPoint>(_bezierPathFromPoint: P0, _toPoint: P1): R;
      bezierPathWithCGPath_bc<R = unknown, P0 = cocoa.CGPath>(_bezierPathWithCGPath_bc: P0): R;
