...
declare namespace cocoa {
  export interface _NSObserverList<T = any> extends cocoa.NSObject {
    ...
    removeBlockSink_observation<R = void, P0 = cocoa.CDUnknownBlockType, P1 = unknown>(_removeBlockSink: P0, _observation: P1): R;
    ...
    addBlockSink_toObservableObject_forTag<R = unknown, P0 = cocoa.CDUnknownBlockType, P1 = unknown, P2 = number>(_addBlockSink: P0, _toObservableObject: P1, _forTag: P2): R;
    _directAddObserver<R = void, P0 = unknown>(__directAddObserver: P0): R;
  }
  namespace classes {
    export interface _NSObserverList<T = any> extends cocoa.classes.NSObject {
