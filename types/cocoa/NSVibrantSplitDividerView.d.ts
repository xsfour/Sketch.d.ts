...
declare namespace cocoa {
  export interface NSVibrantSplitDividerView<T = any> extends cocoa.NSSplitDividerView {
  ...
  namespace classes {
    export interface NSVibrantSplitDividerView<T = any> extends cocoa.classes.NSSplitDividerView {
