...
declare namespace cocoa {
  export interface MSChangePageAction<T = any> extends cocoa.MSDocumentAction {
    changePageIndexBy<R = void, P0 = number>(_changePageIndexBy: P0): R;
    validate<R = boolean>(): R;
  }
  namespace classes {
    export interface MSChangePageAction<T = any> extends cocoa.classes.MSDocumentAction {
