...
declare namespace cocoa {
  export interface MSBackToInstanceAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    backToInstance<R = void, P0 = unknown>(_backToInstance: P0): R;
  }
  namespace classes {
    export interface MSBackToInstanceAction<T = any> extends cocoa.classes.MSDocumentAction {
