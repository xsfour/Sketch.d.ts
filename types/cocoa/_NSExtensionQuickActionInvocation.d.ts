...
declare namespace cocoa {
  export interface _NSExtensionQuickActionInvocation<T = any> extends cocoa.NSObject {
  ...
  namespace classes {
    export interface _NSExtensionQuickActionInvocation<T = any> extends cocoa.classes.NSObject {
