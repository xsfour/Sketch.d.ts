...
declare namespace cocoa {
  export interface NSNameSpecifier<T = any> extends cocoa.NSScriptObjectSpecifier {
  ...
  namespace classes {
    export interface NSNameSpecifier<T = any> extends cocoa.classes.NSScriptObjectSpecifier {
