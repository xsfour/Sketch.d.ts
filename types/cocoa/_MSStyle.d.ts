...
declare namespace cocoa {
  export interface _MSStyle<T = any> extends cocoa.MSModelObject {
    ...
    textStyle<R = cocoa.MSTextStyle>(): R;
    setTextStyle<R = void, P0 = cocoa.MSTextStyle>(_v: P0): R;
    ...
    colorControls<R = cocoa.MSStyleColorControls>(): R;
    setColorControls<R = void, P0 = cocoa.MSStyleColorControls>(_v: P0): R;
    borders<R = cocoa.NSArray>(): R;
    setBorders<R = void, P0 = cocoa.NSArray>(_v: P0): R;
    borderOptions<R = cocoa.MSStyleBorderOptions>(): R;
    setBorderOptions<R = void, P0 = cocoa.MSStyleBorderOptions>(_v: P0): R;
    blur<R = cocoa.MSStyleBlur>(): R;
    setBlur<R = void, P0 = cocoa.MSStyleBlur>(_v: P0): R;
  ...
  namespace classes {
    export interface _MSStyle<T = any> extends cocoa.classes.MSModelObject {
      alloc<R = _MSStyle>(): R;
      new: <R = _MSStyle>() => R;
    }
  }
