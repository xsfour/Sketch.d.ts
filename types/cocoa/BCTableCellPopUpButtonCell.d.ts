...
declare namespace cocoa {
  export interface BCTableCellPopUpButtonCell<T = any> extends cocoa.NSPopUpButtonCell {
    nudgeControlView_by<R = void, P0 = unknown, P1 = number>(_nudgeControlView: P0, _by: P1): R;
  }
  namespace classes {
    export interface BCTableCellPopUpButtonCell<T = any> extends cocoa.classes.NSPopUpButtonCell {
