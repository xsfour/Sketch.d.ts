...
declare namespace cocoa {
  export interface NSMachPort<T = any> extends cocoa.NSPort {
  ...
  namespace classes {
    export interface NSMachPort<T = any> extends cocoa.classes.NSPort {
...
declare const NSMachPort: cocoa.classes.NSMachPort;
