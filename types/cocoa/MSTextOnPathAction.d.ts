...
declare namespace cocoa {
  export interface MSTextOnPathAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
  ...
  namespace classes {
    export interface MSTextOnPathAction<T = any> extends cocoa.classes.MSDocumentAction {
