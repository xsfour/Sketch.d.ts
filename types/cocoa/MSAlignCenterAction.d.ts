...
declare namespace cocoa {
  export interface MSAlignCenterAction<T = any> extends cocoa.MSBaseAlignAction {
    label<R = unknown>(): R;
    alignCenter<R = void, P0 = unknown>(_alignCenter: P0): R;
  }
  namespace classes {
    export interface MSAlignCenterAction<T = any> extends cocoa.classes.MSBaseAlignAction {
