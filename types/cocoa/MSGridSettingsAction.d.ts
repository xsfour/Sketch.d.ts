...
declare namespace cocoa {
  export interface MSGridSettingsAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    gridSettings<R = void, P0 = unknown>(_gridSettings: P0): R;
  }
  namespace classes {
    export interface MSGridSettingsAction<T = any> extends cocoa.classes.MSDocumentAction {
