...
declare namespace cocoa {
  export interface _NSCGLSurfaceNonAtomicLayerContents<T = any> extends cocoa.NSObject {
    dealloc<R = void>(): R;
    CA_copyRenderValue<R = void>(): R;
    initWithSurface<R = unknown, P0 = unknown>(_initWithSurface: P0): R;
  }
  namespace classes {
    export interface _NSCGLSurfaceNonAtomicLayerContents<T = any> extends cocoa.classes.NSObject {
