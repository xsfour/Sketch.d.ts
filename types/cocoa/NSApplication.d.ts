...
declare namespace cocoa {
  export interface NSApplication<T = any> extends cocoa.NSResponder, cocoa.NSAppearanceCustomizationProtocol, cocoa.NSTouchBarProviderContainerProtocol, cocoa.NSAppearanceCustomizationInternalProtocol, cocoa.NSUserInterfaceValidationsProtocol, cocoa.NSMenuItemValidationProtocol, cocoa.NSAccessibilityElementProtocol, cocoa.NSAccessibilityProtocol {
    ...
    addIdleMonitorUsingHandler<R = unknown, P0 = cocoa.CDUnknownBlockType>(_addIdleMonitorUsingHandler: P0): R;
    removeMemoryPressureMonitor<R = void, P0 = unknown>(_removeMemoryPressureMonitor: P0): R;
    addMemoryPressureMonitorUsingHandler<R = unknown, P0 = cocoa.CDUnknownBlockType>(_addMemoryPressureMonitorUsingHandler: P0): R;
    ...
    _reopenWindowsAsNecessaryIncludingRestorableState_completionHandler<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(__reopenWindowsAsNecessaryIncludingRestorableState: P0, _completionHandler: P1): R;
    _launchTaskMask<R = number>(): R;
    _setLaunchTaskMaskBits<R = void, P0 = number>(__setLaunchTaskMaskBits: P0): R;
    _whenReopeningIsAllowedDo<R = void, P0 = cocoa.CDUnknownBlockType>(__whenReopeningIsAllowedDo: P0): R;
    ...
    _createDockMenu<R = cocoa.__CFArray, P0 = boolean>(__createDockMenu: P0): R;
    _flattenMenu<R = cocoa.__CFArray, P0 = unknown>(__flattenMenu: P0): R;
    _flattenMenu_flatList<R = cocoa.__CFArray, P0 = unknown, P1 = unknown>(__flattenMenu: P0, _flatList: P1): R;
    _flattenMenuItem<R = cocoa.__CFDictionary, P0 = unknown>(__flattenMenuItem: P0): R;
    _flattenMenuItem_flatList<R = cocoa.__CFDictionary, P0 = unknown, P1 = unknown>(__flattenMenuItem: P0, _flatList: P1): R;
    ...
    enumerateWindowsWithOptions_usingBlock<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(_enumerateWindowsWithOptions: P0, _usingBlock: P1): R;
    _findWindowWithOptions_passingTest<R = unknown, P0 = number, P1 = cocoa.CDUnknownBlockType>(__findWindowWithOptions: P0, _passingTest: P1): R;
    _enumerateOnScreenWindowsUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__enumerateOnScreenWindowsUsingBlock: P0): R;
    ...
    endModalSession<R = void, P0 = cocoa._NSModalSession>(_endModalSession: P0): R;
    runModalSession<R = number, P0 = cocoa._NSModalSession>(_runModalSession: P0): R;
    beginModalSessionForWindow<R = cocoa._NSModalSession, P0 = unknown>(_beginModalSessionForWindow: P0): R;
    beginModalSessionForWindow_relativeToWindow<R = cocoa._NSModalSession, P0 = unknown, P1 = unknown>(_beginModalSessionForWindow: P0, _relativeToWindow: P1): R;
    _commonBeginModalSessionForWindow_relativeToWindow_modalDelegate_didEndSelector_contextInfo<R = cocoa._NSModalSession, P0 = unknown, P1 = unknown, P2 = unknown, P3 = string, P4 = void>(__commonBeginModalSessionForWindow: P0, _relativeToWindow: P1, _modalDelegate: P2, _didEndSelector: P3, _contextInfo: P4): R;
    ...
    _doModalLoop_peek<R = void, P0 = cocoa._NSModalSession, P1 = boolean>(__doModalLoop: P0, _peek: P1): R;
    run<R = void>(): R;
    ...
    _suppressFinishLaunchingFromEventHandlersWhilePerformingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__suppressFinishLaunchingFromEventHandlersWhilePerformingBlock: P0): R;
    ...
    _withAmbientOriginatingDisplayHint_perform<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(__withAmbientOriginatingDisplayHint: P0, _perform: P1): R;
    ...
    _afterBatchOrderingFinishesDo<R = void, P0 = cocoa.CDUnknownBlockType>(__afterBatchOrderingFinishesDo: P0): R;
    _performBatchWindowOrdering_release<R = void, P0 = number, P1 = boolean>(__performBatchWindowOrdering: P0, _release: P1): R;
    _copyBatchWindowOrderingPerformerForToken_release<R = cocoa.CDUnknownBlockType, P0 = number, P1 = boolean>(__copyBatchWindowOrderingPerformerForToken: P0, _release: P1): R;
    ...
    _previousModalSession<R = cocoa._NSModalSession, P0 = cocoa._NSModalSession>(__previousModalSession: P0): R;
    _windowForModalSession<R = unknown, P0 = cocoa._NSModalSession>(__windowForModalSession: P0): R;
    _modalSessionForWindow<R = cocoa._NSModalSession, P0 = unknown>(__modalSessionForWindow: P0): R;
    ...
    _findMenuItemMatchingPredicate<R = unknown, P0 = cocoa.CDUnknownBlockType>(__findMenuItemMatchingPredicate: P0): R;
    ...
    _accessibilityViewBridgeHitTest<R = unknown, P0 = cocoa.CGPoint>(__accessibilityViewBridgeHitTest: P0): R;
    ...
    _accessibilityCompatibilityHitTest<R = unknown, P0 = cocoa.CGPoint>(__accessibilityCompatibilityHitTest: P0): R;
    ...
    _openURLs_withCompletionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__openURLs: P0, _withCompletionHandler: P1): R;
    ...
    _reopenWindowsIfNecessaryWithAppleEvent_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__reopenWindowsIfNecessaryWithAppleEvent: P0, _completionHandler: P1): R;
    _shouldRestoreWithFullFidelity<R = boolean>(): R;
    runModalForCarbonWindow<R = number, P0 = unknown>(_runModalForCarbonWindow: P0): R;
    _doModalLoopForCarbonWindow_peek<R = void, P0 = cocoa._NSModalSession, P1 = boolean>(__doModalLoopForCarbonWindow: P0, _peek: P1): R;
    ...
    _modalSession_sendEvent<R = void, P0 = cocoa._NSModalSession, P1 = unknown>(__modalSession: P0, _sendEvent: P1): R;
    ...
    _addWindowsMenu_enabled<R = void, P0 = cocoa.__CFArray, P1 = boolean>(__addWindowsMenu: P0, _enabled: P1): R;
    ...
    searchString_inUserInterfaceItemString_searchRange_foundRange<R = boolean, P0 = unknown, P1 = unknown, P2 = cocoa._NSRange, P3 = cocoa._NSRange>(_searchString: P0, _inUserInterfaceItemString: P1, _searchRange: P2, _foundRange: P3): R;
    ...
    _restoreWindowWithRestoration_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__restoreWindowWithRestoration: P0, _completionHandler: P1): R;
    _restoreGlobalStateWithRestoration<R = void, P0 = unknown>(__restoreGlobalStateWithRestoration: P0): R;
    restoreWindowWithIdentifier_state_completionHandler<R = boolean, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_restoreWindowWithIdentifier: P0, _state: P1, _completionHandler: P2): R;
    ...
    helpMenu<R = cocoa.NSMenu>(): R;
    setHelpMenu<R = void, P0 = cocoa.NSMenu>(_v: P0): R;
    mainMenu<R = cocoa.NSMenu>(): R;
    setMainMenu<R = void, P0 = cocoa.NSMenu>(_v: P0): R;
    windows<R = cocoa.NSArray>(): R;
    dockTile<R = cocoa.NSDockTile>(): R;
    applicationIconImage<R = cocoa.NSImage>(): R;
    setApplicationIconImage<R = void, P0 = cocoa.NSImage>(_v: P0): R;
    modalWindow<R = cocoa.NSWindow>(): R;
    running<R = boolean>(): R;
    hidden<R = boolean>(): R;
    active<R = boolean>(): R;
    keyWindow<R = cocoa.NSWindow>(): R;
    mainWindow<R = cocoa.NSWindow>(): R;
    delegate<R = cocoa.NSApplicationDelegate>(): R;
    setDelegate<R = void, P0 = cocoa.NSApplicationDelegate>(_v: P0): R;
    ...
    orderedWindows<R = cocoa.NSArray>(): R;
    orderedDocuments<R = cocoa.NSArray>(): R;
    ...
    windowsMenu<R = cocoa.NSMenu>(): R;
    setWindowsMenu<R = void, P0 = cocoa.NSMenu>(_v: P0): R;
  ...
  namespace classes {
    export interface NSApplication<T = any> extends cocoa.classes.NSResponder, cocoa.classes.NSAppearanceCustomizationProtocol, cocoa.classes.NSTouchBarProviderContainerProtocol, cocoa.classes.NSAppearanceCustomizationInternalProtocol, cocoa.classes.NSUserInterfaceValidationsProtocol, cocoa.classes.NSMenuItemValidationProtocol, cocoa.classes.NSAccessibilityElementProtocol, cocoa.classes.NSAccessibilityProtocol {
