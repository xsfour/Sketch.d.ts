...
declare namespace cocoa {
  export interface NSDatePickerCell<T = any> extends NSActionCell {
    ...
    _rangeOfDaysForMonth_year<R = _NSRange, P0 = number, P1 = number>(__rangeOfDaysForMonth: P0, _year: P1): R;
    ...
    _textFieldWithStepperKeyDown_inRect_ofView<R = boolean, P0 = unknown, P1 = CGRect, P2 = unknown>(__textFieldWithStepperKeyDown: P0, _inRect: P1, _ofView: P2): R;
    _textFieldWithStepperTrackMouse_inRect_ofView_untilMouseUp<R = boolean, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = boolean>(__textFieldWithStepperTrackMouse: P0, _inRect: P1, _ofView: P2, _untilMouseUp: P3): R;
    ...
    _makeSubfieldsWithHandler<R = void, P0 = CDUnknownBlockType>(__makeSubfieldsWithHandler: P0): R;
    ...
    _subfieldsFrame<R = CGRect>(): R;
    _subfieldOffsetForTextAreaFrame<R = number, P0 = CGRect>(__subfieldOffsetForTextAreaFrame: P0): R;
    _textFieldCellSize<R = CGSize>(): R;
    _textFieldWithStepperCellSize<R = CGSize>(): R;
    _indexOfSubfieldAtPoint_inTextAreaFrame<R = number, P0 = CGPoint, P1 = CGRect>(__indexOfSubfieldAtPoint: P0, _inTextAreaFrame: P1): R;
    _getTextAreaFrame_stepperCellFrame_forDatePickerCellFrame<R = void, P0 = CGRect, P1 = CGRect, P2 = CGRect>(__getTextAreaFrame: P0, _stepperCellFrame: P1, _forDatePickerCellFrame: P2): R;
    _stepperCellTopAndBottomTrim<R = number>(): R;
    _desiredTextAreaSize<R = CGSize>(): R;
    ...
    _drawTextFieldWithStepperWithFrame_inView<R = void, P0 = CGRect, P1 = unknown>(__drawTextFieldWithStepperWithFrame: P0, _inView: P1): R;
    _drawThemeBezelWithFrame_inView<R = void, P0 = CGRect, P1 = unknown>(__drawThemeBezelWithFrame: P0, _inView: P1): R;
    _contentInsetsForThemeBezelWithFrame_inView<R = NSEdgeInsets, P0 = CGRect, P1 = unknown>(__contentInsetsForThemeBezelWithFrame: P0, _inView: P1): R;
    _alignmentRectInsetsForThemeBezelWithFrame_inView<R = NSEdgeInsets, P0 = CGRect, P1 = unknown>(__alignmentRectInsetsForThemeBezelWithFrame: P0, _inView: P1): R;
    _coreUIDrawOptionsForThemeBezelWithFrame_inView<R = unknown, P0 = CGRect, P1 = unknown>(__coreUIDrawOptionsForThemeBezelWithFrame: P0, _inView: P1): R;
    _hitTestTextFieldWithStepper_inRect_ofView<R = number, P0 = unknown, P1 = CGRect, P2 = unknown>(__hitTestTextFieldWithStepper: P0, _inRect: P1, _ofView: P2): R;
    ...
    _clockAndCalendarKeyDown_inRect_ofView<R = boolean, P0 = unknown, P1 = CGRect, P2 = unknown>(__clockAndCalendarKeyDown: P0, _inRect: P1, _ofView: P2): R;
    _autoAdvanceCalendar<R = void, P0 = unknown>(__autoAdvanceCalendar: P0): R;
    _clockAndCalendarStopTracking_at_inView_mouseIsUp<R = void, P0 = CGPoint, P1 = CGPoint, P2 = unknown, P3 = boolean>(__clockAndCalendarStopTracking: P0, _at: P1, _inView: P2, _mouseIsUp: P3): R;
    _clockAndCalendarContinueTracking_at_inView<R = boolean, P0 = CGPoint, P1 = CGPoint, P2 = unknown>(__clockAndCalendarContinueTracking: P0, _at: P1, _inView: P2): R;
    _clockAndCalendarStartTrackingAt_inView<R = boolean, P0 = CGPoint, P1 = unknown>(__clockAndCalendarStartTrackingAt: P0, _inView: P1): R;
    _calendarDateComponentsForPoint_inCalendarRect<R = unknown, P0 = CGPoint, P1 = CGRect>(__calendarDateComponentsForPoint: P0, _inCalendarRect: P1): R;
    _clockAndCalendarTrackMouse_inRect_ofView_untilMouseUp<R = boolean, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = boolean>(__clockAndCalendarTrackMouse: P0, _inRect: P1, _ofView: P2, _untilMouseUp: P3): R;
    _clockAndCalendarGetClockFrame_calendarFrame_retreatMonthCellFrame_advanceMonthCellFrame_returnToHomeMonthButtonCellFrame_forDatePickerCellFrame<R = void, P0 = CGRect, P1 = CGRect, P2 = CGRect, P3 = CGRect, P4 = CGRect, P5 = CGRect>(__clockAndCalendarGetClockFrame: P0, _calendarFrame: P1, _retreatMonthCellFrame: P2, _advanceMonthCellFrame: P3, _returnToHomeMonthButtonCellFrame: P4, _forDatePickerCellFrame: P5): R;
    _calendarDaysFrameForDatePickerCellFrame<R = CGRect, P0 = CGRect>(__calendarDaysFrameForDatePickerCellFrame: P0): R;
    _clockAndCalendarCellSize<R = CGSize>(): R;
    _drawClockAndCalendarWithFrame_inView<R = void, P0 = CGRect, P1 = unknown>(__drawClockAndCalendarWithFrame: P0, _inView: P1): R;
    _hitTestClockAndCalendar_inRect_ofView<R = number, P0 = unknown, P1 = CGRect, P2 = unknown>(__hitTestClockAndCalendar: P0, _inRect: P1, _ofView: P2): R;
    _clockAndCalendarFillDayCell_withColor_inFrame_inView<R = void, P0 = number, P1 = unknown, P2 = CGRect, P3 = unknown>(__clockAndCalendarFillDayCell: P0, _withColor: P1, _inFrame: P2, _inView: P3): R;
    _clockAndCalendarFillDayCellRange_withColor_inFrame_inView<R = void, P0 = _NSRange, P1 = unknown, P2 = CGRect, P3 = unknown>(__clockAndCalendarFillDayCellRange: P0, _withColor: P1, _inFrame: P2, _inView: P3): R;
    _calendarContentAttributedStringWithSelectedDayCells<R = unknown, P0 = _NSRange>(__calendarContentAttributedStringWithSelectedDayCells: P0): R;
    ...
    _calendarRangeOfSelectedDaysForDisplayedMonthOffset<R = _NSRange, P0 = number>(__calendarRangeOfSelectedDaysForDisplayedMonthOffset: P0): R;
    _calendarRangeOfAllDaysForDisplayedMonth<R = _NSRange>(): R;
    _calendarRangeOfAllDaysForDisplayedMonthOffset<R = _NSRange, P0 = number>(__calendarRangeOfAllDaysForDisplayedMonthOffset: P0): R;
    ...
    _analogClockTrackMouse_inRect_ofView_untilMouseUp<R = boolean, P0 = unknown, P1 = CGRect, P2 = unknown, P3 = boolean>(__analogClockTrackMouse: P0, _inRect: P1, _ofView: P2, _untilMouseUp: P3): R;
    _drawAnalogClockWithFrame_inView<R = void, P0 = CGRect, P1 = unknown>(__drawAnalogClockWithFrame: P0, _inView: P1): R;
