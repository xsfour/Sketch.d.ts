...
declare namespace cocoa {
  export interface NSMutableRangeArray<T = any> extends cocoa.NSMutableArray {
    ...
    subarrayWithRange<R = unknown, P0 = cocoa._NSRange>(_subarrayWithRange: P0): R;
  ...
  namespace classes {
    export interface NSMutableRangeArray<T = any> extends cocoa.classes.NSMutableArray {
      array<R = unknown>(): R;
