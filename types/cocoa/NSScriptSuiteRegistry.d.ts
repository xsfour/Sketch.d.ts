...
declare namespace cocoa {
  export interface NSScriptSuiteRegistry<T = any> extends cocoa.NSObject {
    ...
    suiteNames<R = cocoa.NSArray>(): R;
  }
  namespace classes {
    export interface NSScriptSuiteRegistry<T = any> extends cocoa.classes.NSObject {
