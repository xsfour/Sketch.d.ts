...
declare namespace cocoa {
  export interface _NSViewBackingLayer<T = any> extends cocoa._NSBackingLayer {
    dealloc<R = void>(): R;
    ...
    setTransform<R = void, P0 = cocoa.CATransform3D>(_setTransform: P0): R;
  ...
  namespace classes {
    export interface _NSViewBackingLayer<T = any> extends cocoa.classes._NSBackingLayer {
