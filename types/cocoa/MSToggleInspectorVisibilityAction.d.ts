...
declare namespace cocoa {
  export interface MSToggleInspectorVisibilityAction<T = any> extends cocoa.MSToggleVisibilityAction {
    label<R = unknown>(): R;
    isActive<R = boolean>(): R;
    toggleInspectorVisibility<R = void, P0 = unknown>(_toggleInspectorVisibility: P0): R;
  }
  namespace classes {
    export interface MSToggleInspectorVisibilityAction<T = any> extends cocoa.classes.MSToggleVisibilityAction {
