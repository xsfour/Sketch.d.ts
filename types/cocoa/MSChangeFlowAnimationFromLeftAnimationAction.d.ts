...
declare namespace cocoa {
  export interface MSChangeFlowAnimationFromLeftAnimationAction<T = any> extends cocoa.MSChangeFlowAnimationAction {
    label<R = unknown>(): R;
    changeFlowAnimationToFromLeftAnimation<R = void, P0 = unknown>(_changeFlowAnimationToFromLeftAnimation: P0): R;
  }
  namespace classes {
    export interface MSChangeFlowAnimationFromLeftAnimationAction<T = any> extends cocoa.classes.MSChangeFlowAnimationAction {
