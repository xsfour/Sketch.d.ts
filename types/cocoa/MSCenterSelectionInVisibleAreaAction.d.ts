...
declare namespace cocoa {
  export interface MSCenterSelectionInVisibleAreaAction<T = any> extends cocoa.MSDocumentAction {
    label<R = unknown>(): R;
    centerCanvasSelectionInVisibleArea<R = void, P0 = unknown>(_centerCanvasSelectionInVisibleArea: P0): R;
    validate<R = boolean>(): R;
  }
  namespace classes {
    export interface MSCenterSelectionInVisibleAreaAction<T = any> extends cocoa.classes.MSDocumentAction {
