...
declare namespace cocoa {
  export interface MSImmutableStyleShadow<T = any> extends cocoa._MSImmutableStyleShadow, cocoa.MSColorUserProtocol {
  ...
  namespace classes {
    export interface MSImmutableStyleShadow<T = any> extends cocoa.classes._MSImmutableStyleShadow, cocoa.classes.MSColorUserProtocol {
...
declare const MSImmutableStyleShadow: cocoa.classes.MSImmutableStyleShadow;
