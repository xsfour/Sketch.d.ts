...
declare namespace cocoa {
  export interface NSExitFullScreenStatusItem<T = any> extends cocoa.NSStatusItem {
  ...
  namespace classes {
    export interface NSExitFullScreenStatusItem<T = any> extends cocoa.classes.NSStatusItem {
