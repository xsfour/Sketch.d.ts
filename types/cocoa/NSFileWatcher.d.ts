...
declare namespace cocoa {
  export interface NSFileWatcher<T = any> extends cocoa.NSObject {
    stop<R = void>(): R;
    settle<R = void>(): R;
    _coalesceSubitemObservations<R = void>(): R;
    unsettle<R = void>(): R;
    start<R = void>(): R;
    setObserver<R = void, P0 = cocoa.CDUnknownBlockType>(_setObserver: P0): R;
  ...
  namespace classes {
    export interface NSFileWatcher<T = any> extends cocoa.classes.NSObject {
