...
declare namespace cocoa {
  export interface NSRegion<T = any> extends cocoa.NSObject {
    stroke<R = void>(): R;
    fill<R = void>(): R;
    addClip<R = void>(): R;
    translateBy<R = void, P0 = cocoa.CGPoint>(_translateBy: P0): R;
    xorRegion<R = void, P0 = unknown>(_xorRegion: P0): R;
    xorRect<R = void, P0 = cocoa.CGRect>(_xorRect: P0): R;
    intersectRegion<R = void, P0 = unknown>(_intersectRegion: P0): R;
    intersectRect<R = void, P0 = cocoa.CGRect>(_intersectRect: P0): R;
    ...
    addRect<R = void, P0 = cocoa.CGRect>(_addRect: P0): R;
    setRegion<R = void, P0 = unknown>(_setRegion: P0): R;
    setRect<R = void, P0 = cocoa.CGRect>(_setRect: P0): R;
    setEmpty<R = void>(): R;
    enumerateRects<R = void, P0 = cocoa.CDUnknownBlockType>(_enumerateRects: P0): R;
    largestRect<R = cocoa.CGRect>(): R;
    isRectangular<R = boolean>(): R;
    getRects_count<R = void, P0 = cocoa.CGRect, P1 = number>(_getRects: P0, _count: P1): R;
    intersectsRegion<R = boolean, P0 = unknown>(_intersectsRegion: P0): R;
    intersectsRect<R = boolean, P0 = cocoa.CGRect>(_intersectsRect: P0): R;
    containsRegion<R = boolean, P0 = unknown>(_containsRegion: P0): R;
    containsRect<R = boolean, P0 = cocoa.CGRect>(_containsRect: P0): R;
    ...
    initWithCGSRegionObj<R = unknown, P0 = cocoa.CGSRegionObject>(_initWithCGSRegionObj: P0): R;
    initWithRects_count<R = unknown, P0 = cocoa.CGRect, P1 = number>(_initWithRects: P0, _count: P1): R;
    initWithRect<R = unknown, P0 = cocoa.CGRect>(_initWithRect: P0): R;
    description<R = unknown>(): R;
  }
  namespace classes {
    export interface NSRegion<T = any> extends cocoa.classes.NSObject {
      alloc<R = NSRegion>(): R;
      new: <R = NSRegion>() => R;
    }
  }
