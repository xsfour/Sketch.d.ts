...
declare namespace cocoa {
  export interface MSConvertFlowToHotspotAction<T = any> extends cocoa.MSFlowBaseAction {
    label<R = unknown>(): R;
    validate<R = boolean>(): R;
    convertFlowToHotspot<R = void, P0 = unknown>(_convertFlowToHotspot: P0): R;
  }
  namespace classes {
    export interface MSConvertFlowToHotspotAction<T = any> extends cocoa.classes.MSFlowBaseAction {
