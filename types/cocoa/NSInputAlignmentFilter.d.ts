...
declare namespace cocoa {
  export interface NSInputAlignmentFilter<T = any> extends cocoa.NSObject {
    processAlignment_ofReference_againstGuide<R = boolean, P0 = cocoa.CGPoint, P1 = unknown, P2 = unknown>(_processAlignment: P0, _ofReference: P1, _againstGuide: P2): R;
    ...
    dealloc<R = void>(): R;
    alignDistance<R = boolean, P0 = cocoa.CGPoint>(_alignDistance: P0): R;
    ...
    _filteredVelocity<R = cocoa.CGPoint>(): R;
    _hasCurrentLocation<R = boolean>(): R;
    _currentLocation<R = cocoa.CGPoint>(): R;
    ...
    _setActuationBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__setActuationBlock: P0): R;
    _isVerticalVelocityAlignable<R = boolean>(): R;
    _isHorizontalVelocityAlignable<R = boolean>(): R;
  }
  namespace classes {
    export interface NSInputAlignmentFilter<T = any> extends cocoa.classes.NSObject {
