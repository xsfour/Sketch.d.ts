...
declare namespace cocoa {
  export interface MSTileMipLevel<T = any> extends cocoa.NSObject {
    cxx_destruct<R = void>(): R;
    subtractDirtyRect<R = void, P0 = unknown>(_subtractDirtyRect: P0): R;
    uniteDirtyRect<R = void, P0 = cocoa.CGRect>(_uniteDirtyRect: P0): R;
    isCurrentColorSpaceEqualTo<R = boolean, P0 = cocoa.CGColorSpace>(_isCurrentColorSpaceEqualTo: P0): R;
    ...
    enqueueRenderableTilesForVisibleRect<R = unknown, P0 = cocoa.CGRect>(_enqueueRenderableTilesForVisibleRect: P0): R;
    countExistingTilesForVisibleRect<R = number, P0 = cocoa.CGRect>(_countExistingTilesForVisibleRect: P0): R;
    dealloc<R = void>(): R;
    initWithScaleRangeMax<R = unknown, P0 = number>(_initWithScaleRangeMax: P0): R;
    tiles<R = cocoa.NSMutableArray>(): R;
    setTiles<R = void, P0 = cocoa.NSMutableArray>(_v: P0): R;
    ...
    currentColorSpace<R = cocoa.CGColorSpace>(): R;
    setCurrentColorSpace<R = void, P0 = cocoa.CGColorSpace>(_v: P0): R;
    scale<R = number>(): R;
  ...
  namespace classes {
    export interface MSTileMipLevel<T = any> extends cocoa.classes.NSObject {
