...
declare namespace cocoa {
  export interface MSFillRendererCG<T = any> extends NSObject, MSFillRendererProtocol {
    ...
    drawNoiseFill_path_layer_rect_context<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = CGRect, P4 = unknown>(_drawNoiseFill: P0, _path: P1, _layer: P2, _rect: P3, _context: P4): R;
