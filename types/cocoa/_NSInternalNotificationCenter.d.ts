...
declare namespace cocoa {
  export interface _NSInternalNotificationCenter<T = any> extends cocoa.NSObject {
    ...
    addObserverForName_object_queue_usingBlock<R = number, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(_addObserverForName: P0, _object: P1, _queue: P2, _usingBlock: P3): R;
  ...
  namespace classes {
    export interface _NSInternalNotificationCenter<T = any> extends cocoa.classes.NSObject {
