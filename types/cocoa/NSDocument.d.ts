...
declare namespace cocoa {
  export interface NSDocument<T = any> extends cocoa.NSObject, cocoa.NSUIActivityProviderProtocol, cocoa.NSEditorRegistrationProtocol, cocoa.NSFilePresenterProtocol, cocoa.NSMenuItemValidationProtocol, cocoa.NSUserInterfaceValidationsProtocol {
    ...
    mergeAlternateContentsToURL_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_mergeAlternateContentsToURL: P0, _completionHandler: P1): R;
    disassociateAlternateContentsWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_disassociateAlternateContentsWithCompletionHandler: P0): R;
    prepareToDisassociateAlternateContentsWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_prepareToDisassociateAlternateContentsWithCompletionHandler: P0): R;
    ...
    _commitEditingWithDelegate_didSomethingSelector_contextInfo_thenContinue<R = void, P0 = unknown, P1 = string, P2 = void, P3 = cocoa.CDUnknownBlockType>(__commitEditingWithDelegate: P0, _didSomethingSelector: P1, _contextInfo: P2, _thenContinue: P3): R;
    _commitEditingThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__commitEditingThenContinue: P0): R;
    _editor_didCommit_soContinue<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(__editor: P0, _didCommit: P1, _soContinue: P2): R;
    ...
    accommodatePresentedItemDisconnectionWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_accommodatePresentedItemDisconnectionWithCompletionHandler: P0): R;
    _handleRemoteMoveToTrash<R = void>(): R;
    _handleRemoteDeletionValidationWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(__handleRemoteDeletionValidationWithCompletionHandler: P0): R;
    _presentAlertForRemoteDeletionValidationWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(__presentAlertForRemoteDeletionValidationWithCompletionHandler: P0): R;
    ...
    _handlePurgedDocumentWithURL_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__handlePurgedDocumentWithURL: P0, _completionHandler: P1): R;
    presentAlertForPurgedUbiquitousDocumentWithFormerAlternateContents_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_presentAlertForPurgedUbiquitousDocumentWithFormerAlternateContents: P0, _completionHandler: P1): R;
    validatePresentedItemRemoteDeletionWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_validatePresentedItemRemoteDeletionWithCompletionHandler: P0): R;
    presentedItemHasUnsavedChangesWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_presentedItemHasUnsavedChangesWithCompletionHandler: P0): R;
    ...
    _requestViewControllerForDocumentTitlebarPopover_thenDisplayPopoverUsingBlock<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__requestViewControllerForDocumentTitlebarPopover: P0, _thenDisplayPopoverUsingBlock: P1): R;
    ...
    _presentErrors_thenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__presentErrors: P0, _thenContinue: P1): R;
    _presentError_thenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__presentError: P0, _thenContinue: P1): R;
    ...
    _waitForEditorCommittingThenPerformBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__waitForEditorCommittingThenPerformBlock: P0): R;
    _changeWillBeDone<R = void, P0 = unknown>(__changeWillBeDone: P0): R;
    _ensureDocumentIsUnlockedForMoveOrRenameThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__ensureDocumentIsUnlockedForMoveOrRenameThenContinue: P0): R;
    _checkAutosavingIgnoringSafetyChecksThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__checkAutosavingIgnoringSafetyChecksThenContinue: P0): R;
    ...
    _checkAutosavingThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__checkAutosavingThenContinue: P0): R;
    ...
    _presentError_ignoreAccidentalEvents_thenContinue<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(__presentError: P0, _ignoreAccidentalEvents: P1, _thenContinue: P2): R;
    ...
    renameToURL_extensionHidden_completionHandler<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(_renameToURL: P0, _extensionHidden: P1, _completionHandler: P2): R;
    renameDocumentToURL_automaticallyChosen_extensionHidden_completionHandler<R = void, P0 = unknown, P1 = boolean, P2 = boolean, P3 = cocoa.CDUnknownBlockType>(_renameDocumentToURL: P0, _automaticallyChosen: P1, _extensionHidden: P2, _completionHandler: P3): R;
    prepareRenameSession<R = void, P0 = unknown>(_prepareRenameSession: P0): R;
    renameToDisplayName_grantHandler_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType, P2 = cocoa.CDUnknownBlockType>(_renameToDisplayName: P0, _grantHandler: P1, _completionHandler: P2): R;
    _renameWithProposedName_grantHandler_destinationURL_hideExtensions_nameChecked_trashChecked_overwriteChecked_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType, P2 = unknown, P3 = boolean, P4 = boolean, P5 = boolean, P6 = boolean, P7 = cocoa.CDUnknownBlockType>(__renameWithProposedName: P0, _grantHandler: P1, _destinationURL: P2, _hideExtensions: P3, _nameChecked: P4, _trashChecked: P5, _overwriteChecked: P6, _completionHandler: P7): R;
    _recoverableRenameFileError_proposedName_destinationURL_retryRenamer_renameCanceler<R = unknown, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa.CDUnknownBlockType, P4 = cocoa.CDUnknownBlockType>(__recoverableRenameFileError: P0, _proposedName: P1, _destinationURL: P2, _retryRenamer: P3, _renameCanceler: P4): R;
    ...
    unlockWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_unlockWithCompletionHandler: P0): R;
    unlockDocumentWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_unlockDocumentWithCompletionHandler: P0): R;
    unlockDocument<R = void, P0 = unknown>(_unlockDocument: P0): R;
    lockWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_lockWithCompletionHandler: P0): R;
    lockDocumentWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_lockDocumentWithCompletionHandler: P0): R;
    ...
    shareItemAtURL_withService_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_shareItemAtURL: P0, _withService: P1, _completionHandler: P2): R;
    shareDocumentWithSharingService_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_shareDocumentWithSharingService: P0, _completionHandler: P1): R;
    prepareSharingServicePicker<R = void, P0 = unknown>(_prepareSharingServicePicker: P0): R;
    shareUbiquitousDocumentWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_shareUbiquitousDocumentWithCompletionHandler: P0): R;
    ...
    resolveConflictRemotelyWithFileVersion_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_resolveConflictRemotelyWithFileVersion: P0, _completionHandler: P1): R;
    willResolveConflictWithFileVersion_continuer<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_willResolveConflictWithFileVersion: P0, _continuer: P1): R;
    willHandleConflictsWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_willHandleConflictsWithCompletionHandler: P0): R;
    ...
    stopBrowsingVersionsWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_stopBrowsingVersionsWithCompletionHandler: P0): R;
    ...
    _moveDocumentToURL_andHideExtension_completionHandler<R = void, P0 = unknown, P1 = boolean, P2 = cocoa.CDUnknownBlockType>(__moveDocumentToURL: P0, _andHideExtension: P1, _completionHandler: P2): R;
    ...
    moveToURL_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_moveToURL: P0, _completionHandler: P1): R;
    _prepareToMoveToURL_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__prepareToMoveToURL: P0, _completionHandler: P1): R;
    _handleOtherFromDocumentTitlebarPopoverThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__handleOtherFromDocumentTitlebarPopoverThenContinue: P0): R;
    ...
    _runModalOpenPanelForMoving_thenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__runModalOpenPanelForMoving: P0, _thenContinue: P1): R;
    _openPanelForOtherInMovePanel<R = unknown, P0 = unknown>(__openPanelForOtherInMovePanel: P0): R;
    _moveToURL_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__moveToURL: P0, _completionHandler: P1): R;
    _preparedMovePanel<R = unknown>(): R;
    moveDocumentWithCompletionHandler<R = void, P0 = cocoa.CDUnknownBlockType>(_moveDocumentWithCompletionHandler: P0): R;
    ...
    autosaveWithImplicitCancellability_completionHandler<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(_autosaveWithImplicitCancellability: P0, _completionHandler: P1): R;
    ...
    _silentlyRecoverableVariantOfSavingError_resaver<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__silentlyRecoverableVariantOfSavingError: P0, _resaver: P1): R;
    _silentlyRecoverableVariantOfDiskFullError_resaver<R = unknown, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__silentlyRecoverableVariantOfDiskFullError: P0, _resaver: P1): R;
    ...
    _errorForOverwrittenFileWithSandboxExtension_andSaver<R = unknown, P0 = string, P1 = cocoa.CDUnknownBlockType>(__errorForOverwrittenFileWithSandboxExtension: P0, _andSaver: P1): R;
    _willPresentSavingError_withURL_ofType_forOperation_recoveryContinuer<R = unknown, P0 = unknown, P1 = unknown, P2 = unknown, P3 = number, P4 = cocoa.CDUnknownBlockType>(__willPresentSavingError: P0, _withURL: P1, _ofType: P2, _forOperation: P3, _recoveryContinuer: P4): R;
    ...
    saveToURL_ofType_forSaveOperation_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa.CDUnknownBlockType>(_saveToURL: P0, _ofType: P1, _forSaveOperation: P2, _completionHandler: P3): R;
    ...
    _recoverableVariantOfOverwritingError_forOperation_url_type_temporaryDirectoryURL_newContentsURL_writer<R = unknown, P0 = unknown, P1 = number, P2 = unknown, P3 = unknown, P4 = unknown, P5 = unknown, P6 = cocoa.CDUnknownBlockType>(__recoverableVariantOfOverwritingError: P0, _forOperation: P1, _url: P2, _type: P3, _temporaryDirectoryURL: P4, _newContentsURL: P5, _writer: P6): R;
    ...
    _revertToVersionForTag_thenContinue<R = void, P0 = number, P1 = cocoa.CDUnknownBlockType>(__revertToVersionForTag: P0, _thenContinue: P1): R;
    _revertToDiscardRecentChangesOrBrowseVersions_thenContinue<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(__revertToDiscardRecentChangesOrBrowseVersions: P0, _thenContinue: P1): R;
    ...
    willRestoreVersion_completionHandler<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(_willRestoreVersion: P0, _completionHandler: P1): R;
    _revertToVersion_thenContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__revertToVersion: P0, _thenContinue: P1): R;
    _revertToChosenVersion_orAlternateContents_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__revertToChosenVersion: P0, _orAlternateContents: P1, _thenContinue: P2): R;
    _checkShouldRevertToChosenVersionThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__checkShouldRevertToChosenVersionThenContinue: P0): R;
    ...
    _revertToSavedThenContinue<R = void, P0 = cocoa.CDUnknownBlockType>(__revertToSavedThenContinue: P0): R;
    ...
    _coordinateReadingContentsAndReturnError_byAccessor<R = boolean, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__coordinateReadingContentsAndReturnError: P0, _byAccessor: P1): R;
    continueAsynchronousWorkOnMainThreadUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_continueAsynchronousWorkOnMainThreadUsingBlock: P0): R;
    performAsynchronousFileAccessUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_performAsynchronousFileAccessUsingBlock: P0): R;
    performSynchronousFileAccessUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_performSynchronousFileAccessUsingBlock: P0): R;
    continueActivityUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_continueActivityUsingBlock: P0): R;
    performActivityWithSynchronousWaiting_usingBlock<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(_performActivityWithSynchronousWaiting: P0, _usingBlock: P1): R;
    _presentAlertWithPrimaryMessage_secondaryMessage_defaultButtonLabel_alternateButtonLabel_otherButtonLabel_ignoreAccidentalEvents_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = unknown, P4 = unknown, P5 = boolean, P6 = cocoa.CDUnknownBlockType>(__presentAlertWithPrimaryMessage: P0, _secondaryMessage: P1, _defaultButtonLabel: P2, _alternateButtonLabel: P3, _otherButtonLabel: P4, _ignoreAccidentalEvents: P5, _thenContinue: P6): R;
    _presentAlertWithPrimaryMessage_secondaryMessage_firstButtonLabel_isDefault_alternateButtonLabel_otherButtonLabel_ignoreAccidentalEvents_guardAlternateButton_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = boolean, P4 = unknown, P5 = unknown, P6 = boolean, P7 = boolean, P8 = cocoa.CDUnknownBlockType>(__presentAlertWithPrimaryMessage: P0, _secondaryMessage: P1, _firstButtonLabel: P2, _isDefault: P3, _alternateButtonLabel: P4, _otherButtonLabel: P5, _ignoreAccidentalEvents: P6, _guardAlternateButton: P7, _thenContinue: P8): R;
    _presentAlertWithPrimaryMessage_secondaryMessage_firstButtonLabel_isDefault_alternateButtonLabel_otherButtonLabel_ignoreAccidentalEvents_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = boolean, P4 = unknown, P5 = unknown, P6 = boolean, P7 = cocoa.CDUnknownBlockType>(__presentAlertWithPrimaryMessage: P0, _secondaryMessage: P1, _firstButtonLabel: P2, _isDefault: P3, _alternateButtonLabel: P4, _otherButtonLabel: P5, _ignoreAccidentalEvents: P6, _thenContinue: P7): R;
    _presentAlertWithPrimaryMessage_secondaryMessage_firstButtonLabel_isDefault_alternateButtonLabel_otherButtonLabel_ignoreAccidentalEvents_showSuppressionButton_guardAlternateButton_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = boolean, P4 = unknown, P5 = unknown, P6 = boolean, P7 = boolean, P8 = boolean, P9 = cocoa.CDUnknownBlockType>(__presentAlertWithPrimaryMessage: P0, _secondaryMessage: P1, _firstButtonLabel: P2, _isDefault: P3, _alternateButtonLabel: P4, _otherButtonLabel: P5, _ignoreAccidentalEvents: P6, _showSuppressionButton: P7, _guardAlternateButton: P8, _thenContinue: P9): R;
    _something_didSomethingSoContinue<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__something: P0, _didSomethingSoContinue: P1): R;
    _somethingDidSomething_soContinue<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType>(__somethingDidSomething: P0, _soContinue: P1): R;
    ...
    _performAsynchronousFileAccessUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__performAsynchronousFileAccessUsingBlock: P0): R;
    _synchronouslyCheckFileURLUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__synchronouslyCheckFileURLUsingBlock: P0): R;
    _performSynchronousFileAccessUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__performSynchronousFileAccessUsingBlock: P0): R;
    _performFileAccess<R = void, P0 = unknown>(__performFileAccess: P0): R;
    _fileAccessStabilizedFileURL<R = void>(): R;
    _continueCurrentFileAccessDuringBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__continueCurrentFileAccessDuringBlock: P0): R;
    _isFileAccessContinuing<R = boolean>(): R;
    _discontinueFileAccessUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__discontinueFileAccessUsingBlock: P0): R;
    continueFileAccessUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(_continueFileAccessUsingBlock: P0): R;
    _enqueueFileAccess<R = void, P0 = unknown>(__enqueueFileAccess: P0): R;
    _fileAccessCompletionHandlerForFileAccess<R = cocoa.CDUnknownBlockType, P0 = unknown>(__fileAccessCompletionHandlerForFileAccess: P0): R;
    _beginNextFileAccess<R = void>(): R;
    _continueActivityUsingBlock<R = void, P0 = cocoa.CDUnknownBlockType>(__continueActivityUsingBlock: P0): R;
    performActivityWithSynchronousWaiting_usingBlock_cancellationHandler<R = void, P0 = boolean, P1 = cocoa.CDUnknownBlockType, P2 = cocoa.CDUnknownBlockType>(_performActivityWithSynchronousWaiting: P0, _usingBlock: P1, _cancellationHandler: P2): R;
    _performActivity<R = void, P0 = unknown>(__performActivity: P0): R;
    _interruptingSynchronousFileAccess<R = boolean>(): R;
    _activityCompletionHandlerForActivity<R = cocoa.CDUnknownBlockType, P0 = unknown>(__activityCompletionHandlerForActivity: P0): R;
    ...
    restoreDocumentWindowWithIdentifier_state_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(_restoreDocumentWindowWithIdentifier: P0, _state: P1, _completionHandler: P2): R;
    ...
    _saveToURL_ofType_forSaveOperation_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = number, P3 = cocoa.CDUnknownBlockType>(__saveToURL: P0, _ofType: P1, _forSaveOperation: P2, _completionHandler: P3): R;
    ...
    _prepareToSaveToURL_forSaveOperation_completionHandler<R = void, P0 = unknown, P1 = number, P2 = cocoa.CDUnknownBlockType>(__prepareToSaveToURL: P0, _forSaveOperation: P1, _completionHandler: P2): R;
    ...
    _coordinateReadingContentsAndWritingItemAtURL_error_byAccessor<R = boolean, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__coordinateReadingContentsAndWritingItemAtURL: P0, _error: P1, _byAccessor: P2): R;
    _coordinateReadingContentsAndWritingItemAtURL_byAccessor<R = void, P0 = unknown, P1 = cocoa.CDUnknownBlockType>(__coordinateReadingContentsAndWritingItemAtURL: P0, _byAccessor: P1): R;
    _fileCoordinator_coordinateReadingContentsAndWritingItemAtURL_byAccessor<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__fileCoordinator: P0, _coordinateReadingContentsAndWritingItemAtURL: P1, _byAccessor: P2): R;
    _fileCoordinator_asynchronouslyCoordinateReadingContentsAndWritingItemAtURL_byAccessor<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__fileCoordinator: P0, _asynchronouslyCoordinateReadingContentsAndWritingItemAtURL: P1, _byAccessor: P2): R;
    ...
    _checkForFileChangesThenSave_saveAs_orCancel<R = void, P0 = cocoa.CDUnknownBlockType, P1 = cocoa.CDUnknownBlockType, P2 = cocoa.CDUnknownBlockType>(__checkForFileChangesThenSave: P0, _saveAs: P1, _orCancel: P2): R;
    _presentAlertForFileOverwritten_moved_renamed_inTrash_orUnavailable_thenSave_saveAs_orCancel<R = void, P0 = boolean, P1 = boolean, P2 = boolean, P3 = boolean, P4 = boolean, P5 = cocoa.CDUnknownBlockType, P6 = cocoa.CDUnknownBlockType, P7 = cocoa.CDUnknownBlockType>(__presentAlertForFileOverwritten: P0, _moved: P1, _renamed: P2, _inTrash: P3, _orUnavailable: P4, _thenSave: P5, _saveAs: P6, _orCancel: P7): R;
    ...
    PDFPrintOperation<R = cocoa.NSPrintOperation>(): R;
    ...
    autosavedContentsFileURL<R = cocoa.NSURL>(): R;
    setAutosavedContentsFileURL<R = void, P0 = cocoa.NSURL>(_v: P0): R;
    autosavingFileType<R = cocoa.NSString>(): R;
    hasUnautosavedChanges<R = boolean>(): R;
    fileTypeFromLastRunSavePanel<R = cocoa.NSString>(): R;
    ...
    backupFileURL<R = cocoa.NSURL>(): R;
    entireFileLoaded<R = boolean>(): R;
    autosavingIsImplicitlyCancellable<R = boolean>(): R;
    fileModificationDate<R = cocoa.NSDate>(): R;
    setFileModificationDate<R = void, P0 = cocoa.NSDate>(_v: P0): R;
    ...
    lastComponentOfFileName<R = cocoa.NSString>(): R;
    setLastComponentOfFileName<R = void, P0 = cocoa.NSString>(_v: P0): R;
  ...
  namespace classes {
    export interface NSDocument<T = any> extends cocoa.classes.NSObject, cocoa.classes.NSUIActivityProviderProtocol, cocoa.classes.NSEditorRegistrationProtocol, cocoa.classes.NSFilePresenterProtocol, cocoa.classes.NSMenuItemValidationProtocol, cocoa.classes.NSUserInterfaceValidationsProtocol {
      ...
      _handleConflictsForDocumentAtURL_modalForWindow_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__handleConflictsForDocumentAtURL: P0, _modalForWindow: P1, _completionHandler: P2): R;
      _handleConflictsForDocument_atURL_modalForWindow_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = cocoa.CDUnknownBlockType>(__handleConflictsForDocument: P0, _atURL: P1, _modalForWindow: P2, _completionHandler: P3): R;
      _resolveConflictsForDocument_atURL_byKeepingVersions_otherVersions_currentVersion_collectingURLsToOpen_andErrors_completionHandler<R = void, P0 = unknown, P1 = unknown, P2 = unknown, P3 = unknown, P4 = unknown, P5 = unknown, P6 = unknown, P7 = cocoa.CDUnknownBlockType>(__resolveConflictsForDocument: P0, _atURL: P1, _byKeepingVersions: P2, _otherVersions: P3, _currentVersion: P4, _collectingURLsToOpen: P5, _andErrors: P6, _completionHandler: P7): R;
      ...
      _presentNameConflictAlertForURL_window_thenContinue<R = void, P0 = unknown, P1 = unknown, P2 = cocoa.CDUnknownBlockType>(__presentNameConflictAlertForURL: P0, _window: P1, _thenContinue: P2): R;
