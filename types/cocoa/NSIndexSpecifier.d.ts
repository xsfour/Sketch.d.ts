...
declare namespace cocoa {
  export interface NSIndexSpecifier<T = any> extends cocoa.NSScriptObjectSpecifier {
  ...
  namespace classes {
    export interface NSIndexSpecifier<T = any> extends cocoa.classes.NSScriptObjectSpecifier {
...
declare const NSIndexSpecifier: cocoa.classes.NSIndexSpecifier;
