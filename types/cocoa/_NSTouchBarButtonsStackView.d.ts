...
declare namespace cocoa {
  export interface _NSTouchBarButtonsStackView<T = any> extends cocoa.NSStackView, cocoa._NSTouchBarItemLayoutWrapperProtocol {
    ...
    popoverItems<R = cocoa.NSMutableArray>(): R;
    setPopoverItems<R = void, P0 = cocoa.NSMutableArray>(_v: P0): R;
    adjustableButtons<R = cocoa.NSMutableArray>(): R;
    setAdjustableButtons<R = void, P0 = cocoa.NSMutableArray>(_v: P0): R;
    desiredWidthConstraint<R = cocoa.NSLayoutConstraint>(): R;
    setDesiredWidthConstraint<R = void, P0 = cocoa.NSLayoutConstraint>(_v: P0): R;
    equalWidthConstraints<R = cocoa.NSMutableArray>(): R;
    setEqualWidthConstraints<R = void, P0 = cocoa.NSMutableArray>(_v: P0): R;
    preferredWidthConstraints<R = cocoa.NSMutableArray>(): R;
    setPreferredWidthConstraints<R = void, P0 = cocoa.NSMutableArray>(_v: P0): R;
    groupTouchBarItem<R = cocoa.NSButtonGroupTouchBarItem>(): R;
    setGroupTouchBarItem<R = void, P0 = cocoa.NSButtonGroupTouchBarItem>(_v: P0): R;
    isSpace<R = boolean>(): R;
  ...
  namespace classes {
    export interface _NSTouchBarButtonsStackView<T = any> extends cocoa.classes.NSStackView, cocoa.classes._NSTouchBarItemLayoutWrapperProtocol {
